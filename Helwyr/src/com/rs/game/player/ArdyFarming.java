		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your crops have fully grown at Ardougne, allotment A.</col>");
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 10);
					player.sm("<col=FF0000>[Notice] Your crops have fully grown at Ardougne, allotment B.</col>");
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your Sweetcorn has fully grown at Ardougne, Allotment A.</col>");
					player.canHarvestAA = true;
				}
					loop++;
					}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 40);
					player.sm("<col=FF0000>[Notice] Your Sweetcorn has fully grown at Ardougne, Allotment B.</col>");
					player.canHarvestAB = true;
				}
					loop++;
					}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your herbs are fully grown at Ardougne.</col>");
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your Marigolds are fully grown at Ardougne.</col>");
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your White Lily's have fully grown at Ardougne.</col>");
					player.canHarvestFlowerAF = true;
				}
					loop++;
					}
