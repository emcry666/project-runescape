...
public class NomadsRequiem extends Controler {
	...
	public boolean processItemTeleport(WorldTile toTile) {
		player.getPackets().sendGameMessage("You are not allowed to teleport in this area.");
		return false;
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (stage == 0) {
					...
					Dialogue.npcNoContinue(player, nomad.getId(),
