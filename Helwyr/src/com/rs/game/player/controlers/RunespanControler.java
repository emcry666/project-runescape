...
public class RunespanControler extends Controler {
	...
	public static WorldTile MEDIUM_LEVEL = new WorldTile(4149, 6104, 1);
	public static WorldTile HIGHER_LEVEL = new WorldTile(4296, 6039, 1);
	...
	public boolean processObjectClick1(final WorldObject object) {
		...
		if (object.getId() == 70508) {
			player.useStairs(16668, MEDIUM_LEVEL, 4, 5);
			WorldTasksManager.schedule(new WorldTask() {
				@Override
				public void run() {
			...
			player.useStairs(16675, HIGHER_LEVEL, 2, 3);
			WorldTasksManager.schedule(new WorldTask() {
				@Override
				public void run() {
					player.setNextAnimation(new Animation(-1));
		...
		player.useStairs(16675, MEDIUM_LEVEL, 2, 3);
		WorldTasksManager.schedule(new WorldTask() {
			@Override
			public void run() {
				player.setNextAnimation(new Animation(-1));
