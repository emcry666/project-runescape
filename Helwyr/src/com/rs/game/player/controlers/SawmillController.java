...
import com.rs.game.player.content.sawmill.ConveyorBeltHopper;
import com.rs.game.player.content.sawmill.CutPlank;
import com.rs.game.player.content.sawmill.PlanksTake;
import com.rs.game.player.content.sawmill.Sawmill;
import com.rs.game.player.content.sawmill.StackOfLogs;
...
public class SawmillController extends Controler {
	...
	private void leave() {
		player.getInterfaceManager().closeAll();
	}
