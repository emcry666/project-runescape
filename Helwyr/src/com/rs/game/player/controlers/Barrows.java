...
public final class Barrows extends Controler {
	...
	private static final Item[] COMMUM_REWARDS = {new Item(558, 1795),
		...
		new Item(565, 164),
		new Item(4740, 188),
		new Item(995, Utils.random(100000, 3000000))
	};
	...
	public void sendReward() {
		boolean isEventActive = EventManager.eventStarted(EventType.MINIGAME_EVENT, EventConstants.BARROWS);
		double percentage = 0;
		...
		if (Utils.random(isEventActive ? 10 : 15) == 0) // rare
			drop(BARROW_REWARDS[Utils.random(BARROW_REWARDS.length)]);
		if (Utils.random(3) != 0)
