...
public class Gerrant extends Dialogue {
	...
	public void start() {
		...
		sendNPCDialogue(npcId, PLAIN_TALKING, "Welcome! You can buy fishing equipment at my store.", "We'll also buy anything you catch off you.");
	}
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			sendOptionsDialogue(DEFAULT, "Let's see what you've got then.", "Sorry, I'm not interested.");
			stage = 0;
			break;
		case 0:
			switch(componentId) {
