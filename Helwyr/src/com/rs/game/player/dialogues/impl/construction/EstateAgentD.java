...
public class EstateAgentD extends Dialogue {
	...
	private static final POHLocation[] LOCATIONS = { POHLocation.RIMMINGTON, POHLocation.TAVERLY,
	...
	public void start() {
		...
		sendNPCDialogue(npcId, NORMAL,
				"Hello. Welcome to " + Configs.SERVER_NAME + " Housing Agency! What can I do you for?");
	}
	...
	public void run(int interfaceId, int componentId) {
		...
		if (stage == -1) {
			...
			if (componentId >= OPTION_1 && componentId <= OPTION_4) {
				...
				sendOptionsDialogue("SELECT AN OPTION", "Brimhaven (15,000)", "Yannile (25,000)", "Prifddinas (50,000)",
						"Previous");
				stage = 4;
			}
		} else if (stage == 4) {
			...
			sendNPCDialogue(npcId, NORMAL, "They created serveral folded-space regions across " + Configs.SERVER_NAME
			...
			sendNPCDialogue(npcId, NORMAL, "There are various other people across " + Configs.SERVER_NAME
			...
			boolean hasEnoughCoins = player.getInventory().getNumerOf(995) >= 99000;
			if (hasEnoughCoins) {
