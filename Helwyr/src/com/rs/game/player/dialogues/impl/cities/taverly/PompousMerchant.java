...
public class PompousMerchant extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			...
			break;
		case 0:
			sendNPCDialogue(npcId, PLAIN_TALKING, "I have no idea. Some 'hero' I would guess.");
			stage = 1;
			break;
		case 1:
			...
			break;
		case 2:
			sendNPCDialogue(npcId, PLAIN_TALKING, "Hush. I have far to much money to listen to the idle", "prattle of menials. Begone!");
			stage = 50;
			break;
		case 50:
			end();
