...
//	if (stage == -1) {
//	    sendOptionsDialogue("Select an Option", "Go to the bank/sawmill...", "Misc...", "Stop following me",
//		    "You're fired");
//	    stage = 2;
//	} else if (stage == 2) {
...
//		player.getTemporaryAttributtes().put(Key.SERVANT_REQUEST_ITEM,
//			HouseConstants.BANKABLE_ITEMS[page][componentId == 11 ? 0 : componentId - 12]);
//		player.getPackets().sendInputIntegerScript("How many would you like?");
//		end();
//	    }
//	} else if (stage == 13) {
//	    sendOptionsDialogue("Would you you like to pay the fee of " + servant.getServantData().getCost() + "?",
//		    "Yes", "No", "Fire.");
//	    stage = 14;
//	} else if (stage == 14) {
//	    if (componentId == OPTION_1) {
