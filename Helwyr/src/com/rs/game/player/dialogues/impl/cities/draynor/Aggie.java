...
public class Aggie extends Dialogue {
	...
	public void start() {
		...
		case NOT_STARTED:
			if(stage != -3) {
				sendNPCChat(Mood.ASKING, "What can I help you with?");
				stage = 1;
			} else {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 2:
			switch(componentId) {
			case OPTION_1:
				sendNPCChat(Mood.NORMAL, "My, you're observant!");
				stage = 3;
				break;
			case OPTION_2:
				sendNPCChat(Mood.ASKING, "You don't really expect me to give away trade secrets, do " + 
						"you?");
				stage = -2;
				break;
			case OPTION_3:
				sendNPCChat(Mood.ANGRY, "The blood sucker has returend to Draynor Manor. I hate "
						+ "his kind.");
				stage = 5;
				break;
			case OPTION_4:
		...
		case 3:
			sendPlayerChat(Mood.ASKING, "Cool, do you turn people into frogs?");
			stage = 4;
			break;

		case 4:
			sendNPCChat(Mood.NORMAL, "Oh, not for years. But if you meet a talking chicken, you " + 
		...
		case 5:
			sendPlayerChat(Mood.ASKING, "The blood sucker?");
			stage = 6;
			break;

		case 6:
			sendPlayerChat(Mood.SAD, "Yes, Court Draynor, the vampyre. He's preying on the " +
		...
		case 7:
			sendPlayerChat(Mood.SAD, "Wow, that's sad.");
			stage = -2;
			break;
		...
		case 8:
			switch(componentId) {
			case OPTION_1:
				sendNPCChat(Mood.NORMAL, "I mostly just make what I find pretty. I sometimes make " + 
				...
				break;
			case OPTION_2:
				sendNPCChat(Mood.ASKING, "What sort of dye would you like? Red, yellow or blue?");
				stage = 13;
				break;
			case OPTION_3:
				sendOptionsDialogue(DEFAULT, "Hey, you're a witch aren't you?", "So what is actually in that cauldron?", "What's new in Draynor Village?", "More...");
		...
		case 10:
			switch(componentId) {
			case OPTION_1:
				sendNPCChat(Mood.NORMAL, "3 lots of redberries and 5 coins to you.");
				stage = 11;
				break;
			case OPTION_2:
				sendNPCChat(Mood.NORMAL, "Yellow is a strange colour to get, comes from onion skins.",
						"I need 2 onions and 5 coins to make yellow dye.");
				stage = 15;
				break;
			case OPTION_3:
				sendNPCChat(Mood.NORMAL, "2 Woad leaves and 5 coins to you.");
				stage = 17;
				break;
			case OPTION_4:
				sendNPCChat(Mood.NORMAL, "You are easily pleased with yourself then.",
		...
		case 12:
			...
			case OPTION_1:
				...
				if(player.getInventory().contains(REDBERRIES) && player.getMoneyPouch().getCoinsAmount() >= 5) {
					player.getInventory().deleteItem(REDBERRIES);
					player.getMoneyPouch().removeFromMoneyPouch(5);
					make(1763);
				...
				break;
			case OPTION_2:
				sendNPCChat(Mood.NORMAL, "You know what you need to get, now come back when you",
						"have them. Goodbye for now.");
				stage = -2;
				break;
			case OPTION_3:
				sendNPCChat(Mood.NORMAL, "That's your choice, but I would think you have killed for",
						"less. I can see it in your eyes.");
				stage = -2;
				break;
			case OPTION_4:
				sendNPCChat(Mood.NORMAL, "I pick mine from the woods south of Varrock. The food",
						"shop port in Port Sarim sometimes has some as well.");
				stage = 13;
				break;
			case OPTION_5:
				sendNPCChat(Mood.NORMAL, "Red, yellow, and blue. Which one would you like?");
				stage = 9;
				break;
			}
			break;
		...
		case 14:
			switch(componentId) {
			case OPTION_1:
				sendNPCChat(Mood.ASKING, "Red, yellow and blue. Which one would you like?");
				stage = 9;
				break;
			case OPTION_2:
				sendNPCChat(Mood.HAPPY, "You're Welcome!");
				stage = -2;
				break;
			}
			break;
		...
		case 16:
			...
			case OPTION_1:
				...
				if(player.getMoneyPouch().getCoinsAmount() < 5) {
					sendDialogue("You don't have enough coins.");
					stage = -2;
					return;
				}
				if(player.getInventory().contains(ONIONS) && player.getMoneyPouch().getCoinsAmount() >= 5) {
			...
			case OPTION_3:
				...
				break;
			case OPTION_4:
				sendNPCChat(Mood.NORMAL, "There are some onions growing on a farm to East of",
		...
		case 18:
			...
			case OPTION_3:
				...
				break;
			case OPTION_4:
				sendNPCChat(Mood.NORMAL, "Woad leaves are fairly hard to find. My other customers",
		...
		case 20:
			...
			case OPTION_1:
				if(!hasIngredients(player)) {
					sendNPCChat(Mood.NORMAL, "Why it's one of my most popular potions. The women", "here, they like to have smooth looking skin. And I must", "admit, some of the men buy it as well.");
					stage = 21;
				} else {
					sendNPCChat(Mood.HAPPY, "Yes I can, I see you already have the ingredients.", "Would you like me to mix some for you now?");
					stage = 24;
				}
				break;
			case OPTION_2:
			...
			case OPTION_3:
				...
				break;
			case OPTION_4:
				sendNPCChat(Mood.ANGRY, "Oh, you like to call a witch names do you?");
				stage = 31;
				break;
			case OPTION_5:
				sendNPCChat(Mood.ASKING, "What sort of dye would you like? Red, yellow or blue?");
		...
		case 21:
			sendNPCChat(Mood.NORMAL, "I can make it for you, just get me what's needed.");
			stage = 22;
			break;

		case 22:
			sendPlayerChat(Mood.ASKING, "What do you need to make it?");
			stage = 23;
			break;

		case 23:
			sendNPCChat(Mood.NORMAL, "Well dearie, you need a base of the paste. That's a",
		...
		case 25:
			switch(componentId) {
			case OPTION_1:
				sendPlayerChat(Mood.NORMAL, "Yes please. Mix me some skin paste.");
				stage = 26;
				break;
			case OPTION_2:
				sendNPCChat(Mood.NORMAL, "Okay dearie, that's always your choice.");
				stage = -2;
				break;
			}
			break;
		...
		case 26:
			sendNPCChat(Mood.NORMAL, "That should be simple. hand the things to Aggie then.");
			stage = 27;
			break;
		...
		case 28:
			sendNPCChat(Mood.NORMAL, "Tourniquet, Fenderbaum, Tottenham, marshmaallow,", "MarbleArch.");
			make(2424);
			stage = 29;
			break;
		...
		case 30:
			sendNPCChat(Mood.NORMAL, "There you go dearie, your skin potion. That will make", "you look good at the Varrock dances.");
			stage = -2;
			break;

		case 31:
			if(player.getMoneyPouch().getCoinsAmount() < 20) {
				sendNPCChat(Mood.ANGRY, "You should be careful about insulting a witch. You", "never know what shape you could wake up in.");
				stage = -2;
				return;
			} else {
				sendItemDialogue(1001, "Aggie waves her hands about, and you seem to be 20", "coins poorer.");
				player.getMoneyPouch().removeFromMoneyPouch(20);
				stage = -2;
			}
			break;
