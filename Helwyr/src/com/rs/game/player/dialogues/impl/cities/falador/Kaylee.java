...
public class Kaylee extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			...
			break;
		case 0:
			sendNPCDialogue(npcId, HAPPY, "Well, we've got Asgarnian Ale, Wizard's Mind Bomb", "and Dwarven Stout, all for only 3 coins.");
			stage = 1;
			break;
		case 1:
			sendOptionsDialogue(DEFAULT, "One Asgarnian Ale, please.", "I'll try the Mind Bomb.", "Can I have a Dwarven Stout?", "I don't feel like any of those.");
			stage = 2;
			break;
		case 2:
			switch(componentId) {
		...
		case 3:
			...
			sendNPCDialogue(npcId, SAD, "Sorry, you don't have enough coins to buy this.");
			stage = 25;
		}
			break;
		case 4:
