...
public class Olivia extends Dialogue {
	...
	public void start() {
		...
		npc(npcId, HAPPY, "Would you like to trade in seeds?");
	}
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			options(DEFAULT, "Yes", "No.", "Where do I get higher-level seeds from?");
			stage = 1;
			break;
		...
		case 1:
			...
			case OPTION_2:
				...
				break;
			case OPTION_3:
				npc(npcId, NORMAL, "Master farmers usually carry a few higher-level seeds",
