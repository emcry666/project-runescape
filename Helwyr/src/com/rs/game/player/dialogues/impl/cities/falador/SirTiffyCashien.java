...
public class SirTiffyCashien extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			sendNPCDialogue(npcId, HAPPY, "What ho, sirrah.", "Spiffing day for a walk in the park, what?");
			stage = 0;
			break;
		case 0:
			...
			break;
		case 1:
			sendNPCDialogue(npcId, HAPPY, "Absolutely, top-hole!", "Well, can't stay and chat all day, dontchaknow!", "T-ta for now!");
			stage = 2;
			break;
		case 2:
