...
public class MonkOfEntrana extends Dialogue {
	...
	public void start() {
		...
		sendNPCDialogue(npcId, PLAIN_TALKING, "Do you seek passage to holy Entrana? If so, you must", "leaves you weaponry and armour behind - this is", "Saradomin's will.");
	}
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			sendOptionsDialogue(DEFAULT, "Yes, okay, I'm ready to do.", "No, not right now.");
			stage = 0;
			break;
		case 0:
			switch(componentId) {
