...
public class CreateOublietteD extends Dialogue {
	...
	sendOptionsDialogue("This trapdoor does not lead anywhere. Do you want to build a oubliette at the bottom?",
		"Yes.", "No.");
	...
	if (componentId == OPTION_1) {
	    ...
	    if (slot != -1) {
		RoomReference newRoom = new RoomReference(Room.OUTBLIETTE, room.getX(), room.getY(), 0,
			room.getRotation());
