...
public class Betty extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			sendOptionsDialogue(DEFAULT, "Can I see your wares?", "Sorry, I'm not into Magic.");
			stage = 0;
			break;
		case 0:
			switch(componentId) {
			...
			break;
		case 1:
			sendNPCDialogue(npcId, HAPPY, "Well, if you see anyone who is into Magic, please send", "them my way.");
			stage = -2;
			break;
		case -2:
			end();
