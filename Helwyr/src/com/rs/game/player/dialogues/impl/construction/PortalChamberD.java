...
public class PortalChamberD extends Dialogue {
	...
	sendDialogue(
		"To direct a portal you ned enough runes for 100 castings of that teleport spell. \n(Combination runes and staffs cannot be used.)");
    }
	...
	if (stage == -1) {
	    ...
	    sendOptionsDialogue("Redirect which portal?",
		    ...
		    existingPortals[2] ? OPTION_NAMES[tertiaryFrame] : "No portal frame", "Cancel");
	    stage = 0;
	} else if (stage == 0) {
	    if (componentId >= OPTION_1 && componentId <= OPTION_3) {
		redirectSlot = componentId - 3;
