...
public class SilkTrader extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		switch(stage) {
		case -1:
			sendOptionsDialogue(DEFAULT, "How much are they?", "No, silk doesn't suit me.");
			stage = 0;
		break;
		case 0:
			switch(componentId) {
		...
		case 1:
			...
			break;
		case 2:
			sendOptionsDialogue(DEFAULT, "No, that's too much for me.", "Okay, that sounds good.");
			stage = 3;
			break;
		case 3:
			switch(componentId) {
		...
		case 4:
			...
			break;
		case 5:
			sendNPCDialogue(npcId, SAD, "I'm not selling it for any less. You'll only go and sell it in Varrock for a profit.");
			stage = 6;
			break;
		case 6:
			sendOptionsDialogue(DEFAULT, "2gp sounds good.", "No, really, I don't want it.");
			stage = 7;
			break;
		case 7:
			switch(componentId) {
		...
		case 8:
			if (player.getInventory().containsItem(GOLD, 2)) {
				sendHandedItem(SILK, "You buy some silk for 2gp.");
		...
		case 9:
			if (player.getInventory().containsItem(GOLD, 3)) {
				sendHandedItem(SILK, "You buy some silk for 3 gp.");
			...
			break;
		case 10:
			sendNPCDialogue(npcId, NORMAL, "Okay, but that's the best price you're going to get.");
			stage = -2;
			break;
		case 11:
			sendNPCDialogue(npcId, MILDLY_ANGRY, "Well, come back when you do have some money.");
			stage = -2;
			break;
		case -2:
			end();
