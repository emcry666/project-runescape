		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your crops have fully grown at Catherby, allotment A.</col>");
				...
				player.sm("You'll need some potato seeds.");
			}
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 10);
					player.sm("<col=FF0000>[Notice] Your crops have fully grown at Catherby, allotment B.</col>");
	...
	public static void plantMelonCA(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.sm("You'll need some melon seeds.");
			}
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your Sweetcorn has fully grown at Catherby, Allotment A.</col>");
					player.canHarvestCA = true;
				}
					loop++;
					}
				...
				player.sm("You'll need a Sweetcorn Seed.");
			}
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 40);
					player.sm("<col=FF0000>[Notice] Your Sweetcorn has fully grown at Catherby, Allotment B.</col>");
					player.canHarvestCB = true;
				}
					loop++;
					}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your herbs are fully grown at Catherby.</col>");
				...
				player.sm("You'll need some guam seeds.");
			}
	}
	
	public static void plantRanarrC(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.sm("You'll need some ranarr seeds.");
			}
	}
	...
	public static void plantDwarfC(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.sm("You'll need some dwarf weed seeds.");
			}
	}
	...
	public static void plantSnapC(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.sm("You'll need some snapdragon seeds.");
			}
	}
	...
	public static void plantTorstolC(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				player.sm("You'll need some Torstol seeds.");
			}
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your Marigolds are fully grown at Catherby.</col>");
				...
				player.sm("You'll need some Marigold seeds.");
			}
	}
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.sm("<col=FF0000>[Notice] Your White Lily's have fully grown at Catherby.</col>");
					player.canHarvestFlowerCA = true;
				}
					loop++;
					}
				...
				player.sm("You'll need some White Lily seeds.");
			}
	}
}
