...
public class Hunter {
	...
	public enum FlyingEntities {
		...
		DRAGON_IMPLING(6054, 11256, 390, 553, 83, new Item[] {
				new Item(11212, 100), new Item(11212, 300),
				new Item(11212, 500), new Item(9341, 40), new Item(9341, 20),
				new Item(9341, 1), new Item(1305, 1), new Item(11232, 105),
				new Item(11237, 100), new Item(535, 111) }, new Item[] {
				new Item(5316, 1), new Item(537, 52), new Item(537, 70),
				new Item(537, 80), new Item(537, 99), new Item(1616, 3),
				new Item(1616, 6), new Item(1216, 3), new Item(11230, 150),
				new Item(11230, 105), new Item(11230, 250),
				new Item(11230, 350), }, new Item[] { new Item(5300, 6),
				new Item(7219, 15), new Item(7219, 5), new Item(1705, 3),
				new Item(1705, 1) }, new Item[] { new Item(4093, 1),
				new Item(5547, 1), new Item(1703, 1), new Item(1703, 3) }),

		PIRATE_IMPLING(7845, 13337, 350, 497, 76, new Item[] {
				new Item(2358, 15), new Item(7110, 1), new Item(7122, 1),
				new Item(7128, 1), new Item(7134, 1), new Item(13358, 1),
				new Item(13360, 1), new Item(13362, 1), new Item(7116, 1),
				new Item(7126, 1), new Item(7132, 1), new Item(7138, 1),
				new Item(13364, 1), new Item(13366, 1), new Item(13368, 1),
				new Item(7112, 1), new Item(7124, 1), new Item(7130, 1),
				new Item(7136, 1), new Item(8949, 1), new Item(13370, 1),
				new Item(13372, 1), new Item(13374, 1), new Item(8927, 1),
				new Item(8924, 1), new Item(8926, 1), new Item(8925, 1) }, // common
				new Item[] { new Item(7114, 1), new Item(13355, 1) }, // uncommon
				new Item[] { new Item(995, 1) }, // rare
				new Item[] { new Item(8951, 1), new Item(8951, 3),
						new Item(8951, 5) }), // very rare

		ZOMBIE_IMPLING(7902, 15515, 412, 585, 87, new Item[] {
				new Item(533, 5), new Item(533, 10), new Item(533, 15),
				new Item(535, 2), new Item(535, 4), new Item(535, 6),
				new Item(537, 3), }, new Item[] { new Item(10977, 1),
				new Item(10976, 1), }, new Item[] { new Item(4831, 3),
				new Item(4833, 2), new Item(4835, 1), }, new Item[] { new Item(
				4034, 1) }),
		...
		EARTH_IMPLING(1031, 11244, 126, 177, 36, new Item[] { new Item(444, 1),
				...
				new Item(6032, 1), new Item(24767, 1) }, new Item[] {
				new Item(237, 1), new Item(447, 1), new Item(1273, 1),
				new Item(454, 6), new Item(1487, 1), new Item(5311, 2),
				new Item(5294, 2) }, new Item[] { new Item(448, 1),
				new Item(1606, 2), new Item(6035, 2), }, new Item[] {
				...
				if (isSuccessful(player, instance.getLevel(),
					...
					if (player.getInventory().addItem(
						...
						if (player.getDailyTask() != null)
							player.getDailyTask().incrementTask(player, 3, instance.getReward(), Skills.HUNTER);
						player.getPackets().sendGameMessage(
	...
	public static void createLoggedObject(Player player, WorldObject object,
		...
		if (World.removeObjectTemporary(object, 300000)) {// five minute delay
			World.spawnObjectTemporary(new WorldObject(kebbits ? 19206 : -1,
	...
	public static void setupNetTrap(Player player, WorldObject object) {
		...
		if (!player.getInventory().containsItem(303, 1)) {
			player.output("You need a small fishing net to setup that trap.");
			return;
		}
		if (!player.getInventory().containsItem(954, 1)) {
			player.output("You need a rope to setup that trap.");
			return;
		}
		...
		OwnedObjectManager.addOwnedObjectManager(player,
				new WorldObject[] { new WorldObject(trapId, object.getType(),
						object.getRotation(), player.getX(), player.getY(),
						player.getPlane()) }, new long[] { 300000 });
	}
	...
	public static boolean isSuccessful(Player player, int dataLevel,
		...
		/*
		 * int increasedProbability = formula == null ? 1 :
