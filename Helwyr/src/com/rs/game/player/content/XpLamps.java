...
public class XpLamps {
	...
	player.getDialogueManager().startDialogue(new Dialogue() {
		...
		if (componentId >= 13 && componentId <= 37) {
		    ...
		    dialogue("<col=0000ff>Your wish has been granted!</col>", "You have been awarded " + Utils.getFormattedNumber(exp, ',') + " XP in " + Skills.SKILL_NAME[selectedSkill] + "!");
		}
	...
	player.getDialogueManager().startDialogue(new Dialogue() {
	    @Override
	    public void start() {
		options("Rub Lamp?", "Gain <col=ff0000>" + Skills.SKILL_NAME[skillId] + "</col> experience", "Cancel");
	    }
		...
		if (componentId != Dialogue.OPTION_1 || !player.getInventory().containsItem(id, 1)) {
		    ...
		    dialogue("<col=0000ff>Your wish has been granted!</col>", "You have been awarded " + Utils.getFormattedNumber(exp, ',') + " XP in " + Skills.SKILL_NAME[skillId] + "!");
	    }
