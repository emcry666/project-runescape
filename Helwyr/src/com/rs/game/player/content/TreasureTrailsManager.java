...
public class TreasureTrailsManager implements Serializable {
	...
	public boolean useItem(Item item, int slot) {
		...
		if (level != -1) {
			...
			if (currentClue.details.type == SIMPLE || currentClue.details.type == ANAGRAM) {
				...
				for (int i = 0; i < 8; i++)
					player.getPackets().sendIComponentText(345, i + 1, "");
				player.getPackets().sendIComponentText(345, 4, ((Integer) currentClue.details.parameters[0] <= 9 ? "0" : "") + currentClue.details.parameters[0] + " degrees, " + ((Integer) currentClue.details.parameters[1] <= 9 ? "0" : "")
						+ currentClue.details.parameters[1] + " minutes " + ((Integer) currentClue.details.parameters[2] == NORTH ? "north" : "south"));
				player.getPackets().sendIComponentText(345, 5, ((Integer) currentClue.details.parameters[3] <= 9 ? "0" : "") + currentClue.details.parameters[3] + " degrees, " + ((Integer) currentClue.details.parameters[4] <= 9 ? "0" : "")
	...
	public void useEmote(int id) {// returned it all true because it wont stop
		...
		if (currentClue == null)
			...
			player.sendMessage("Hint has been given: "+new WorldTile(currentClue.details.id).toString());
			return;
		}
	...
	private Item[] generateRewards(int level) {
		...
		for (Item reward : rewards)
			rewards[count++] = new Item(reward.getId(), reward.getAmount() > 1 ? 1 + Utils.random(reward.getAmount() * Settings.getDropRate(player)) : 1);
		return rewards;
	}
	...
	public static final String[] UGIS_QUOTES = new String[] { "I saw bo once, he gave me pokemon.", "Once, I was a poor man, but then I found a party hat.", "There were three goblins in a bar, which one left first?",
	...
	private static enum ClueDetails {
		...
		EMOTE_B_7(
				...
				"and no jewellery."),
		EMOTE_B_8(EASY, EMOTE, TILE, 55200971, new int[] { 4 }, new Item[] { new Item(1101, 1), new Item(1095, 1), new Item(1169, 1) }, "Bow or curtsy in the lobby", "of the Duel Arena.", "Equip an iron chainbody,", "leather chaps and a coif."),
		EMOTE_B_9(
				EASY,
				EMOTE,
				TILE,
		...
		EMOTE_C_2(EASY, EMOTE, TILE, 47648172, new int[] { 9 }, new Item[] { new Item(5527, 1), new Item(1307, 1), new Item(1692, 1) }, "Cheer at the druids circle,", "equip an Air tiara, a bronze 2h sword,", "and Gold amulet."),
		...
		EMOTE_C_7(EASY, EMOTE, TILE, 51022956, new int[] { 22 }, new Item[] { new Item(1137, 1), new Item(1639, 1), new Item(1059, 1) }, "Clap on the causeway to", "the Wizard's Tower.", " Equip an Iron helm, emerald ring", "and leather gloves."),
		EMOTE_C_8(
				EASY,
				EMOTE,
				TILE,
		...
		EMOTE_H_1(EASY, EMOTE, TILE, 54086900, new int[] { 17 }, new Item[] { new Item(1059, 1), new Item(1061, 1) }, "Headbang in the mine", "north of Al-kharid.", "Equip Leather Gloves", "and Leather Boots."),
		EMOTE_J_1(
				EASY,
				EMOTE,
				TILE,
		...
		EMOTE_P_1(HARD, EMOTE, TILE, 59231649, new int[] { 20 }, new Item[] {}, "Panic in the heart of", "the Haunted Woods.", "Beware of double agents!", "Have no items equipped when you do."),
		...
		EMOTE_W_1(EASY, EMOTE, TILE, 49138733, new int[] { 7 }, new Item[] { new Item(1635, 1), new Item(1095, 1), new Item(1424, 1) }, "Wave on Mudskipper Point. Equip a gold ring, leather chaps and a steel mace. "),
		EMOTE_W_2(
				EASY,
				EMOTE,
				TILE,
	...
	, new Item(2591), new Item(2593), new Item(2595), new Item(2597), new Item(3473) // Gold-trimmed
			...
			, new Item(7332), new Item(7338), new Item(7344), new Item(7350), new Item(7356), new Item(10306), new Item(10308), new Item(10310), new Item(10312), new Item(10314), new Item(19167), new Item(19169), new Item(19171), new Item(19188),
			new Item(19190), new Item(19192), new Item(19209), new Item(19211), new Item(19213), new Item(19230), new Item(19232), new Item(19234), new Item(19251), new Item(19253), new Item(19255), new Item(10404), new Item(10406), new Item(10424),
			new Item(10426) // Red
			// elegant
			// costumes
	...
	private static final Item[] MEDIUM_NORMAL_REWARDS = {
			// adamant weapons
			new Item(803, 100), new Item(810, 100), new Item(829, 100), new Item(867, 100), new Item(1211), new Item(1245), new Item(1271), new Item(1287), new Item(1301), new Item(1317), new Item(1331), new Item(1345), new Item(1357), new Item(1371),
			new Item(1430), new Item(9183)
			// adamant armour
	...
	, new Item(2607), new Item(2609), new Item(2611), new Item(2613), new Item(3475) // Gold-trimmed
			...
			, new Item(7334), new Item(7340), new Item(7346), new Item(7352), new Item(7358), new Item(10296), new Item(10298), new Item(10300), new Item(10302), new Item(10304), new Item(19173), new Item(19175), new Item(19177), new Item(19194),
			new Item(19196), new Item(19198), new Item(19215), new Item(19217), new Item(19219), new Item(19236), new Item(19238), new Item(19240), new Item(10400), new Item(10402), new Item(10420), new Item(10422) // black
																																																						// +
																																																						// white
																																																						// elegant
																																																						// costume
	...
	private static final Item[] HARD_NORMAL_REWARDS = {
			// rune weapons
			new Item(805, 100), new Item(811, 100), new Item(830, 100), new Item(868, 100), new Item(1213), new Item(1247), new Item(1275), new Item(1289), new Item(1303), new Item(1319), new Item(1333), new Item(1347), new Item(1359), new Item(1373),
			new Item(1432), new Item(9185)
			// rune armor
	...
	, new Item(2615), new Item(2617), new Item(2619), new Item(2621), new Item(3476) // Gold-trimmed
			...
			, new Item(7336), new Item(7342), new Item(7348), new Item(7354), new Item(7360), new Item(10286), new Item(10288), new Item(10290), new Item(10292), new Item(10294), new Item(19179), new Item(19182), new Item(19185), new Item(19200),
			new Item(19203), new Item(19206), new Item(19221), new Item(19224), new Item(19227), new Item(19242), new Item(19245), new Item(19248), new Item(19263), new Item(19266), new Item(19269), new Item(10346), new Item(10348), new Item(10350),
	...
	, new Item(19413), new Item(19416), new Item(19419), new Item(19422), new Item(19425) // Armadyl
			...
			// animal
			// masks
			, new Item(33294), new Item(33296), new Item(33298)// Teir 90 dyes
	};
