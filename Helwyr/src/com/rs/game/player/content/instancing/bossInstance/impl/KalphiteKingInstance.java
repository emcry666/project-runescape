package com.rs.game.player.content.instancing.bossInstance.impl;
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (!KalphiteKingInstance.this.isInstanceReady())
					return;
				KalphiteKing king = (KalphiteKing) World.spawnNPC(16697 + Utils.random(3), getTile(2974, 1759, 0), -1,
