...
import com.rs.game.player.content.instancing.bossInstance.impl.KalphiteKingInstance;
import com.rs.game.player.content.instancing.bossInstance.impl.KingBlackDragonInstance;
import com.rs.game.player.content.instancing.bossInstance.impl.VoragoInstance;
...
public class BossInstanceHandler {
	...
	public static enum Boss {
		King_Black_Dragon(KingBlackDragonInstance.class, 50000, 200, false, true, new WorldTile(3051, 3520, 0),
				new WorldTile(2273, 4681, 0), null, "BossInstanceController", 14),

		Araxxi(AraxxiInstance.class, 0, 50, false, false, new WorldTile(4486, 6266, 1), new WorldTile(4490, 6266, 1),
				new WorldTile(3542, 3310, 0), "AraxxiInstanceController", 1155),

		/*Kalphite_Queen(KalphiteQueenInstance.class, 100000, 200, false, true, new WorldTile(3446, 9496, 0),
		new WorldTile(3508, 9494, 0), null, "KalphiteQueenInstanceController", 212),

	Exiled_Kalphite_Queen(ExiledKalphiteQueenInstance.class, 100000, 200, false, true, new WorldTile(2995, 1617, 0),
		new WorldTile(2967, 1711, 0), null, "KalphiteQueenInstanceController", 212),

	Dagannoth_Kings(DagannothKingsInstance.class, 150000, 200, false, true, new WorldTile(1912, 4367, 0),
		new WorldTile(2900, 4449, 0), null, "DagannothKingsInstanceController", 365),

	Corporeal_Beast(CorporealBeastInstance.class, 300000, 200, false, true, new WorldTile(2970, 4384, 2),
		new WorldTile(2974, 4384, 2), null, "CorporealBeastInstanceController", 617),*/

		Kalphite_King(KalphiteKingInstance.class, 0, 200, false, false, new WorldTile(2971, 1656, 0),
				new WorldTile(2974, 1746, 0), null, "KalphiteKingInstanceController", 1140),

		Vorago(VoragoInstance.class, 1000000, 50, true, true, new WorldTile(2972, 3431, 0),
				new WorldTile(3043, 6100, 0), new WorldTile(3072, 6176, 0), "VoragoInstanceController", 1155)
