...
public class TrimCompletionistRequirements {
	...
	public static void init() {
		try {
			System.out.println("[Achievement] -> : Loading Trimmed Completionist Achievements...");
			BufferedReader reader = new BufferedReader(new FileReader("./data/content/tcompletionist.ini"));
			String line = "";
			int count = 0;
