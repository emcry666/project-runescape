...
public class DungeonManager {
	...
	public void loadRewards() {
		...
		for (Player player : party.getTeam()) {
			...
			player.getDungManager().setTokens(player.getDungManager().getTokens() + tokens);
			player.getMusicsManager().forcePlayMusic(770);
			if (!tickedOff) {
	...
	public void setRewardsTimer() {
		GameEngine.fastExecutor.schedule(rewardsTimer = new RewardsTimer(), 1000, 5000);
	}
	...
	public void setDestroyTimer() {
		...
		GameEngine.fastExecutor.schedule(destroyTimer = new DestroyTimer(), 1000, 5000);
	}
