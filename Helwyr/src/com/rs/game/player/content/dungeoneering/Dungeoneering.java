...
import com.rs.game.npc.ndung.FrostWeb;
import com.rs.game.npc.ndung.NDungeonBoss;
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(Dungeon dungeon, int[] pos) {
					...
					int npcId = getBossId(1,
							...
							"Gluttonous behemoth");
					NDungeonBoss boss = new NDungeonBoss(npcId, new WorldTile(
			...
			new BossRoom(new RoomEvent() {
				...
				public void openRoom(Dungeon dungeon, int[] pos) {
					int npcId = getBossId(1,
							...
							"Astea Frostweb");
					WorldTile base = dungeon.getBaseCoords(pos);
					new FrostWeb(npcId, new WorldTile(base.getX() - 1,
