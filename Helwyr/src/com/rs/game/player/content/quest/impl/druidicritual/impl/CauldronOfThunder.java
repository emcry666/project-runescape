	...
	public static void dipItem(final Player player, Item item) {
		...
		switch (item.getId()) {
			...
			case 2132:
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						player.output("You dip Raw Beef into the cauldron.");
			...
			case 2134:
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						player.output("You dip Raw Rat Meat into the cauldron.");
			...
			case 2138:
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						player.output("You dip Raw Chicken into the cauldron.");
			...
			default:
				...
				player.output("You can not dip this item.");
