...
public class GoblinDiplomacy extends Quest implements Serializable{
    ...
    public QuestReward[] getRewards() {
        return new QuestReward[] {new QuestReward(RewardType.EXPERIENCE, Skills.CRAFTING, 200), new QuestReward(RewardType.ITEM, new Item(GOLD_BAR, 1))};
    }
    ...
    private QuestJournal journal = new QuestJournal() {
        ...
        public QuestJournal display(int stage) {
            ...
            addLog(new Entry(""), new Entry("I can start this quest by speaking to " + keyWord("Generals Wartface ")) {
                       @Override
