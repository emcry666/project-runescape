...
public class GillieGroats extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 3:
			...
			break;
		case 4:
			sendNPCDialogue(npcId, HAPPY, "You can buy empty buckets from the general store in", "Lumbridge, south-west of here, or from most general", "stores in Avalon. You can also buy them from the", "Grand Exchange in Varrock.");
			stage = 5;
			break;
		case 5:
