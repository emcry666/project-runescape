...
private Map<String, String> data = new HashMap<String, String>();
	...
	public void acceptQuest() {
		...
		player.getInterfaceManager().sendTab(player.getInterfaceManager().hasRezizableScreen() ? 114 : 174, 190);
		player.getPackets().sendUnlockIComponentOptionSlots(190, 15, 0, 201, 0, 1,
				2, 3);
		stage = 1;
		accept();
	}
	...
	public Quest openJournal() {
		...
		player.getInterfaceManager().sendScreenInterface(96, 275);
		String text = "";
