...
public class Sanfew extends Dialogue {
	...
	public void start() {
		...
		if (progress == 10) {
			sendNPCDialogue(npcId, NORMAL, "What can I do for you young 'un?");
			stage = 4;
		} else if (progress == 20) {
			sendNPCDialogue(npcId, NORMAL, "Did you bring me the required ingredients for the potion?");
			stage = 26;
		} else {
			//TODO
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			...
			break;
		case 0:
			sendNPCDialogue(npcId, BLANK, "Herblore eh? You're probably best off talking to", "Kaqemeex about that; he's the best Herblore teacher we", "currently have. I believe at the moment he's at our stone", "circle just north of here.");
			stage = 1;
			break;
		case 1:
			sendNPCDialogue(npcId, BLANK, "'Course he's just the best teacher. You don't need him to", "show you how it works. Not like in my day. Back then you", "had to go running all over the place before you so much as", "learned how to wipe muck off a leaf.");
			stage = 2;
			break;
		case 2:
			sendNPCDialogue(npcId, SAD, "Still, that's what the kids are all like these days. No time", "to stop and listen to a teacher. With their 'rune armour',", "and their 'chilly-chompers' and their loud music...");
			stage = 3;
			break;
		case 3:
		...
		case 5:
			...
			case OPTION_1:
				...
				break;
			case OPTION_2:
				sendNPCDialogue(npcId, BLANK, "Well, we all make mistakes sometimes.");
				stage = 50;
				break;
			}
			break;
		case 6:
			sendNPCDialogue(npcId, BLANK, "Well, what I'm struggling with right now is the meats", "needed for the potion to honour Guthix. I need the raw", "meat of four dirrerent animals for it, but not just any", "old meats will do.");
			stage = 7;
			break;
		case 7:
			sendNPCDialogue(npcId, BLANK, "Each meat has to be dipped individually into the", "Cauldron of Thunder for it to work correctly.");
			quest.setStage(20);
			stage = 8;
			break;
		case 8:
		...
		case 9:
			...
			break;
		case 10:
			sendNPCDialogue(npcId, BLANK, "It's located somewhere in the mysterious underground", "halls which are located somewhere in the woods just", "South of here. They are too dangerous for me to go", "myself however.");
			stage = 8;
			break;
