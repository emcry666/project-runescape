...
public class LumbridgeCook extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 10:
			...
			break;
		case 11:
			if (player.getInventory().contains(CooksAssistant.BUCKET_OF_MILK) ||
					player.getInventory().contains(CooksAssistant.EGG) ||
					player.getInventory().contains(CooksAssistant.POT_OF_FLOUR)) {
		...
		case 12:
			if (player.getInventory().contains(CooksAssistant.BUCKET_OF_MILK)) {
				...
				stage = 13;
			} else if (player.getInventory().contains(CooksAssistant.EGG)) {
				...
				stage = 13;
			} else if (player.getInventory().contains(CooksAssistant.POT_OF_FLOUR)) {
		...
		case 38:
			...
			player.getQuestManager().get(Quests.COOKS_ASSISTANT).finish();
			player.getQuestManager().get(Quests.COOKS_ASSISTANT).sendReward();
			stage = 10;
			break;
		}
