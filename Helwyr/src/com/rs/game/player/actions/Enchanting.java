...
public class Enchanting {
	...
	public static void processMagicEnchantSpell(Player player, int slot,
		...
		if (secondaryIndex == -1) {
			player.sm("This spell can only be cast on amulets, necklaces, rings, braclets or shapes in the training arena.");
			return;
	...
	public static void processBoltEnchantSpell(Player player, final int index,
		...
		player.getActionManager().setAction(new Action() {
			...
			public int processWithDelay(Player player) {
				...
				player.getInventory().addItemMoneyPouch(BOLT_PRODCUTS[index],
						createdCount);
