...
public class SiphonActionCreatures extends Action {
	...
	private static enum Creature {
		...
		DEATH_ESSWRAITH(15414, 95, 24219, 16644, 65, 16641),

		BLOOD_ESSWRAITH(15415, 120.1, 24225, 16644, 77, 16641),

		SOUL_ESSWRAITH(15416, 156.5, 24226, 16644, 90, 16641);
	...
	public static boolean chipCreature(Player player, NPC npc) {
		...
		if (!player.getInventory().containsItem(creature.getRuneId(), 10)) {
		    player.getPackets().sendGameMessage(
			    "You dont have enough " + ItemDefinitions.getItemDefinitions(creature.getRuneId()).getName()
