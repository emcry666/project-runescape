...
public class Slayer {
	...
	public enum Master {
		...
		VANNAKA(
				...
				40, 1, new int[] { 60, 135 }, "Bats", "Crawling hands",
		...
		CHAELDAR(
				...
				70, 1, new int[] { 56, 150 }, "Banshees", "Spiders",
		...
		SUMONA(
				...
				85, 35, new int[] { 63, 142 }, "Aberrant spectres",
		...
		LAPALOK(
				...
				100, 50, new int[] { 75, 156 }, "Aberrant spectres",
				"Gargoyles", "Abyssal demons", "Black demons", "Black Dragons",
				"Bloodvelds", "Dogs", 1594, "Dark beasts", "Dagannoth", "Kalphites",
				"Iron dragons", "Steel dragons",
				"Mithril dragons", "Nechryael", "Spiritual mages", "Suqahs",
				"Greater demons", "Fire giant", "Hellhounds"),

		KURADAL(9084, "", 110, 75, new int[] { 85, 185 }, "Aberrant spectres",
