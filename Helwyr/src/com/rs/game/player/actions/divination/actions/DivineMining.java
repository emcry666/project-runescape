...
public final class DivineMining extends MiningBase {
	...
	public enum RockDefinitions {
		...
		DIVINE_RUNE_ORE(85, 125, 451, 10, 10, 87290, 360, -1), DIVINE_ADAMANTITE_ORE(70, 125, 449, 10, 10, 87289, 360,
				-1), DIVINE_MITHRIL_ORE(55, 125, 447, 10, 10, 87288, 360, -1), DIVINE_COAL_ORE(30, 125, 453, 10, 10,
						87287, 360, -1), DIVINE_IRON_ORE(15, 125, 440, 10, 10, 87286, 360, -1), DIVINE_BRONZE_ORE(1,
								125, 436, 10, 10, 87285, 360, -1);
		...
		if (definitions.getEmptyId() != -1) {
			if (!usedDeplateAurora && (1 + Math.random()) < player.getAuraManager().getChanceNotDepleteMN_WC()) {
				usedDeplateAurora = true;
					...
					&& definitions != RockDefinitions.DIVINE_COAL_ORE && definitions != RockDefinitions.DIVINE_IRON_ORE
