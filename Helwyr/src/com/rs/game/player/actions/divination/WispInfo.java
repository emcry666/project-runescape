...
public enum WispInfo {
    ...
    PALE(18150, 1), FLICKERING(18151, 10), BRIGHT(18153, 20), GLOWING(18155, 30), SPARKLING(18157, 40), GLEAMING(18159,
	    50), VIBRANT(18161, 60), LUSTROUS(18163, 70), BRILLIANT(18165, 80), RADIANT(18167, 85), LUMINOUS(18169,
		    90), INCANDESCENT(18171, 95);
