...
public class Thieving {
	...
	public enum Stalls {
		...
		MONKEY_GENERAL(4876, 1, new int[] { 2347, 590, 1931, 946 }, 1, 7, 100, 4876),
		
		MONKEY_FOOD(4875, 50, new int[] { 1963, 385, 379, 373, 15272, 329, 373 }, 1, 7, 135, 4875), 
		...
		MAGIC_STALL(4877, 80, new int[] { 1391, 1393, 1395, 1397, 1399, 3053 }, 1, 80, 165, 4877), 
		
		SCIMITAR_STALL(4878, 90, new int[] { 1333, 1331, 1323, 1325, 1329, 6317, 4587 }, 1, 80, 180, 4878), 
		
		GEM_STALL(34385, 1, new int[] { 995 }, 0, 3, 1, 34385);
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						if(Miscellania.isInArea(player))
							player.getThrone().lostReputation(3.5);
						if (!gaveItems) {
