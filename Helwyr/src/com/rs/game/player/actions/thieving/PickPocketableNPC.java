...
public enum PickPocketableNPC {
	 ...
	 */
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170, 7875, 7879, 7882, 7876 }, new byte[] { 1, 11, 21,
			31 }, new byte[] { 1, 1, 11, 21 }, 8.0, 4, 10, new Item(995, Utils.random(356, 833))),

	/**
	 * The regular farmer npcs.
	 */
	FARMER(new short[] { 7, 1757, 1758, 1760 }, new byte[] { 10, 20, 30, 40 },
			new byte[] { 1, 10, 20, 30 }, 14.5, 4, 10, new Item(995, Utils.random(656, 1133)),
			new Item(5318, 1)),
	...
	FEMALE_HAM(new short[] { 1715 }, new byte[] { 15, 25, 35, 45 }, new byte[] {
			...
			new Item(697), new Item(453), new Item(688), new Item(314, Utils.random(756, 1333))),

	/**
	 * The male H.A.M. members.
	 */
	MALE_HAM(new short[] { 1714, 1716 }, new byte[] { 20, 30, 40, 50 },
			new byte[] { 1, 20, 30, 40 }, 22.5, 3, 20, new Item(995, Utils.random(776, 1133)),
	...
	HAM_GUARD(new short[] { 1710, 1711, 1712 }, new byte[] { 20, 30, 40, 50 },
			new byte[] { 1, 20, 30, 40 }, 22.5, 3, 30, new Item(995, Utils.random(656, 1833)),
			new Item(590), new Item(1621), new Item(1623), new Item(1625),
			new Item(1269), new Item(321), new Item(2138), new Item(4298),
			new Item(4300), new Item(4302), new Item(4304), new Item(4306),
			new Item(4308), new Item(4310), new Item(1267), new Item(1353),
	...
	WARRIOR(new short[] { 15, 18 }, new byte[] { 25, 35, 45, 55 }, new byte[] {
			1, 25, 35, 45 }, 26, 5, 20, new Item(995, Utils.random(956, 1333))),

	/**
	 * The rogues.
	 */
	ROGUE(new short[] { 187, 2267, 2268, 2269, 8122 }, new byte[] { 32, 42, 52,
			62 }, new byte[] { 1, 32, 42, 52 }, 35.5, 4, 20, new Item(995, Utils.random(756, 1233)),
			new Item(995, Utils.random(676, 1533)), new Item(1993), new Item(556, 2),
	...
	GUARD(new short[] { 9, 32, 206, 296, 297, 298, 299, 344, 345, 346, 368,
			...
			60 }, 46.5, 4, 20, new Item(995, Utils.random(1120, 2234))),

	/**
	 * Fremennik citizen. TODO: correct npc ids.
	 */
	FREMENNIK_CITIZEN(new short[] { 2462 }, new byte[] { 45, 55, 65, 75 },
			new byte[] { 1, 45, 55, 65 }, 65, 4, 20, new Item(995, Utils.random(1220, 2334))),

	/**
	 * A knight of ardougne.
	 */
	ARDOUGNE_KNIGHT(new short[] { 23, 26 }, new byte[] { 55, 65, 75, 85 },
			new byte[] { 1, 55, 65, 75 }, 84.3, 4, 30, new Item(995,Utils.random(2620, 5534))),

	/**
	 * A menaphite thug.
	 */
	MENAPHITE_THUG(new short[] { 1905 }, new byte[] { 65, 75, 85, 95 },
			new byte[] { 1, 65, 75, 85 }, 137.5, 4, 50, new Item(995, Utils.random(3320, 6234))),

	/**
	 * A paladin.
	 */
	PALADIN(new short[] { 20, 2256 }, new byte[] { 70, 80, 90, 100 },
			new byte[] { 1, 70, 80, 90 }, 151.75, 4, 30, new Item(995, Utils.random(4620, 7434)),
			new Item(562, 2)),
	...
	MONKEY_KNIFE_FIGHTER(new short[] { 13195, 13212, 13213 }, new byte[] { 70,
			...
			995, 341), new Item(995, 50), new Item(869, 4), new Item(874, 2),
	 ...
	 * Iorwerth workers.
	 */
	IORWERTH_WORKERS(new short[] { 20129, 20130, 20131, 20132, 20133, 20134, 20135, 20136, 20316, 20317, },
			new byte[] { 91, 91, 91, 91 },
			new byte[] { 91, 91, 91, 91 },
			125, 5, 50, 
			new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1),
			new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1),
			new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1),
			new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1),
			new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)),
			new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)),
			new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)),
			new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(32206, 1), new Item(13845, 1),
			new Item(32736, 1), new Item(32732, 1), new Item(32733, 1), new Item(32734, 1), new Item(32735, 1), new Item(31427, 1), new Item(13010, 1),
			new Item(19064, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1),
			new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)),
			new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1),
			new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), 
			new Item(385, 1), new Item(995, Utils.random(8335, 946)), new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1), new Item(995, Utils.random(8335, 946)),
			new Item(450, 1), new Item(168, 1), new Item(150, 1), new Item(162, 1), new Item(385, 1)),
