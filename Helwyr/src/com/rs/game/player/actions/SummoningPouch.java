...
public enum SummoningPouch {
															...
															SPIRIT_SCORPION_POUCH(12055, 19, 83.2, 6837, 0.9, 2, new Item(12160),
																	...
																	SPIRIT_TZ_KIH_POUCH(12808, 22, 96.8, 7361, 1.1, 3, new Item(12160),
																			...
																			ALBINO_RAT_POUCH(12067, 23, 202.4, 6847, 2.3, 1, new Item(12163), new Item(
																					...
																					SPIRIT_KALPHITE_POUCH(12063, 25, 220, 6994, 2.5, 3, new Item(12163),
	...
	CLASS1_POUCH(14422, 1, 0, 8241, 0, 10, new Item(12160)),

	CLASS2_POUCH(14424, 20, 0, 8243, 0, 10, new Item(12160)),

																																																																																																																																																															CLASS3_POUCH(14426, 40, 0, 8245, 0, 10, new Item(12160)),

																																																																																																																																																															CLASS4_POUCH(14428, 60, 0, 8247, 0, 10, new Item(12160)),

																																																																																																																																																															CLASS5_POUCH(14430, 80, 0, 8249, 0, 10, new Item(12160));

	public static SummoningPouch get(int pouchId) {
		for (final SummoningPouch p : SummoningPouch.values()) {
