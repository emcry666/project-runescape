...
public class Slayer {
	...
	public enum SlayerMaster implements Serializable {
		...
		SPRIA(8462, 85, 1, new int[] { 0, 0, 0 }, new int[] { 15, 50 },
				SlayerTask.BANSHEE, SlayerTask.COW, SlayerTask.DWARF,
				SlayerTask.CRAWLING_HAND, SlayerTask.DWARF, SlayerTask.GHOST,
				SlayerTask.GOBLIN, SlayerTask.MINOTAUR, SlayerTask.MONKEY,
		...
		MAZCHNA(8481, 20, 1, new int[] { 2, 5, 15 }, new int[] { 40, 85 },
				SlayerTask.BANSHEE,
				SlayerTask.COCKATRICE, SlayerTask.CRAWLING_HAND,
				SlayerTask.CYCLOPS, SlayerTask.DOG, SlayerTask.FLESH_CRAWLER,
				SlayerTask.GHOST, SlayerTask.HILL_GIANT, SlayerTask.HOBGOBLIN,
				SlayerTask.ICE_WARRIOR, SlayerTask.KALPHITE,
				SlayerTask.SKELETON, SlayerTask.ZOMBIE),
		...
		VANNAKA(1597, 40, 1, new int[] { 4, 20, 60 }, new int[] { 60, 120 },
				...
				SlayerTask.COCKATRICE, SlayerTask.CYCLOPS,
				...
				SlayerTask.SHADE, SlayerTask.TUROTH, SlayerTask.EXPERIMENT),
		...
		SUMONA(7780, 85, 35, new int[] { 12, 60, 180 }, new int[] { 120, 185 },
				...
				SlayerTask.KURASK, SlayerTask.JADINKO, SlayerTask.NECHRYAEL,
		...
		DURADEL(8466, 100, 50, new int[] { 15, 75, 225 },
				...
				SlayerTask.DUST_DEVIL, SlayerTask.FIRE_GIANT,
				SlayerTask.GANODERMIC, SlayerTask.GARGOYLE, SlayerTask.GORAK,
				...
				SlayerTask.NECHRYAEL, SlayerTask.SPIRITUAL_MAGE,
		...
		KURADAL(9085, 110, 75, new int[] { 18, 90, 270 },
				...
				SlayerTask.HELLHOUND, SlayerTask.IRON_DRAGON,
				SlayerTask.JUNGLE_STRYKEWYRM, SlayerTask.KALPHITE,
				SlayerTask.LIVING_ROCK, SlayerTask.MITHRIL_DRAGON,
				SlayerTask.JADINKO, SlayerTask.NECHRYAEL,
				SlayerTask.SPIRITUAL_MAGE, SlayerTask.STEEL_DRAGON,
				SlayerTask.SUQAH, SlayerTask.TZHAAR, SlayerTask.TZHAAR,
				SlayerTask.WATERFIEND);
	...
	public enum SlayerTask implements Serializable {// 79 matches out of 117
		...
		EXPERIMENT(1, new String[] {}),

		// finished
		BIRD(
				1,
				new String[] {
						"Birds are a type of species found throughout arrow in different forms.",
		...
		public static SlayerTask getTaskByName(String name) {
