...
public final class DominionTower implements Serializable {
	...
	private static final Boss[] BOSSES = { 
			new Boss("Evil Chicken", " ", 3375),
			new Boss("The Black Knight Titan", " ", 14436),
			new Boss("Bouncer", " ", 14483),
			new Boss("Glacor", " ", 14301),
			new Boss("Dagannoth King", " ", 2881),
			new Boss("Dagannoth King", " ", 2882),
			new Boss("Dagannoth King", " ", 2883),
			new Boss("King Black Dragon", " ", 50),
	...
	public void win(int mode) {
		...
		player.setDominionTowerKills(player.getDominionTowerKills() + 1);
		if(player.getInventory().hasFreeSlots()) {
			player.getInventory().addItem(7478, 8);
		} else {
			player.getBank().addItem(7478, 8, false);
		}
