package com.rs.game.area.dungeonhandler.others;
...
public class AscensionDungeon {
	...
	public static void handleLightning(final Legio leg, final WorldTile targetPosition, final int min, final int max, boolean sextus) {
