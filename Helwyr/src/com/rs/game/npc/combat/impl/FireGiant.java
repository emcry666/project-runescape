...
public class FireGiant extends CombatScript {
	...
	case 0:// MELEE
	    ...
	    delayHit(npc, 0, target, getMeleeHit(npc, getMaxHit(npc, 225, NPCCombatDefinitions.MELEE, target)));
	    break;
	case 1:// RANGED
	    npc.setNextAnimation(new Animation(defs.getAttackEmote()));
	    ...
	    delayHit(npc, Utils.projectileTimeToCycles(projectile.getEndTime()) - 1, target,
		    getRangeHit(npc, getMaxHit(npc, 280, NPCCombatDefinitions.RANGE, target)));
	    break;
	}
