...
public class InfernalMage extends CombatScript {
	...
	Projectile projectile = World.sendProjectileNew(npc, target, defs.getAttackProjectile(), 30, 30, 50, 2,
		Utils.random(5), 5);
	delayHit(npc, Utils.projectileTimeToCycles(projectile.getEndTime()) - 1, target,
		getMagicHit(npc, getMaxHit(npc, 250, NPCCombatDefinitions.MAGE, target)));
