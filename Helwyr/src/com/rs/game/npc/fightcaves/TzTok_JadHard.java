...
public class TzTok_JadHard extends FightCavesHardModeNPC {

	private boolean spawnedMinions;
	private FightCavesHardMode controler;
	
	public TzTok_JadHard(int id, WorldTile tile, FightCavesHardMode controler) {
		super(id, tile);
