...
public class WildyWyrm extends NPC {
	...
	for (Entity t : getReceivedDamageSources()) {
	    ...
	    player.setKilledWildyWyrm(true);
	    player.getPackets()
		    .sendGameMessage("You contributed to the wyrm's death, and it leaves a fury shark behind.");
	    sendDrop(player, new Drop(Rarity.ALWAYS, 20429, 1, 1));
	}
	super.drop();
    }
