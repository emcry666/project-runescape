...
public class ZarosGodwars {
    ...
    private static final Animation START = new Animation(17412), SECOND_START = new Animation(17413),
	    THIRD_START = new Animation(17414);
    private static WorldTile[] MINION_SPAWNS = { new WorldTile(2913, 5215, 0), new WorldTile(2937, 5215, 0),
	    new WorldTile(2937, 5191, 0), new WorldTile(2913, 5191, 0) };
    private static Graphics[] MINION_GRAPHICS = { new Graphics(3359), new Graphics(3361), new Graphics(3358),
	    new Graphics(3360) };
	...
	WorldTasksManager.schedule(new WorldTask() {
		...
		if (stage == 0) {
		    ...
		    NexMinion nexMinion = (NexMinion) World.spawnNPC(13450 + stage, MINION_SPAWNS[stage - 1], 0, true,
			    true);
		    if (nex != null)
