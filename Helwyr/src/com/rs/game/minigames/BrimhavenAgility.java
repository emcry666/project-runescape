...
public final class BrimhavenAgility extends Controler {
	...
	private static void startGame() {
		...
		GameEngine.getEngine().getScheduler().scheduleAtFixedRate(currentGame = new PlayingGame(), 0, 60000);
		GameEngine.getEngine().getScheduler().scheduleAtFixedRate(bladesManager = new BladesManager(), 5000, 5000);
	}
