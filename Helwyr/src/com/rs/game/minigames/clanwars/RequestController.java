...
public final class RequestController extends Controler {
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		case 38698: // Safe FFA portal.
			if (player.getPlayerPin().hasEnteredPin() && player.getPlayerPin().hasPin()) {
				player.getPackets().sendRunScript(108,
						new Object[] { "Please enter your bank PIN:" });
				player.getTemporaryAttributtes().put("enter_bank_pin_setup",
						Boolean.TRUE);
				return false;
			}
