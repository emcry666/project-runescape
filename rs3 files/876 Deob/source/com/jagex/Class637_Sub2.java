...
public class Class637_Sub2 extends Class637 {
	boolean method10452(byte i) {
		return (method16849((byte) 0) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}

	boolean method10463() {
		return (method16849((byte) -69) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}
	...
	void method10457(RSBuffer class523_sub34, Class523_Sub39 class523_sub39, int i) {
		/* empty */
	}
	...
	boolean method10458() {
		return (method16849((byte) -38) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}
	...
	boolean method10464() {
		return (method16849((byte) -75) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}

	boolean method10465() {
		return (method16849((byte) -81) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}

	boolean method10466() {
		return (method16849((byte) -52) != null || (aLong8305 * 5505102922195369039L < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 2000L));
	}
	...
	void method10449(RSBuffer class523_sub34, Class523_Sub39 class523_sub39) {
		/* empty */
	}
	...
	void method10467(RSBuffer class523_sub34, Class523_Sub39 class523_sub39) {
		/* empty */
	}
