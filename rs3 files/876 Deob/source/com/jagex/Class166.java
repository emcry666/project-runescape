...
public class Class166 {
	...
	public static Class175[] method2661(byte[] is) {
		...
		class523_sub34.offset = (is.length - 2) * 189765723;
		...
		if (i_3_ == 0) {
			...
			class523_sub34.offset = (is.length - 7 - i_4_ * 8) * 189765723;
			...
			class523_sub34.offset = (is.length - 7 - i_4_ * 8 - (i_8_ - 1) * 3) * 189765723;
	...
	public static Class175[] method2667(byte[] is) {
		...
		if (i_41_ == 0) {
			...
			class523_sub34.offset = (is.length - 7 - i_42_ * 8) * 189765723;
			...
			class523_sub34.offset = (is.length - 7 - i_42_ * 8 - (i_46_ - 1) * 3) * 189765723;
	...
	public static Class175[] method2669(byte[] is) {
		...
		if (i_77_ == 0) {
			...
			class523_sub34.offset = (is.length - 7 - i_78_ * 8) * 189765723;
			...
			class523_sub34.offset = (is.length - 7 - i_78_ * 8 - (i_82_ - 1) * 3) * 189765723;
