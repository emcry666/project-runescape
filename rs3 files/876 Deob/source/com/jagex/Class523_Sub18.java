...
public abstract class Class523_Sub18 extends Class523 {
	...
	abstract void method16037(RSBuffer class523_sub34, byte i);

	abstract void method16038(RSBuffer class523_sub34);

	abstract void method16039(RSBuffer class523_sub34);

	abstract void method16040(RSBuffer class523_sub34);
	...
	public static Class523_Sub22 method16042(OutgoingPacket class408, Class11 class11, int i) {
		...
		if (class523_sub22.anInt10523 * -764738435 == -1)
			class523_sub22.aClass523_Sub34_Sub2_10525 = new RSBitBuffer(260);
		else if (-2 == class523_sub22.anInt10523 * -764738435)
			class523_sub22.aClass523_Sub34_Sub2_10525 = new RSBitBuffer(10000);
		else if (class523_sub22.anInt10523 * -764738435 <= 18)
			class523_sub22.aClass523_Sub34_Sub2_10525 = new RSBitBuffer(20);
		else if (class523_sub22.anInt10523 * -764738435 <= 98)
			class523_sub22.aClass523_Sub34_Sub2_10525 = new RSBitBuffer(100);
		else
			class523_sub22.aClass523_Sub34_Sub2_10525 = new RSBitBuffer(260);
