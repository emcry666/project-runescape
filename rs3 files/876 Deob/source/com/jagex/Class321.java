...
public class Class321 {
	...
	static final void method5716(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_1_, -389014336);
	...
	static final void method5717(Class669 class669, byte i) {
		String string = "";
		if (null != NetworkStream.aClipboard7479) {
	...
	public static void method5719(int i, int i_2_, byte i_3_) {
		...
		JS5ArchiveReference.method1233((byte) -118);
	}
