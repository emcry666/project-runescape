...
public class BaseVarType implements Interface75 {
	static BaseVarType aClass474_5381;
	public static BaseVarType aClass474_5382 = new BaseVarType(0, 0, java.lang.Integer.class, new Class483());
	public static BaseVarType aClass474_5383 = new BaseVarType(1, 1, java.lang.Long.class, new Class487());
	public static BaseVarType aClass474_5384 = new BaseVarType(2, 2, java.lang.String.class, new Class485());
	static BaseVarType aClass474_5385;
	public int anInt5386;
	int anInt5387;
	public Class aClass5388;
	Interface11 anInterface11_5389;
	static int anInt5390;
	static InterfaceComponentDefinitions aClass250_5391;
	static Class523_Sub27_Sub6 aClass523_Sub27_Sub6_5392;

	public static Interface11 method7742(Class var_class) {
		BaseVarType class474 = method7744(var_class, 199906709);
		if (class474 == null)
			throw new IllegalArgumentException();
		return class474.anInterface11_5389;
	}

	public static BaseVarType[] method7743() {
		return new BaseVarType[] { aClass474_5382, aClass474_5383, aClass474_5384, aClass474_5385, aClass474_5381 };
	}

	static BaseVarType method7744(Class var_class, int i) {
		BaseVarType[] class474s = method7746(1132540194);
		for (int i_0_ = 0; i_0_ < class474s.length; i_0_++) {
			BaseVarType class474 = class474s[i_0_];
	...
	public static Interface11 method7745(Class var_class, int i) {
		BaseVarType class474 = method7744(var_class, -1837438247);
		if (class474 == null)
			throw new IllegalArgumentException();
		return class474.anInterface11_5389;
	}
	...
	public static BaseVarType[] method7746(int i) {
		return new BaseVarType[] { aClass474_5382, aClass474_5383, aClass474_5384, aClass474_5385, aClass474_5381 };
	}

	static {
		aClass474_5381 = new BaseVarType(4, 3, com.jagex.Class523_Sub29.class, new Class482());
		aClass474_5385 = new BaseVarType(3, 4, com.jagex.Class245.class, new Class480());
	}
	...
	public static BaseVarType[] method7747() {
		return new BaseVarType[] { aClass474_5382, aClass474_5383, aClass474_5384, aClass474_5385, aClass474_5381 };
	}

	public static BaseVarType[] method7748() {
		return new BaseVarType[] { aClass474_5382, aClass474_5383, aClass474_5384, aClass474_5385, aClass474_5381 };
	}

	public Object method7749(RSBuffer class523_sub34, int i) {
	...
	BaseVarType(int i, int i_1_, Class var_class, Interface11 interface11) {
	...
	public static Interface11 method7750(Class var_class) {
		BaseVarType class474 = method7744(var_class, 395713311);
		if (class474 == null)
			throw new IllegalArgumentException();
		return class474.anInterface11_5389;
	}

	public static BaseVarType[] method7751() {
		return new BaseVarType[] { aClass474_5382, aClass474_5383, aClass474_5384, aClass474_5385, aClass474_5381 };
	}

	public static Interface11 method7752(Class var_class) {
		BaseVarType class474 = method7744(var_class, 1653210154);
		if (class474 == null)
			throw new IllegalArgumentException();
		return class474.anInterface11_5389;
	}
	...
	public static Interface11 method7753(Class var_class) {
		BaseVarType class474 = method7744(var_class, 1701203380);
		if (class474 == null)
			throw new IllegalArgumentException();
		return class474.anInterface11_5389;
	}

	public Object method7754(RSBuffer class523_sub34) {
		return anInterface11_5389.method65(class523_sub34, -721285210);
	}

	public Object method7755(RSBuffer class523_sub34) {
		return anInterface11_5389.method65(class523_sub34, -721285210);
	}
	...
	static final void method7756(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_2_, -639868326);
