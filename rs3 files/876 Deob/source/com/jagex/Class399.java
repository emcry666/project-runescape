...
public class Class399 implements Interface48 {
	...
	public synchronized Class400 method350(int i) {
		...
		if (null != is)
			class400.method6535(new RSBuffer(is), -2017279262);
	...
	public synchronized Class400 method348(int i, int i_0_) {
		...
		class400 = new Class400();
		if (null != is)
			class400.method6535(new RSBuffer(is), -1756254779);
	...
	public synchronized Class400 method349(int i) {
		...
		class400 = new Class400();
		if (null != is)
			class400.method6535(new RSBuffer(is), -1492866241);
	...
	public static void method6533(int i) {
		if (client.aBool11000) {
			InterfaceComponentDefinitions class250 = Class654.method10722(Class232.anInt2367 * 1383041209, client.anInt11105 * -1034378319, (byte) 15);
			...
			if (null != class250)
				Login.method15991(class250, (byte) -27);
		}
	}
}
