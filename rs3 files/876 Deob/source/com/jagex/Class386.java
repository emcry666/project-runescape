...
public class Class386 {
	...
	void method6451(RSBuffer class523_sub34, int i, int i_0_) {
		for (;;) {
	...
	void method6452(RSBuffer class523_sub34, int i, int i_2_, byte i_3_) {
		if (1 == i) {
	...
	void method6453(RSBuffer class523_sub34, int i) {
		for (;;) {
	...
	void method6454(RSBuffer class523_sub34, int i) {
		for (;;) {
	...
	void method6455(RSBuffer class523_sub34, int i) {
		for (;;) {
	...
	static final void method6457(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, byte i) {
		class250.anInt2605 = (class669.anIntArray8557[(class669.anInt8558 -= 2138772399) * 1357652815]) * -254363595;
		Login.method15991(class250, (byte) -76);
		if (class250.anInt2709 * 234012635 == -1 && !class242.aBool2456)
			Class508.method8506(class250.interfaceHash * -1363815505, 1451118309);
	}
	...
	static final void method6458(Class669 class669, int i) {
		...
		ClientScriptDefinitions class37 = ((ClientScriptDefinitions) Class394.aClass53_Sub16_4056.getDefinition(i_7_, (byte) -19));
		if (Class464.aClass464_5165 != class37.valueType)
			throw new RuntimeException();
	...
	static final void method6461(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_8_, -665794671);
