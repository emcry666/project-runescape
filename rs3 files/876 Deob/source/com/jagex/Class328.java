...
public abstract class Class328 {
	...
	public abstract void method5760(RSBuffer class523_sub34, int i);
	...
	public abstract void method5768(RSBuffer class523_sub34);
	...
	public abstract void method5778(RSBuffer class523_sub34);

	public abstract double[] method5779();

	public abstract Class437 method5780();

	public abstract void method5781(RSBuffer class523_sub34);
	...
	static final void method5787(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		...
		Login.method15991(class250, (byte) -24);
		if (234012635 * class250.anInt2709 == -1 && !class242.aBool2456) {
			...
			Class98.method1780(class250.interfaceHash * -1363815505, (byte) -110);
		}
	}
