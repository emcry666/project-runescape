...
public abstract class Class159 implements Interface14 {
	...
	public VarDomainType aClass470_1755;
	...
	abstract void method2558(RSBuffer class523_sub34, int i, int i_0_);

	Class159(VarDomainType class470, int i) {
	...
	abstract void method2562(RSBuffer class523_sub34, int i);

	abstract void method2563(RSBuffer class523_sub34, int i);
	...
	public static Class387 method2568(RSBuffer class523_sub34, int i) {
	...
	static final void method2569(Class669 class669, int i) {
		...
		Class188.getDefinitions(i_9_, -1328619467);
