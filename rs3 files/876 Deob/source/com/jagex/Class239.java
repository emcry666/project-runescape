...
public class Class239 implements Interface13 {
	...
	public int method4312(int i, int i_2_) {
		if (null == aClass14_2444)
			return i_2_;
		Class523_Sub24 class523_sub24 = (Class523_Sub24) aClass14_2444.getFromIndex((long) i);
	...
	public boolean method4314(Interface19 interface19, Interface17 interface17, int i) {
		...
		if (-1 != 659042581 * anInt2420) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2420 * 659042581, 1834627789);
			i_4_ = interface17.method94(class159, -1435919759);
		} else if (1165506823 * anInt2429 != -1) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, 1415401329);
		...
		if (anInt2424 * 521630281 != -1) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2424 * 521630281, 2146236050);
			i_6_ = interface17.method94(class159, -1348990499);
		} else if (-1 != -184540069 * anInt2437) {
			VarBitDefinitions class309 = interface19.method106(-184540069 * anInt2437, -835403996);
	...
	public final Class239 method4319(Interface19 interface19, Interface17 interface17, int i) {
		...
		if (-1 != anInt2429 * 1165506823) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, -89862587);
			if (null != class309)
				i_12_ = interface17.method93(class309, -1775669924);
		} else if (-1 != anInt2420 * 659042581) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, 659042581 * anInt2420, 1914135238);
			if (null != class159)
	...
	public String method4321(int i, String string, byte i_15_) {
		if (null == aClass14_2444)
			return string;
		Class523_Sub28 class523_sub28 = (Class523_Sub28) aClass14_2444.getFromIndex((long) i);
	...
	void method4323(RSBuffer class523_sub34, int i, int i_17_) {
		if (i == 1)
	...
	public boolean method4324(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != 659042581 * anInt2420) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2420 * 659042581, 1280170719);
			i = interface17.method94(class159, 721295868);
		} else if (1165506823 * anInt2429 != -1) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, 1112004899);
		...
		int i_32_;
		if (anInt2424 * 521630281 != -1) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2424 * 521630281, 2070436245);
			i_32_ = interface17.method94(class159, -835123287);
		} else if (-1 != -184540069 * anInt2437) {
			VarBitDefinitions class309 = interface19.method106(-184540069 * anInt2437, 563830732);
	...
	public boolean method4325(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != 659042581 * anInt2420) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2420 * 659042581, 1942580180);
			i = interface17.method94(class159, -1508144716);
		} else if (1165506823 * anInt2429 != -1) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, -1198738528);
		...
		int i_34_;
		if (anInt2424 * 521630281 != -1) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2424 * 521630281, 1787581094);
			i_34_ = interface17.method94(class159, 370701435);
		} else if (-1 != -184540069 * anInt2437) {
			VarBitDefinitions class309 = interface19.method106(-184540069 * anInt2437, 85659289);
	...
	public boolean method4326(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != 659042581 * anInt2420) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2420 * 659042581, 2087892895);
			i = interface17.method94(class159, 346831727);
		} else if (1165506823 * anInt2429 != -1) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, 134050062);
		...
		int i_36_;
		if (anInt2424 * 521630281 != -1) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, anInt2424 * 521630281, 1423396153);
			i_36_ = interface17.method94(class159, -1096653757);
		} else if (-1 != -184540069 * anInt2437) {
			VarBitDefinitions class309 = interface19.method106(-184540069 * anInt2437, -70177088);
	...
	public final Class239 method4334(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != anInt2429 * 1165506823) {
			VarBitDefinitions class309 = interface19.method106(1165506823 * anInt2429, 351820124);
			if (null != class309)
				i = interface17.method93(class309, -479771800);
		} else if (-1 != anInt2420 * 659042581) {
			Class159 class159 = interface19.method110(VarDomainType.PLAYER_CONFIGS, 659042581 * anInt2420, 1603939167);
			if (null != class159)
	...
	static final void method4337(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_50_, -1913954059);
