...
public class Class179 {
	...
	public Class179(byte[] is) {
		...
		RSBuffer class523_sub34_2_ = new RSBuffer(is);
		RSBuffer class523_sub34_3_ = new RSBuffer(is);
		RSBuffer class523_sub34_4_ = new RSBuffer(is);
		RSBuffer class523_sub34_5_ = new RSBuffer(is);
		RSBuffer class523_sub34_6_ = new RSBuffer(is);
		RSBuffer class523_sub34_7_ = new RSBuffer(is);
		...
		if (i != 1)
			...
			class523_sub34.offset = (is.length - 26) * 189765723;
			...
			if (anInt1982 > 0) {
				...
				class523_sub34.offset = 569297169;
			...
			int i_58_ = is.length;
			if (bool_14_) {
				RSBuffer class523_sub34_59_ = new RSBuffer(is);
				class523_sub34_59_.offset = (is.length - 26) * 189765723;
				class523_sub34_59_.offset -= (is[class523_sub34_59_.offset * 2349011 - 1] * 189765723);
			...
			class523_sub34.offset = i_33_ * 189765723;
			class523_sub34_2_.offset = i_44_ * 189765723;
			class523_sub34_3_.offset = i_45_ * 189765723;
			class523_sub34_4_.offset = i_46_ * 189765723;
			class523_sub34_5_.offset = i_38_ * 189765723;
			int i_62_ = 0;
			int i_63_ = 0;
			int i_64_ = 0;
			for (int i_65_ = 0; i_65_ < anInt1953; i_65_++) {
				...
				if (i_19_ == 1) {
					if (bool_11_)
						anIntArray1956[i_65_] = class523_sub34_5_.readUnsignedSmart((short) -9898);
					else {
			...
			if (anInt1961 > 0) {
				class523_sub34.offset = i_56_ * 189765723;
				class523_sub34_2_.offset = i_57_ * 189765723;
				class523_sub34_3_.offset = i_58_ * 189765723;
			...
			class523_sub34.offset = i_43_ * 189765723;
			class523_sub34_2_.offset = i_34_ * 189765723;
			class523_sub34_3_.offset = i_36_ * 189765723;
			class523_sub34_4_.offset = i_39_ * 189765723;
			class523_sub34_5_.offset = i_37_ * 189765723;
			class523_sub34_6_.offset = i_41_ * 189765723;
			class523_sub34_7_.offset = i_42_ * 189765723;
			for (int i_72_ = 0; i_72_ < anInt1964; i_72_++) {
				...
				if (i_17_ == 1) {
					if (bool_12_)
						anIntArray1993[i_72_] = class523_sub34_5_.readUnsignedSmart((short) -2712);
					else {
			...
			anInt1991 = -1;
			class523_sub34.offset = i_40_ * 189765723;
			class523_sub34_2_.offset = i_35_ * 189765723;
			class523_sub34_3_.offset = i_55_ * 189765723;
			method3481(class523_sub34, class523_sub34_2_, class523_sub34_3_);
			class523_sub34.offset = i_47_ * 189765723;
			class523_sub34_2_.offset = i_48_ * 189765723;
			class523_sub34_3_.offset = i_50_ * 189765723;
			class523_sub34_4_.offset = i_51_ * 189765723;
			class523_sub34_5_.offset = i_52_ * 189765723;
			class523_sub34_6_.offset = i_53_ * 189765723;
			method3482(class523_sub34, class523_sub34_2_, class523_sub34_3_, class523_sub34_4_, class523_sub34_5_, class523_sub34_6_);
			class523_sub34.offset = i_54_ * 189765723;
			if (bool_9_) {
			...
			if (bool_10_) {
				...
				if (i_82_ > 0) {
					...
					for (int i_83_ = 0; i_83_ < i_82_; i_83_++) {
						...
						int i_86_;
						if (bool_13_)
							i_86_ = class523_sub34.readUnsignedSmart((short) -14911);
						else {
	...
	void method3481(RSBuffer class523_sub34, RSBuffer class523_sub34_110_, RSBuffer class523_sub34_111_) {
		short i = 0;
		short i_112_ = 0;
		short i_113_ = 0;
		int i_114_ = 0;
	...
	void method3482(RSBuffer class523_sub34, RSBuffer class523_sub34_119_, RSBuffer class523_sub34_120_, RSBuffer class523_sub34_121_, RSBuffer class523_sub34_122_, RSBuffer class523_sub34_123_) {
	...
	void method3486(RSBuffer class523_sub34, RSBuffer class523_sub34_136_, RSBuffer class523_sub34_137_, RSBuffer class523_sub34_138_, RSBuffer class523_sub34_139_, RSBuffer class523_sub34_140_) {
		for (int i = 0; i < anInt1982; i++) {
	...
	void method3501(RSBuffer class523_sub34, RSBuffer class523_sub34_197_, RSBuffer class523_sub34_198_) {
		short i = 0;
		short i_199_ = 0;
		short i_200_ = 0;
		int i_201_ = 0;
	...
	void method3502(RSBuffer class523_sub34, RSBuffer class523_sub34_206_, RSBuffer class523_sub34_207_) {
		short i = 0;
		short i_208_ = 0;
		short i_209_ = 0;
		int i_210_ = 0;
	...
	void method3503(RSBuffer class523_sub34, RSBuffer class523_sub34_259_, RSBuffer class523_sub34_260_) {
		short i = 0;
		short i_261_ = 0;
		short i_262_ = 0;
		int i_263_ = 0;
	...
	void method3504(RSBuffer class523_sub34, RSBuffer class523_sub34_268_, RSBuffer class523_sub34_269_, RSBuffer class523_sub34_270_, RSBuffer class523_sub34_271_, RSBuffer class523_sub34_272_) {
		for (int i = 0; i < anInt1982; i++) {
	...
	void method3506(RSBuffer class523_sub34, RSBuffer class523_sub34_277_, RSBuffer class523_sub34_278_, RSBuffer class523_sub34_279_, RSBuffer class523_sub34_280_, RSBuffer class523_sub34_281_) {
		for (int i = 0; i < anInt1982; i++) {
	...
	void method3523(RSBuffer class523_sub34, RSBuffer class523_sub34_362_, RSBuffer class523_sub34_363_) {
		short i = 0;
		short i_364_ = 0;
		short i_365_ = 0;
		int i_366_ = 0;
