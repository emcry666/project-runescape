...
public class Class288 implements Interface75 {
	...
	public static Class381 method5159(RSBuffer class523_sub34, byte i) {
	...
	static final void method5162(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class654.method10722(i_10_, i_11_, (byte) -10);
	...
	static final void method5164(InterfaceComponentDefinitions[] class250s, int i, byte i_13_) {
		for (int i_14_ = 0; i_14_ < class250s.length; i_14_++) {
			InterfaceComponentDefinitions class250 = class250s[i_14_];
			if (class250 != null) {
				if (0 == 36473529 * class250.type) {
				...
				if (i == 1 && null != class250.anObjectArray2673) {
					if (234012635 * class250.anInt2709 >= 0) {
						InterfaceComponentDefinitions class250_15_ = Class188.getDefinitions((class250.interfaceHash * -1363815505), -801768548);
