...
public class NPC extends Class647_Sub1_Sub3_Sub1 {
	int anInt12160;
	...
	public Class304 headIcon;
	int anInt12168;
	public String customName;
	int[] anIntArray12170;
	public int customCombatLevel;
	int anInt12172;
	int[] anIntArray12173;
	...
	public NPC(Class560 class560, int i) {
	...
	public void method18620(int i) {
		...
		anInt11951 = client.cycles * -834874663;
	}
	...
	boolean method18621(Class178 class178, int i) {
		...
		if (0 != i_1_ || 0 != i_2_ || 0 != class588.anInt7791 * -941991763 || -1578959099 * class588.anInt7788 != 0)
			i |= 0x7;
		boolean bool = (aByte11929 != 0 && client.cycles >= -1284164047 * colorDelay && client.cycles < colorDuration * 1874600493);
		if (bool)
			i |= 0x80000;
		...
		if (0 != anInt11931 * 1766454463) {
			...
			if (class300 == null || client.cycles >= (-2066969239 * anInt11951 + class300.anInt3320 * 1034868193))
				anInt11931 = 0;
			else {
				anInt11931 = ((255 - ((client.cycles - anInt11951 * -2066969239) * 255 / (1034868193 * class300.anInt3320))) * 1980463935);
				bool_3_ = true;
			}
		}
		if (bool_3_)
	...
	public void method18623(NPCDefinition class300, boolean bool, boolean bool_5_, boolean bool_6_, byte i) {
		...
		if (aClass300_12175 != null) {
			if (bool)
				customName = aClass300_12175.name;
			if (bool_5_)
				customCombatLevel = 1584612661 * aClass300_12175.anInt3295;
			if (bool_6_)
				headIcon = null;
		}
	...
	public void method18626(int i, int i_22_, int i_23_, boolean bool, int i_24_, int i_25_) {
		...
		for (int i_26_ = 0; i_26_ < aClass515Array11912.length; i_26_++) {
			if (aClass515Array11912[i_26_].id * 985865715 != -1) {
				...
				if (class671.aBool8602 && class671.emoteId * -61429051 != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) 16)).anInt2238) * 1830302607 == 1) {
		...
		if (!bool) {
			int i_27_ = i_22_ - screenX[0];
			int i_28_ = i_23_ - screenY[0];
			if (i_27_ >= -8 && i_27_ <= 8 && i_28_ >= -8 && i_28_ <= 8) {
				if (stepsCount * 703205765 < screenX.length - 1)
					stepsCount += -822788275;
				for (int i_29_ = 703205765 * stepsCount; i_29_ > 0; i_29_--) {
					screenX[i_29_] = screenX[i_29_ - 1];
					screenY[i_29_] = screenY[i_29_ - 1];
		...
		class437.aFloat4903 = (float) ((i_24_ << 8) + (screenX[0] << 9));
		class437.aFloat4905 = (float) ((i_24_ << 8) + (screenY[0] << 9));
	...
	public void method18630(int i, int i_43_, int i_44_, boolean bool, int i_45_) {
		...
		for (int i_46_ = 0; i_46_ < aClass515Array11912.length; i_46_++) {
			if (aClass515Array11912[i_46_].id * 985865715 != -1) {
				...
				if (class671.aBool8602 && class671.emoteId * -61429051 != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) -21)).anInt2238) * 1830302607 == 1) {
		...
		if (!bool) {
			int i_47_ = i_43_ - screenX[0];
			int i_48_ = i_44_ - screenY[0];
			if (i_47_ >= -8 && i_47_ <= 8 && i_48_ >= -8 && i_48_ <= 8) {
				if (stepsCount * 703205765 < screenX.length - 1)
					stepsCount += -822788275;
				for (int i_49_ = 703205765 * stepsCount; i_49_ > 0; i_49_--) {
					screenX[i_49_] = screenX[i_49_ - 1];
					screenY[i_49_] = screenY[i_49_ - 1];
		...
		screenY[0] = i_44_;
		Class437 class437 = Class437.method6884(method10569().aClass437_4862);
		class437.aFloat4903 = (float) ((i_45_ << 8) + (screenX[0] << 9));
		class437.aFloat4905 = (float) ((i_45_ << 8) + (screenY[0] << 9));
		method10573(class437);
		class437.method6949();
		if (aClass621_11948 != null)
			aClass621_11948.method10131();
	...
	public void setTargetInformation(int i, int i_51_, int i_52_, int i_53_) {
	...
	public final void method18644(Class682 class682, int i) {
		...
		for (int i_84_ = 0; i_84_ < aClass515Array11912.length; i_84_++) {
			if (-1 != 985865715 * aClass515Array11912[i_84_].id) {
				...
				if (class671.aBool8602 && -61429051 * class671.emoteId != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) 27)).anInt2238) * 1830302607 == 1) {
		...
		if (703205765 * stepsCount < screenX.length - 1)
			stepsCount += -822788275;
		for (int i_85_ = stepsCount * 703205765; i_85_ > 0; i_85_--) {
			screenX[i_85_] = screenX[i_85_ - 1];
			screenY[i_85_] = screenY[i_85_ - 1];
	...
	public void method18645(int i, int i_86_, int i_87_, boolean bool, int i_88_) {
		...
		for (int i_89_ = 0; i_89_ < aClass515Array11912.length; i_89_++) {
			if (aClass515Array11912[i_89_].id * 985865715 != -1) {
				...
				if (class671.aBool8602 && class671.emoteId * -61429051 != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) -92)).anInt2238) * 1830302607 == 1) {
		...
		if (!bool) {
			int i_90_ = i_86_ - screenX[0];
			int i_91_ = i_87_ - screenY[0];
			if (i_90_ >= -8 && i_90_ <= 8 && i_91_ >= -8 && i_91_ <= 8) {
				if (stepsCount * 703205765 < screenX.length - 1)
					stepsCount += -822788275;
				for (int i_92_ = 703205765 * stepsCount; i_92_ > 0; i_92_--) {
					screenX[i_92_] = screenX[i_92_ - 1];
					screenY[i_92_] = screenY[i_92_ - 1];
		...
		screenY[0] = i_87_;
		Class437 class437 = Class437.method6884(method10569().aClass437_4862);
		class437.aFloat4903 = (float) ((i_88_ << 8) + (screenX[0] << 9));
		class437.aFloat4905 = (float) ((i_88_ << 8) + (screenY[0] << 9));
		method10573(class437);
		class437.method6949();
		if (aClass621_11948 != null)
			aClass621_11948.method10131();
	...
	public void method18646(int i, int i_93_, int i_94_, boolean bool, int i_95_) {
		...
		for (int i_96_ = 0; i_96_ < aClass515Array11912.length; i_96_++) {
			if (aClass515Array11912[i_96_].id * 985865715 != -1) {
				...
				if (class671.aBool8602 && class671.emoteId * -61429051 != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) 25)).anInt2238) * 1830302607 == 1) {
		...
		if (!bool) {
			int i_97_ = i_93_ - screenX[0];
			int i_98_ = i_94_ - screenY[0];
			if (i_97_ >= -8 && i_97_ <= 8 && i_98_ >= -8 && i_98_ <= 8) {
				if (stepsCount * 703205765 < screenX.length - 1)
					stepsCount += -822788275;
				for (int i_99_ = 703205765 * stepsCount; i_99_ > 0; i_99_--) {
					screenX[i_99_] = screenX[i_99_ - 1];
					screenY[i_99_] = screenY[i_99_ - 1];
		...
		screenY[0] = i_94_;
		Class437 class437 = Class437.method6884(method10569().aClass437_4862);
		class437.aFloat4903 = (float) ((i_95_ << 8) + (screenX[0] << 9));
		class437.aFloat4905 = (float) ((i_95_ << 8) + (screenY[0] << 9));
		method10573(class437);
		class437.method6949();
		if (aClass621_11948 != null)
			aClass621_11948.method10131();
	...
	public final void method18652(Class682 class682, int i, int i_106_) {
		int i_107_ = screenX[0];
		int i_108_ = screenY[0];
		switch (616149425 * class682.anInt8658) {
		case 2:
			i_107_++;
			break;
		...
		for (int i_109_ = 0; i_109_ < aClass515Array11912.length; i_109_++) {
			if (-1 != 985865715 * aClass515Array11912[i_109_].id) {
				...
				if (class671.aBool8602 && -61429051 * class671.emoteId != -1 && (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(((class671.emoteId) * -61429051), (byte) 13)).anInt2238) * 1830302607 == 1) {
		...
		if (703205765 * stepsCount < screenX.length - 1)
			stepsCount += -822788275;
		for (int i_110_ = stepsCount * 703205765; i_110_ > 0; i_110_--) {
			screenX[i_110_] = screenX[i_110_ - 1];
			screenY[i_110_] = screenY[i_110_ - 1];
