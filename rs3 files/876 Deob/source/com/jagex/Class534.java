...
public class Class534 {
	...
	static RSBuffer aClass523_Sub34_7191;
	static RSBuffer aClass523_Sub34_7192;
	...
	public static JS5FileQueue method8810(int i, int i_20_) {
		JS5FileQueue class697 = new JS5FileQueue();
		for (Class523_Sub27_Sub17 class523_sub27_sub17 = (Class523_Sub27_Sub17) aClass14_7147.method735(-380907255); class523_sub27_sub17 != null; class523_sub27_sub17 = ((Class523_Sub27_Sub17) aClass14_7147.method749(1640498952))) {
			if (class523_sub27_sub17.aBool11826 && class523_sub27_sub17.method18191(i, i_20_, 632146607))
				class697.removeFromQueue(class523_sub27_sub17, (byte) -28);
		}
		return class697;
	}
	...
	public static Class523_Sub27_Sub17 method8813(int i) {
		return (Class523_Sub27_Sub17) aClass14_7147.getFromIndex((long) i);
	}
	...
	static boolean method8818(Class178 class178, int i, int i_50_, boolean bool) {
		...
		if (anInt7189 == 0) {
			if (aClass523_Sub27_Sub17_7144.anInt11831 * -536403473 == aClass624_7158.anInt8128 * 1217610883) {
				...
				if (aClass523_Sub34_7192 == null)
					aClass523_Sub34_7192 = (new RSBuffer(aClass472_7146.method7688(i_51_, 0, 727781809)));
				aClass523_Sub34_7191 = aClass523_Sub34_7192;
				aClass523_Sub34_7191.offset = 0;
			} else {
				int i_52_ = aClass472_7146.method7646((aClass523_Sub27_Sub17_7144.aString11824), (byte) -72);
				aClass523_Sub34_7191 = new RSBuffer(aClass472_7146.method7688(i_52_, 0, 96657360));
			}
		...
		while (aClass523_Sub34_7191 != null && (aClass523_Sub34_7191.offset * 2349011 < aClass523_Sub34_7191.buffer.length) && (!bool || (TimeUtils.getCurrentTimeMilliseconds(1516375036) < l + (long) anInt7175))) {
		...
		if (aClass523_Sub34_7191 != null) {
			anInt7189 = aClass523_Sub34_7191.offset * 2349011;
			if (aClass523_Sub34_7191.offset * 2349011 < aClass523_Sub34_7191.buffer.length)
				return false;
		}
		...
		if (!bool || TimeUtils.getCurrentTimeMilliseconds(1516375036) < l + (long) anInt7175) {
			method8820();
			return true;
		}
		return false;
	...
	static void method8855(int i) {
		Class523_Sub27_Sub17 class523_sub27_sub17 = (Class523_Sub27_Sub17) aClass14_7147.getFromIndex((long) i);
		if (class523_sub27_sub17 != null && class523_sub27_sub17 != aClass523_Sub27_Sub17_7144) {
			aClass523_Sub27_Sub17_7144 = class523_sub27_sub17;
			aBool7170 = (aClass523_Sub27_Sub17_7144.anInt11831 * -536403473 == aClass624_7158.anInt8118 * -1183714497);
		}
	...
	static boolean method8870(Class178 class178, int i, int i_415_, boolean bool) {
		...
		if (anInt7189 == 0) {
			if (aClass523_Sub27_Sub17_7144.anInt11831 * -536403473 == aClass624_7158.anInt8128 * 1217610883) {
				...
				if (aClass523_Sub34_7192 == null)
					aClass523_Sub34_7192 = new RSBuffer(aClass472_7146.method7688(i_416_, 0, -1300153861));
				aClass523_Sub34_7191 = aClass523_Sub34_7192;
				aClass523_Sub34_7191.offset = 0;
			} else {
				int i_417_ = aClass472_7146.method7646((aClass523_Sub27_Sub17_7144.aString11824), (byte) -19);
				aClass523_Sub34_7191 = (new RSBuffer(aClass472_7146.method7688(i_417_, 0, 1724924131)));
			}
	...
	static boolean method8871(Class178 class178, int i, int i_447_, boolean bool) {
		...
		if (anInt7189 == 0) {
			if (aClass523_Sub27_Sub17_7144.anInt11831 * -536403473 == aClass624_7158.anInt8128 * 1217610883) {
				...
				if (aClass523_Sub34_7192 == null)
					aClass523_Sub34_7192 = (new RSBuffer(aClass472_7146.method7688(i_448_, 0, 1880971783)));
				aClass523_Sub34_7191 = aClass523_Sub34_7192;
				aClass523_Sub34_7191.offset = 0;
			} else {
				int i_449_ = aClass472_7146.method7646((aClass523_Sub27_Sub17_7144.aString11824), (byte) -35);
				aClass523_Sub34_7191 = (new RSBuffer(aClass472_7146.method7688(i_449_, 0, -1333264328)));
			}
	...
	static void method8873(Class178 class178, RSBuffer class523_sub34, int i, int i_479_, int i_480_, int i_481_, int[] is, int[] is_482_) {
	...
	static void method8892(Class178 class178, RSBuffer class523_sub34, int i, int i_734_, int i_735_, int i_736_, int[] is, int[] is_737_) {
	...
	static void method8899(Class178 class178, RSBuffer class523_sub34, int i, int i_760_, int i_761_, int i_762_, int[] is, int[] is_763_) {
