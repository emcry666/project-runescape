...
public class Class424 {
	...
	JS5FileRequest aClass523_Sub27_Sub14_Sub2_4810;
	JS5Protocol aClass458_4811;
	...
	public boolean method6720(int i) {
		...
		if (null == aClass523_Sub27_Sub14_Sub2_4810) {
			if (aClass458_4811.canAddLowPriority(1357652815))
				return false;
			aClass523_Sub27_Sub14_Sub2_4810 = aClass458_4811.removeRequest(255, 255, (byte) 0, true, (byte) 40);
		}
		if (aClass523_Sub27_Sub14_Sub2_4810.inProgress)
			return false;
		RSBuffer class523_sub34 = new RSBuffer(aClass523_Sub27_Sub14_Sub2_4810.method18148(310325297));
	...
	public Class424(JS5Protocol class458, Class452 class452, Class456 class456, BigInteger biginteger, BigInteger biginteger_5_) {
		...
		if (!aClass458_4811.canAddLowPriority(1357652815))
			aClass523_Sub27_Sub14_Sub2_4810 = aClass458_4811.removeRequest(255, 255, (byte) 0, true, (byte) 8);
	...
	public void method6722(int i) {
		if (aClass467_Sub1Array4806 != null) {
			...
			if (null == aClass463_4813)
				...
				else if (!aClass523_Sub27_Sub14_Sub3_4812.inProgress) {
					byte[] is = aClass523_Sub27_Sub14_Sub3_4812.method18148(-89889532);
					try {
						aClass463_4814 = new Class463(new RSBuffer(is), aBigInteger4809, aBigInteger4816);
	...
	public boolean method6726() {
		...
		if (null == aClass523_Sub27_Sub14_Sub2_4810) {
			if (aClass458_4811.canAddLowPriority(1357652815))
				return false;
			aClass523_Sub27_Sub14_Sub2_4810 = aClass458_4811.removeRequest(255, 255, (byte) 0, true, (byte) 45);
		}
		if (aClass523_Sub27_Sub14_Sub2_4810.inProgress)
			return false;
		RSBuffer class523_sub34 = new RSBuffer(aClass523_Sub27_Sub14_Sub2_4810.method18148(763430061));
		aClass463_4813 = new Class463(class523_sub34, aBigInteger4809, aBigInteger4816);
		if (null == aClass467_Sub1Array4806)
			aClass467_Sub1Array4806 = new Class467_Sub1[aClass463_4813.aClass453Array5126.length];
		else {
	...
	static final void method6731(Class669 class669, byte i) {
		...
		class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_19_, (byte) 21)).anInt2233) * -1826834279;
	}
