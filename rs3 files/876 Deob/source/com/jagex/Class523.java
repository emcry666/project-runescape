...
public class Class523 {
	...
	static final void method8665(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_0_, -685583323);
		Class242 class242 = Class31.aClass242Array302[i_0_ >> 16];
		Class457.method7443(class250, class242, true, 0, class669, -1968462546);
	}

	static final void method8666(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
			...
			for (int i_7_ = 0; i_5_ != 0 && i_7_ < (class647_sub1_sub3_sub1.aClass707_Sub2_Sub1Array11933).length; i_5_ >>>= 1) {
				if ((i_5_ & 0x1) != 0) {
					if (i_4_ == -1)
						...
						AnimationDefinitions class205 = (AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_4_, (byte) -49);
