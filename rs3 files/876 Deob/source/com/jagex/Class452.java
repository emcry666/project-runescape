...
public class Class452 {
	...
	Class523_Sub27_Sub14_Sub3 method7298(int i, int i_1_, byte i_2_, boolean bool, int i_3_, int i_4_) {
		...
		if (!aBool4974 && !bool_5_)
			return null;
		if (10000L + aLong4970 * -8564360591818690391L >= TimeUtils.getCurrentTimeMilliseconds(1516375036))
			return null;
		Object object = null;
		String string;
		if (bool_5_)
			string = new StringBuilder().append("&cb=").append(TimeUtils.getCurrentTimeMilliseconds(1516375036)).toString();
		else
		...
		class523_sub27_sub14_sub3.isLowPriority = bool;
		anInt4969 += -1924850795;
