...
public abstract class Class467 {
	...
	abstract JS5ReferenceTable method7583(int i);

	abstract byte[] method7584(int i);

	abstract JS5ReferenceTable method7585();

	abstract JS5ReferenceTable method7586();
	...
	static final void method7596(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_3_, -422753281);
