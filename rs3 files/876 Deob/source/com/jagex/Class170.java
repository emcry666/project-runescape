...
public class Class170 {
	...
	static final void method2885(Class669 class669, int i) {
		...
		if (class76.method1537((byte) -66))
			class669.anObjectArray8559[(class669.anInt8560 += 1235970069) * 240723773 - 1] = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_1_, (byte) 5)).method3725(i_2_, class76.aString849, (byte) -80);
		else
			class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = (((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_1_, (byte) -7)).method3715(i_2_, class76.anInt850 * -1100663923, (byte) -53));
	}
	...
	static void method2890(InterfaceComponentDefinitions[] class250s, InterfaceComponentDefinitions class250, boolean bool, int i) {
		...
		Class214.method3841(class250s, class250.interfaceHash * -1363815505, i_6_, i_7_, bool, 143451369);
		if (class250.aClass250Array2519 != null)
			Class214.method3841(class250.aClass250Array2519, class250.interfaceHash * -1363815505, i_6_, i_7_, bool, 143451369);
		Class523_Sub36 class523_sub36 = ((Class523_Sub36) client.aClass14_11187.getFromIndex((long) (-1363815505 * class250.interfaceHash)));
		...
		if (client.aClass250_11114 == class250) {
			...
			for (int i_10_ = 0; i_10_ < 920163749 * client.anInt11050; i_10_++) {
				...
				Class523_Sub28 class523_sub28 = ((Class523_Sub28) client.aClass14_11047.getFromIndex((long) i_11_));
	...
	static final void method2891(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_12_, -736100855);
		Class242 class242 = Class31.aClass242Array302[i_12_ >> 16];
		Class602.method9936(class250, class242, class669, (short) 10445);
	}

	static final void method2892(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, PacketsDecoder class233, byte i) {
