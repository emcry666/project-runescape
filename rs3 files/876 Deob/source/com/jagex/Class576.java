...
public class Class576 implements Interface13, Interface6 {
	...
	void method9640(RSBuffer class523_sub34, int i) {
		if (i == 1)
	...
	void method9641(RSBuffer class523_sub34, int i) {
		if (i == 1)
	...
	void method9642(RSBuffer class523_sub34, int i, int i_4_) {
		if (i == 1)
	...
	static void method9645(Class523_Sub27_Sub19 class523_sub27_sub19, int i, Class669 class669, byte i_16_) {
		...
		class669.aMap8573.put(VarDomainType.PLAYER_CONFIGS, (Class98_Sub1_Sub2.playerVarsProvider.aClass590_1348));
		class669.aMap8573.put(VarDomainType.CLIENT_CONFIGS, Class423.clientConfigsDomain);
		class669.aMap8573.put(VarDomainType.CLAN_CONFIGS, QuickChatStringType.aClass149_8300);
		if (null != class669.aClass334_8571)
			class669.aMap8573.put(VarDomainType.CLAN_SETTING_CONFIGS, Class244.method4378(class669.aClass334_8571, -1055596246));
		if (class669.aClass647_Sub1_Sub3_Sub1_8552 instanceof NPC)
			class669.aMap8573.put(VarDomainType.NPC_CONFIGS, (class669.aClass647_Sub1_Sub3_Sub1_8552.anInterface20_11956));
		if (class669.aClass647_Sub1_Sub3_Sub1_8552 instanceof Player)
			class669.aMap8556.put(VarDomainType.PLAYER_CONFIGS, (class669.aClass647_Sub1_Sub3_Sub1_8552.anInterface20_11956));
		if (Class461.aClass218_5122 != null)
			class669.aMap8573.put(VarDomainType.aClass470_5345, Class461.aClass218_5122.method4024(519976705));
		try {
			try {
	...
	static final void method9647(Class669 class669, int i) {
		...
		QuickChatOptionDefinitions class523_sub27_sub18 = Class645.aClass24_8347.method839(i_17_, (byte) -55);
		if (null == class523_sub27_sub18.quickReplyOptions)
			class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = 0;
		else
			class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = class523_sub27_sub18.quickReplyOptions.length;
	}
}
