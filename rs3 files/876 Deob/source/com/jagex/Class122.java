...
public class Class122 {
	...
	Class122(Class178_Sub1 class178_sub1, Class147 class147, Class142_Sub2 class142_sub2, int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		...
		anInt1508 = i_5_;
		if (i_5_ > 0) {
			RSBuffer class523_sub34 = new RSBuffer(i_5_ * 2);
			...
			anInterface18_1501 = aClass178_Sub1_1511.method14660(5123, (class523_sub34.buffer), (class523_sub34.offset * 2349011), false);
