...
public class Class242 {
	...
	public InterfaceComponentDefinitions[] aClass250Array2457;
	InterfaceComponentDefinitions[] aClass250Array2458;

	public InterfaceComponentDefinitions method4364(int i) {
		if (i >>> 16 != aClass250Array2457[0].interfaceHash * -1363815505 >>> 16)
			throw new IllegalArgumentException();
		return aClass250Array2457[i & 0xffff];
	}

	public InterfaceComponentDefinitions[] method4365(byte i) {
		return (aClass250Array2458 == null ? aClass250Array2457 : aClass250Array2458);
	}

	Class242(boolean bool, InterfaceComponentDefinitions[] class250s) {
		aClass250Array2457 = class250s;
		aBool2456 = bool;
	}

	public InterfaceComponentDefinitions getDefinitions(int i, int i_0_) {
		if (i >>> 16 != aClass250Array2457[0].interfaceHash * -1363815505 >>> 16)
			throw new IllegalArgumentException();
		return aClass250Array2457[i & 0xffff];
	}

	public InterfaceComponentDefinitions[] method4367() {
		return (aClass250Array2458 == null ? aClass250Array2457 : aClass250Array2458);
	}

	public InterfaceComponentDefinitions[] method4368() {
		return (aClass250Array2458 == null ? aClass250Array2457 : aClass250Array2458);
	}

	public InterfaceComponentDefinitions[] method4369(int i) {
		if (aClass250Array2458 == null) {
			int i_1_ = aClass250Array2457.length;
			aClass250Array2458 = new InterfaceComponentDefinitions[i_1_];
	...
	static final void method4370(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_2_, -645612603);
