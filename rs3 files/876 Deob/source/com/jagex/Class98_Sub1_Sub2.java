...
public class Class98_Sub1_Sub2 extends Class98_Sub1 implements Interface12 {
	...
	Class159_Sub1 method17717(int i, int i_1_) {
		byte[] is = aClass472_11331.method7688((aClass470_8890.getCurrentConfigStruct((byte) 60).anInt8501) * 1688317219, i, -976886202);
		Class159_Sub1 class159_sub1 = new Class159_Sub1(aClass470_8890, i);
		if (null != is)
			class159_sub1.readValues(new RSBuffer(is), 2079267786);
		return class159_sub1;
	}
	...
	public Class98_Sub1_Sub2(Class681 class681, VarDomainType class470, Class668 class668, Class472 class472) {
		super(class681, class470, class668, (class472 != null ? class472.method7702((class470.getCurrentConfigStruct((byte) 33).anInt8501 * 1688317219), (byte) -3) : 0));
