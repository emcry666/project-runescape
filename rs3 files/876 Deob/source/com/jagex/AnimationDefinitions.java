...
public class AnimationDefinitions implements Interface13 {
	...
	public String method3714(int i, String string) {
		if (null == aClass14_2227)
			return string;
		Class523_Sub28 class523_sub28 = (Class523_Sub28) aClass14_2227.getFromIndex((long) i);
	...
	AnimationDefinitions(int i, Class208 class208) {
		...
		priority = -1979391729;
		rightHandItem = 1846042203;
		leftHandItem = -2144577099;
		anInt2228 = 131897575;
		anInt2229 = 949876769;
		anInt2238 = 338850961;
		anInt2220 = -200019730;
	...
	public void method76(RSBuffer buffer) {
		for (;;) {
			int i = buffer.readUnsignedByte(421056421);
			if (0 == i)
				break;
			method3716(buffer, i, -1771014218);
		}
	}
	...
	public int method3715(int i, int i_0_, byte i_1_) {
		if (aClass14_2227 == null)
			return i_0_;
		Class523_Sub24 class523_sub24 = (Class523_Sub24) aClass14_2227.getFromIndex((long) i);
	...
	void method3716(RSBuffer buffer, int opcode, int i_3_) {
		if (1 == opcode) {
			int i_4_ = buffer.readUnsignedShort(-256501963);
			anIntArray2225 = new int[i_4_];
			for (int i_5_ = 0; i_5_ < i_4_; i_5_++)
				anIntArray2225[i_5_] = buffer.readUnsignedShort(-1087116111);
			anIntArray2217 = new int[i_4_];
			for (int i_6_ = 0; i_6_ < i_4_; i_6_++)
				anIntArray2217[i_6_] = buffer.readUnsignedShort(-947463340);
			for (int i_7_ = 0; i_7_ < i_4_; i_7_++)
				anIntArray2217[i_7_] = (buffer.readUnsignedShort(-1879595044) << 16) + anIntArray2217[i_7_];
		} else if (2 == opcode)
			anInt2237 = buffer.readUnsignedShort(-1328464586) * -1029980571;
		else if (5 == opcode)
			priority = buffer.readUnsignedByte(327742006) * -1254871805;
		else if (6 == opcode)
			rightHandItem = buffer.readUnsignedShort(-1150484317) * -1846042203;
		else if (opcode == 7)
			leftHandItem = buffer.readUnsignedShort(-162309997) * 2144577099;
		else if (opcode == 8)
			anInt2228 = buffer.readUnsignedByte(2080546549) * -1864158547;
		else if (9 == opcode)
			anInt2229 = buffer.readUnsignedByte(358457490) * -949876769;
		else if (10 == opcode)
			anInt2238 = buffer.readUnsignedByte(645125595) * -338850961;
		else if (11 == opcode)
			anInt2220 = buffer.readUnsignedByte(1677751437) * 2047473783;
		else if (12 == opcode || opcode == 112) {
			int i_8_;
			if (opcode == 12)
				i_8_ = buffer.readUnsignedByte(577672302);
			else
				i_8_ = buffer.readUnsignedShort(-432169923);
			anIntArray2218 = new int[i_8_];
			for (int i_9_ = 0; i_9_ < i_8_; i_9_++)
				anIntArray2218[i_9_] = buffer.readUnsignedShort(-1731353915);
			for (int i_10_ = 0; i_10_ < i_8_; i_10_++)
				anIntArray2218[i_10_] = (buffer.readUnsignedShort(-773765861) << 16) + anIntArray2218[i_10_];
		} else if (opcode == 13) {
			int i_11_ = buffer.readUnsignedShort(-582953369);
			handledSounds = new int[i_11_][];
			for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
				int i_13_ = buffer.readUnsignedByte(-617642840);
				if (i_13_ > 0) {
					handledSounds[i_12_] = new int[i_13_];
					handledSounds[i_12_][0] = buffer.read24BitInt(1887251181);
					for (int i_14_ = 1; i_14_ < i_13_; i_14_++)
						handledSounds[i_12_][i_14_] = buffer.readUnsignedShort(-347527520);
				}
			}
		} else if (opcode == 14)
			aBool2232 = true;
			...
			if (opcode == 19 || opcode == 119) {
				if (null == anIntArray2234) {
					anIntArray2234 = new int[handledSounds.length];
					for (int i_15_ = 0; i_15_ < handledSounds.length; i_15_++)
						anIntArray2234[i_15_] = 255;
				}
				int i_16_;
				if (opcode == 19)
					i_16_ = buffer.readUnsignedByte(-1507256211);
				else
					i_16_ = buffer.readUnsignedShort(-224344599);
				anIntArray2234[i_16_] = buffer.readUnsignedByte(-1876841193);
				...
				if (soundMaxDelay == null || soundMinDelay == null) {
					...
					for (int i_17_ = 0; i_17_ < handledSounds.length; i_17_++) {
						soundMaxDelay[i_17_] = 256;
						soundMinDelay[i_17_] = 256;
					}
				}
				int i_18_;
				if (20 == opcode)
					i_18_ = buffer.readUnsignedByte(-1711552297);
				else
					i_18_ = buffer.readUnsignedShort(-1032410612);
				soundMaxDelay[i_18_] = buffer.readUnsignedShort(-1947663868);
				soundMinDelay[i_18_] = buffer.readUnsignedShort(-330985560);
			} else if (opcode == 22)
				anInt2214 = buffer.readUnsignedByte(1485641238) * 906618673;
			else if (opcode == 23)
				buffer.readUnsignedShort(-1900799797);
			else if (opcode == 24) {
				anInt2222 = buffer.readUnsignedShort(-1149309396) * 455055171;
				...
				int i_19_ = buffer.readUnsignedByte(-649237323);
				if (aClass14_2227 == null) {
					int i_20_ = Class628.method10313(i_19_, -1830742294);
					aClass14_2227 = new Class14(i_20_);
				}
				for (int i_21_ = 0; i_21_ < i_19_; i_21_++) {
					boolean bool = buffer.readUnsignedByte(1940770612) == 1;
					int i_22_ = buffer.read24BitInt(871781128);
					Class523 class523;
					if (bool)
						class523 = (new Class523_Sub28(buffer.readString(-1625611599)));
					else
						class523 = new Class523_Sub24(buffer.readUnsignedInt((byte) -21));
	...
	void method3717(RSBuffer class523_sub34, int i) {
		if (1 == i) {
			...
			rightHandItem = class523_sub34.readUnsignedShort(-438562714) * -1846042203;
		else if (i == 7)
			leftHandItem = class523_sub34.readUnsignedShort(-1636619985) * 2144577099;
		else if (i == 8)
			...
			handledSounds = new int[i_31_][];
			for (int i_32_ = 0; i_32_ < i_31_; i_32_++) {
				int i_33_ = class523_sub34.readUnsignedByte(-2132821448);
				if (i_33_ > 0) {
					handledSounds[i_32_] = new int[i_33_];
					handledSounds[i_32_][0] = class523_sub34.read24BitInt(187291179);
					for (int i_34_ = 1; i_34_ < i_33_; i_34_++)
						handledSounds[i_32_][i_34_] = class523_sub34.readUnsignedShort(-371287660);
				}
			}
		} else if (i == 14)
			aBool2232 = true;
			...
			if (i == 19 || i == 119) {
				if (null == anIntArray2234) {
					anIntArray2234 = new int[handledSounds.length];
					for (int i_35_ = 0; i_35_ < handledSounds.length; i_35_++)
				...
				if (soundMaxDelay == null || soundMinDelay == null) {
					soundMaxDelay = new int[handledSounds.length];
					soundMinDelay = new int[handledSounds.length];
					for (int i_37_ = 0; i_37_ < handledSounds.length; i_37_++) {
				...
				soundMaxDelay[i_38_] = class523_sub34.readUnsignedShort(-287064091);
				soundMinDelay[i_38_] = class523_sub34.readUnsignedShort(-797083596);
			} else if (i == 22)
	...
	void method3718(RSBuffer class523_sub34, int i) {
		if (1 == i) {
			...
			rightHandItem = class523_sub34.readUnsignedShort(-2024747547) * -1846042203;
		else if (i == 7)
			leftHandItem = class523_sub34.readUnsignedShort(-627978040) * 2144577099;
		else if (i == 8)
			...
			handledSounds = new int[i_50_][];
			for (int i_51_ = 0; i_51_ < i_50_; i_51_++) {
				int i_52_ = class523_sub34.readUnsignedByte(-871350698);
				if (i_52_ > 0) {
					handledSounds[i_51_] = new int[i_52_];
					handledSounds[i_51_][0] = class523_sub34.read24BitInt(483982663);
					for (int i_53_ = 1; i_53_ < i_52_; i_53_++)
						handledSounds[i_51_][i_53_] = class523_sub34.readUnsignedShort(-1732118215);
				}
			}
		} else if (i == 14)
			aBool2232 = true;
			...
			if (i == 19 || i == 119) {
				if (null == anIntArray2234) {
					anIntArray2234 = new int[handledSounds.length];
					for (int i_54_ = 0; i_54_ < handledSounds.length; i_54_++)
				...
				if (soundMaxDelay == null || soundMinDelay == null) {
					soundMaxDelay = new int[handledSounds.length];
					soundMinDelay = new int[handledSounds.length];
					for (int i_56_ = 0; i_56_ < handledSounds.length; i_56_++) {
						soundMaxDelay[i_56_] = 256;
						soundMinDelay[i_56_] = 256;
					}
				}
				int i_57_;
				if (20 == i)
				...
				soundMaxDelay[i_57_] = class523_sub34.readUnsignedShort(-1101889848);
				soundMinDelay[i_57_] = class523_sub34.readUnsignedShort(-1450155482);
			} else if (i == 22)
	...
	static final void method3728(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_70_, -1774915540);
