...
public class Class318 {
	...
	public static void method5692(byte i) {
		Container container = JS5Protocol.method7486(-1675585370);
		...
		if (i_3_ != -1308828521 * client.anInt5668 || 60613197 * Class391.anInt4023 != i_4_ || client.aBool11133) {
			...
			client.aLong11146 = ((TimeUtils.getCurrentTimeMilliseconds(1516375036) + 500L) * -7429034141385127915L);
			client.aBool11133 = false;
		}
	}

	static final void method5693(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
