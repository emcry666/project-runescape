...
public abstract class Class637 {
	...
	abstract void method10449(RSBuffer class523_sub34, Class523_Sub39 class523_sub39);
	...
	void method10450(byte i) {
		if (method10452((byte) 14)) {
			...
			while (iterator.hasNext()) {
				...
				if (class523_sub22 != null && (2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset) - i_0_ >= 252 - (6 + method10454(608968025))))
					break;
				...
				if (anInt8304 * 704672467 == i_4_ && anInt8303 * -1686187423 == i_3_)
					...
					if (class523_sub22 == null) {
						...
						i_0_ = (class523_sub22.aClass523_Sub34_Sub2_10525.offset) * 2349011;
						class523_sub22.aClass523_Sub34_Sub2_10525.offset += 379531446;
						i_1_ = 0;
						i_2_ = 0;
					}
					int i_5_;
			...
			if (class523_sub22 != null) {
				class523_sub22.aClass523_Sub34_Sub2_10525.method16276((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i_0_, 500354589);
				int i_8_ = (class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011);
				class523_sub22.aClass523_Sub34_Sub2_10525.offset = 189765723 * i_0_;
				...
				class523_sub22.aClass523_Sub34_Sub2_10525.offset = i_8_ * 189765723;
	...
	abstract void method10457(RSBuffer class523_sub34, Class523_Sub39 class523_sub39, int i);
	...
	abstract void method10467(RSBuffer class523_sub34, Class523_Sub39 class523_sub39);
	...
	void method10474() {
		if (method10452((byte) 34)) {
			...
			while (iterator.hasNext()) {
				Class523_Sub39 class523_sub39 = (Class523_Sub39) iterator.next();
				if (class523_sub22 != null && (2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset) - i >= 252 - (6 + method10454(608968025))))
					break;
				class523_sub39.method8661(607052656);
				...
				if (anInt8304 * 704672467 == i_13_ && anInt8303 * -1686187423 == i_12_)
					...
					if (class523_sub22 == null) {
						...
						i = (class523_sub22.aClass523_Sub34_Sub2_10525.offset) * 2349011;
						class523_sub22.aClass523_Sub34_Sub2_10525.offset += 379531446;
						i_10_ = 0;
						i_11_ = 0;
					}
			...
			if (class523_sub22 != null) {
				class523_sub22.aClass523_Sub34_Sub2_10525.method16276((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i, 1028935971);
				int i_17_ = (class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011);
				class523_sub22.aClass523_Sub34_Sub2_10525.offset = 189765723 * i;
				...
				class523_sub22.aClass523_Sub34_Sub2_10525.offset = i_17_ * 189765723;
