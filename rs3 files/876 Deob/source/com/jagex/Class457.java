...
public class Class457 {
	...
	Class457(Class452 class452, InputStream inputstream, Class523_Sub27_Sub14_Sub3 class523_sub27_sub14_sub3, URL url) {
		...
		if (null != inputstream) {
			int i = 10240;
			RSBuffer class523_sub34 = new RSBuffer(i, true);
			int i_0_ = 0;
			...
			while (i_0_ >= 0) {
				...
				if (i_0_ > 0) {
					if (class523_sub34.offset * 2349011 + i_0_ >= class523_sub34.buffer.length) {
						int i_1_ = 10240 + class523_sub34.buffer.length;
						byte[] is_2_ = Class689.method13936(i_1_, true, 1756993336);
						System.arraycopy(class523_sub34.buffer, 0, is_2_, 0, class523_sub34.offset * 2349011);
						Class689.method13938(class523_sub34.buffer, (byte) 40);
						class523_sub34.buffer = is_2_;
					}
			...
			byte[] is_4_ = new byte[2349011 * class523_sub34.offset];
			System.arraycopy(class523_sub34.buffer, 0, is_4_, 0, class523_sub34.offset * 2349011);
		...
		class523_sub27_sub14_sub3.inProgress = false;
	...
	static final void method7443(InterfaceComponentDefinitions class250, Class242 class242, boolean bool, int i, Class669 class669, int i_6_) {
		...
		if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456) {
			Class687_Sub1.method16687(class250.interfaceHash * -1363815505, 1718138974);
			BodyDefinitions.method10331(class250.interfaceHash * -1363815505, 825227355);
			Class98.method1780(class250.interfaceHash * -1363815505, (byte) -2);
		}
		if (i_7_ == -1) {
			class250.modelType = -182688103;
	...
	static final void method7444(Class669 class669, int i) {
		class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = ((null != Class241.player.aClass623_12183) && (Class241.player.aClass623_12183.aBool8104)) ? 1 : 0;
	}
