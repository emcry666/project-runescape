...
public class Class523_Sub27_Sub10 extends Class523_Sub27 {
	...
	void method18092(RSBuffer class523_sub34, int i) {
		for (;;) {
	...
	void method18096(RSBuffer class523_sub34, int i, byte i_3_) {
		do {
			if (i == 1)
	...
	void method18097(RSBuffer class523_sub34, int i) {
		do {
			if (i == 1)
	...
	void method18099(RSBuffer class523_sub34, int i) {
		do {
			if (i == 1)
	...
	void method18100(RSBuffer class523_sub34, int i) {
		do {
			if (i == 1)
	...
	void method18102(RSBuffer class523_sub34) {
		for (;;) {
