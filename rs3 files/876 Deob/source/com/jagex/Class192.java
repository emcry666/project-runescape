...
public final class Class192 {
	...
	NPC aClass647_Sub1_Sub3_Sub1_Sub1_2173;
	...
	void method3628(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		if (!aBool2174) {
			...
			if (-580266303 * anInt2172 >= 0) {
				aClass647_Sub1_Sub3_Sub1_Sub1_2173 = (new NPC(client.aClass505_11019.method8241((byte) -93), 25));
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11888 = -39653875 * anInt2171;
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11916 = client.cycles * 395066505;
				...
				aClass647_Sub1_Sub3_Sub1_Sub2_2175.anInt11916 = 395066505 * client.cycles;
	...
	Class192(RSBuffer class523_sub34, int i) {
	...
	boolean method3632(int i) {
		if (-580266303 * anInt2172 >= 0) {
			...
			for (int i_8_ = 0; i_8_ < is.length; i_8_++) {
				int i_9_ = is[i_8_];
				bool &= ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_9_, (byte) -91)).method3719(169699403);
			}
			return bool;
		}
		return true;
	...
	void method3633(int i, int i_10_, int i_11_, int i_12_) {
		if (!aBool2174) {
			aBool2174 = true;
			if (-580266303 * anInt2172 >= 0) {
				aClass647_Sub1_Sub3_Sub1_Sub1_2173 = (new NPC(client.aClass505_11019.method8241((byte) -6), 25));
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11888 = -39653875 * anInt2171;
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11916 = client.cycles * 395066505;
	...
	void method3634(int i, int i_13_, int i_14_, int i_15_) {
		if (!aBool2174) {
			aBool2174 = true;
			if (-580266303 * anInt2172 >= 0) {
				aClass647_Sub1_Sub3_Sub1_Sub1_2173 = (new NPC(client.aClass505_11019.method8241((byte) -52), 25));
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11888 = -39653875 * anInt2171;
				aClass647_Sub1_Sub3_Sub1_Sub1_2173.anInt11916 = client.cycles * 395066505;
	...
	boolean method3636() {
		if (-580266303 * anInt2172 >= 0) {
			...
			for (int i = 0; i < is.length; i++) {
				int i_18_ = is[i];
				bool &= ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(i_18_, (byte) -47)).method3719(169699403);
			}
			return bool;
		}
		return true;
