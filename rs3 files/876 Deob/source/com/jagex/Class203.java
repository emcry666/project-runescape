...
class Class203 implements Interface44 {
	...
	static void method3700(RSBuffer class523_sub34, byte i) {
	...
	static final void method3702(InterfaceComponentDefinitions class250, byte[] is, byte[] is_5_, Class669 class669, byte i) {
	...
	static void method3705(InterfaceComponentDefinitions class250, Class145 class145, int i, int i_10_, int i_11_, int i_12_, Class148 class148, int i_13_) {
