...
public class Class381 implements Interface49 {
	...
	public static Class381 method6406(RSBuffer class523_sub34) {
	...
	static void method6407(Class523_Sub27_Sub6 class523_sub27_sub6, int i, int i_18_, boolean bool, byte i_19_) {
		if (null != class523_sub27_sub6 && Class36.aClass708_342.aClass523_8838 != class523_sub27_sub6) {
			...
			if (25 == i_22_) {
				InterfaceComponentDefinitions class250 = Class654.method10722(i_21_, i_20_, (byte) 41);
				if (null != class250) {
				...
				if (16 == i_22_) {
					...
					class523_sub22.aClass523_Sub34_Sub2_10525.writeShort((Class241.player.anInt11888) * -1087669731, (byte) -88);
				...
				if (class408 != null) {
					Class523_Sub28 class523_sub28 = ((Class523_Sub28) client.aClass14_11047.getFromIndex((long) i_23_));
					if (class523_sub28 != null) {
						...
						Class581.method9664((class647_sub1_sub3_sub1_sub1.screenX[0]), (class647_sub1_sub3_sub1_sub1.screenY[0]), 1413447144);
					}
				}
				if (i_22_ == 59) {
					client.anInt11117 = -685128629 * i;
				...
				if (60 == i_22_) {
					if (client.rights * -1746920271 > 0 && WorldVarDomainType.method15902(-727172490))
						RSSocket.method506((Class241.player.aByte10821), (i_20_ + 235453015 * class592.localX), (1704054549 * class592.localY + i_21_), -1755464689);
					else {
						client.anInt11117 = -685128629 * i;
						client.anInt11122 = 1014439817 * i_18_;
						client.anInt11135 = -457701609;
				...
				if (15 == i_22_) {
					...
					if (class647_sub1_sub3_sub1_sub2 != null) {
						...
						Class581.method9664((class647_sub1_sub3_sub1_sub2.screenX[0]), (class647_sub1_sub3_sub1_sub2.screenY[0]), -570624772);
					}
				}
				if (58 == i_22_) {
					InterfaceComponentDefinitions class250 = Class654.method10722(i_21_, i_20_, (byte) 100);
					if (null != class250)
						Class446.method7240(class250, (byte) -22);
				}
				if (i_22_ == 23) {
					if (-1746920271 * client.rights > 0 && WorldVarDomainType.method15902(-1967370907))
						RSSocket.method506((Class241.player.aByte10821), (i_20_ + 235453015 * class592.localX), (i_21_ + 1704054549 * class592.localY), -1570602955);
					else {
				...
				if (null != class408_25_) {
					...
					if (null != class647_sub1_sub3_sub1_sub2) {
						...
						client.aClass116_11058.method1974(class523_sub22, (byte) 88);
						Class581.method9664((class647_sub1_sub3_sub1_sub2.screenX[0]), (class647_sub1_sub3_sub1_sub2.screenY[0]), 1743132779);
					}
				}
				if (i_22_ == 30 && null == client.aClass250_11189) {
					NetworkStream.method9225(i_21_, i_20_, 1369556809);
					client.aClass250_11189 = Class654.method10722(i_21_, i_20_, (byte) 14);
					if (client.aClass250_11189 != null)
						Login.method15991(client.aClass250_11189, (byte) -105);
				}
				if (i_22_ == 8) {
					Class523_Sub28 class523_sub28 = ((Class523_Sub28) client.aClass14_11047.getFromIndex((long) i_23_));
					if (class523_sub28 != null) {
						...
						client.aClass116_11058.method1974(class523_sub22, (byte) 74);
						Class581.method9664((class647_sub1_sub3_sub1_sub1.screenX[0]), (class647_sub1_sub3_sub1_sub1.screenY[0]), -993025943);
					}
				}
				...
				if (null != Class436.aClass250_4899 && client.anInt11173 * -1412331351 == 0)
					Login.method15991(Class436.aClass250_4899, (byte) -53);
			}
		}
	}
	...
	static final void method6409(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_31_, -1533581011);
