...
public class Class194_Sub2 extends Class194 {
	...
	Class194_Sub2(RSBuffer class523_sub34, int i, int i_0_) {
	...
	public void method3648(int i) {
		...
		Class647_Sub1_Sub3_Sub6 class647_sub1_sub3_sub6 = (new Class647_Sub1_Sub3_Sub6(client.aClass505_11019.method8241((byte) -122), 26032135 * anInt9865, i_5_, i_5_, i_3_, i_4_, anInt9872 * 1402167009 << 2, client.cycles, 1213409339 * anInt9876 + client.cycles, 589541029 * anInt9878, i_8_, 2126558069 * anInt9871 + 1, 1 + 20369487 * anInt9870, -2065843539 * anInt9875 << 2, false, 0, 0));
		class647_sub1_sub3_sub6.method18596(i_6_, i_7_, anInt9875 * -2065843539 << 2, (client.cycles + 1213409339 * anInt9876), -410729865);
	...
	boolean method3650(int i) {
		...
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(-61429051 * class671.emoteId, (byte) -44));
	...
	public void method3651() {
		...
		Class647_Sub1_Sub3_Sub6 class647_sub1_sub3_sub6 = (new Class647_Sub1_Sub3_Sub6(client.aClass505_11019.method8241((byte) -83), 26032135 * anInt9865, i_10_, i_10_, i, i_9_, anInt9872 * 1402167009 << 2, client.cycles, 1213409339 * anInt9876 + client.cycles, 589541029 * anInt9878, i_13_, 2126558069 * anInt9871 + 1, 1 + 20369487 * anInt9870, -2065843539 * anInt9875 << 2, false, 0, 0));
		class647_sub1_sub3_sub6.method18596(i_11_, i_12_, anInt9875 * -2065843539 << 2, (client.cycles + 1213409339 * anInt9876), -1140828668);
	...
	public void method3656() {
		...
		Class647_Sub1_Sub3_Sub6 class647_sub1_sub3_sub6 = (new Class647_Sub1_Sub3_Sub6(client.aClass505_11019.method8241((byte) -125), 26032135 * anInt9865, i_15_, i_15_, i, i_14_, anInt9872 * 1402167009 << 2, client.cycles, 1213409339 * anInt9876 + client.cycles, 589541029 * anInt9878, i_18_, 2126558069 * anInt9871 + 1, 1 + 20369487 * anInt9870, -2065843539 * anInt9875 << 2, false, 0, 0));
		class647_sub1_sub3_sub6.method18596(i_16_, i_17_, anInt9875 * -2065843539 << 2, (client.cycles + 1213409339 * anInt9876), 1682927556);
	...
	public void method3657() {
		...
		Class647_Sub1_Sub3_Sub6 class647_sub1_sub3_sub6 = (new Class647_Sub1_Sub3_Sub6(client.aClass505_11019.method8241((byte) -101), 26032135 * anInt9865, i_20_, i_20_, i, i_19_, anInt9872 * 1402167009 << 2, client.cycles, 1213409339 * anInt9876 + client.cycles, 589541029 * anInt9878, i_23_, 2126558069 * anInt9871 + 1, 1 + 20369487 * anInt9870, -2065843539 * anInt9875 << 2, false, 0, 0));
		class647_sub1_sub3_sub6.method18596(i_21_, i_22_, anInt9875 * -2065843539 << 2, (client.cycles + 1213409339 * anInt9876), -1944611403);
	...
	boolean method3655() {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(-61429051 * class671.emoteId, (byte) -119));
		bool &= class205.method3719(169699403);
		return bool;
	}
	...
	boolean method3653() {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(-61429051 * class671.emoteId, (byte) -69));
		bool &= class205.method3719(169699403);
		return bool;
	}
	...
	boolean method3654() {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(-61429051 * class671.emoteId, (byte) 61));
		bool &= class205.method3719(169699403);
		return bool;
	}
}
