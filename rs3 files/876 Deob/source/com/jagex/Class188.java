...
class Class188 implements Interface58 {
	...
	public static InterfaceComponentDefinitions getDefinitions(int i, int i_20_) {
		int i_21_ = i >> 16;
		if (Class31.aClass242Array302[i_21_] == null || (Class31.aClass242Array302[i_21_].getDefinitions(i, 41459288) == null)) {
			boolean bool = Class69.method1464(i_21_, null, 1929719609);
			if (!bool)
				return null;
		}
		return Class31.aClass242Array302[i_21_].getDefinitions(i, -874716849);
	}

	static boolean method3593(RSBitBuffer class523_sub34_sub2, int i, int i_22_) {
	...
	static String method3596(InterfaceComponentDefinitions class250, int i) {
