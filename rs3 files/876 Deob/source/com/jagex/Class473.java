...
public class Class473 {
	...
	public Class523_Sub27_Sub10 method7738(int i) {
		...
		if (is != null)
			class523_sub27_sub10.method18092(new RSBuffer(is), 326189351);
		if (i >= 32768)
	...
	public Class523_Sub27_Sub10 method7739(int i, byte i_0_) {
		...
		class523_sub27_sub10 = new Class523_Sub27_Sub10();
		if (is != null)
			class523_sub27_sub10.method18092(new RSBuffer(is), 519310859);
		if (i >= 32768)
	...
	public Class523_Sub27_Sub10 method7740(int i) {
		...
		class523_sub27_sub10 = new Class523_Sub27_Sub10();
		if (is != null)
			class523_sub27_sub10.method18092(new RSBuffer(is), -121100580);
		if (i >= 32768)
	...
	static boolean method7741(InterfaceComponentDefinitions class250, byte i) {
