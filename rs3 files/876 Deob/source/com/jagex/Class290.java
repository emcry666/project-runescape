...
public class Class290 {
	...
	static void method5216(Class242 class242, int i, int i_12_, int i_13_, boolean bool, Class669 class669, int i_14_) {
		...
		InterfaceComponentDefinitions class250 = class242.aClass250Array2457[i];
		if (null == class250.aClass250Array2535) {
			class250.aClass250Array2535 = new InterfaceComponentDefinitions[i_13_ + 1];
		...
		if (class250.aClass250Array2535.length <= i_13_) {
			if (class250.aClass250Array2535 == class250.aClass250Array2519) {
				InterfaceComponentDefinitions[] class250s = new InterfaceComponentDefinitions[1 + i_13_];
				...
				InterfaceComponentDefinitions[] class250s = new InterfaceComponentDefinitions[i_13_ + 1];
				InterfaceComponentDefinitions[] class250s_16_ = new InterfaceComponentDefinitions[1 + i_13_];
		...
		InterfaceComponentDefinitions class250_18_ = new InterfaceComponentDefinitions();
		class250_18_.type = i_12_ * -223716471;
		class250_18_.parentId = (class250_18_.interfaceHash = class250.interfaceHash * 1) * -1609778067;
	...
	static final void method5217(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		...
		if (i_19_ >= 0 && i_19_ < 5) {
			...
			Login.method15991(class250, (byte) -116);
			if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456)
				Class635.method10439(class250.interfaceHash * -1363815505, i_19_, 1004351327);
		}
	}

	static final void method5218(Class669 class669, byte i) {
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(class669.anIntArray8557[((class669.anInt8558 -= 2138772399) * 1357652815)], -633587300);
	...
	static final void method5221(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_25_, -1426613691);
