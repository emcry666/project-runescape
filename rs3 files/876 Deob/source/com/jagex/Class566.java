...
public class Class566 implements Runnable {
	...
	static String method9503(RSBuffer class523_sub34, int i, int i_14_) {
		String string;
		try {
			...
			class523_sub34.offset += (Class260.aClass262_2837.method4731((class523_sub34.buffer), (class523_sub34.offset) * 2349011, is, 0, i_15_, (short) 5921) * 189765723);
