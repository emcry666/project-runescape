...
class Class221 implements Interface44 {
	Class217 this$0;
	static Class557 aClass557_2332;
	...
	public static Class242 method4132(int i, int[] is, Class242 class242, boolean bool, byte i_0_) {
		...
		Class250[] class250s;
		if (i_1_ == 0)
			class250s = new Class250[0];
		else if (class242 == null)
			class250s = new Class250[i_1_];
		else
		...
		for (int i_2_ = 0; i_2_ < i_1_; i_2_++) {
			if (class242.aClass250Array2457[i_2_] == null) {
				byte[] is_3_ = Class251.aClass472_2716.method7648(i, i_2_, is, -1876906699);
				if (is_3_ != null) {
					Class250 class250 = class242.aClass250Array2457[i_2_] = new Class250();
					class250.anInt2585 = -2111216817 * (i_2_ + (i << 16));
					class250.method4428(new Class523_Sub34(is_3_), (byte) 18);
				}
			}
		}
		return class242;
