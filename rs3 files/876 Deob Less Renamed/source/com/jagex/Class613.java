...
public class Class613 {
	...
	void method10046(Class523_Sub34 class523_sub34) {
		for (;;) {
	...
	void method10047(Class523_Sub34 class523_sub34) {
		for (;;) {
	...
	public Class613(Class472 class472) {
		...
		if (null != is)
			method10048(new Class523_Sub34(is), -1667043721);
	}

	void method10048(Class523_Sub34 class523_sub34, int i) {
		for (;;) {
	...
	void method10049(Class523_Sub34 class523_sub34) {
		for (;;) {
	...
	void method10050(Class523_Sub34 class523_sub34) {
		for (;;) {
	...
	static final void method10054(Class250 class250, Class242 class242, Class669 class669, int i) {
	...
	static void method10055(Class178 class178, int i, int i_2_, Class250 class250, Class145 class145, int i_3_, int i_4_, int i_5_) {
		for (int i_6_ = 0; i_6_ < client.anInt11050 * 920163749; i_6_++) {
			Class523_Sub28 class523_sub28 = ((Class523_Sub28) client.aClass14_11047.method741((long) client.anIntArray11051[i_6_]));
			if (null != class523_sub28) {
				...
				if (class647_sub1_sub3_sub1_sub1.method18627(2079325769) && (class647_sub1_sub3_sub1_sub1.aByte10821 == (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821))) {
