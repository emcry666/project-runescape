...
public class Class687_Sub14 extends Class687 {
	...
	static final void decodeMasks(Class523_Sub34_Sub2 class523_sub34_sub2, byte i) {
		for (int i_3_ = 0; i_3_ < Class108.anInt1323 * -1962023375; i_3_++) {
			class523_sub34_sub2.readUnsignedShort(-1435075399);
			int i_4_ = Class108.anIntArray1312[i_3_];
			Player class647_sub1_sub3_sub1_sub2 = client.aClass647_Sub1_Sub3_Sub1_Sub2Array11153[i_4_];
			int mask = class523_sub34_sub2.readUnsignedByte(-695879624);
			if ((mask & 0x80) != 0)
				mask += class523_sub34_sub2.readUnsignedByte(1707916664) << 8;
			if ((mask & 0x800) != 0)
				mask += class523_sub34_sub2.readUnsignedByte(2115406455) << 16;
			Class232.decodeMask(class523_sub34_sub2, i_4_, class647_sub1_sub3_sub1_sub2, mask, (byte) 112);
		}
	}
}
