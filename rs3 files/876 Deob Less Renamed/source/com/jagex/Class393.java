...
public class Class393 {
	...
	public static Class382 method6493(Class523_Sub34 class523_sub34, int i) {
	...
	static final void method6494(Class669 class669, byte i) {
		...
		Class250 class250 = Class188.method3592(i_5_, -1487075135);
	...
	public static final void method6496(byte i) {
		if (-1 != client.anInt11116 * -1160807977 && -836108237 * client.anInt11103 != -1) {
			...
			Class248.anInt2491 = (-1053422769 * ((client.anIntArrayArrayArray11115[-1160807977 * client.anInt11116][i_8_][3]) + ((((client.anIntArrayArrayArray11115[-1160807977 * client.anInt11116][2 + i_8_][3]) - (client.anIntArrayArrayArray11115[client.anInt11116 * -1160807977][i_8_][3])) * (client.anInt11120 * 1714712881)) >> 16)));
		}
	}
	...
	static int method6497(byte[] is, int i, int i_30_, int i_31_) {
		...
		for (int i_33_ = i; i_33_ < i_30_; i_33_++)
			i_32_ = i_32_ >>> 8 ^ (Class523_Sub34.anIntArray10660[(i_32_ ^ is[i_33_]) & 0xff]);
		i_32_ ^= 0xffffffff;
		return i_32_;
	}
