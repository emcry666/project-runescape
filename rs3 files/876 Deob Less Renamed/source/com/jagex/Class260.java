...
public class Class260 {
	...
	public static int method4701(Class523_Sub34 class523_sub34, String string) {
		int i = class523_sub34.anInt10661 * 2349011;
		byte[] is = OutgoingPacket.method6623(string, 1768850870);
		class523_sub34.method16317(is.length, (short) -2002);
		class523_sub34.anInt10661 += aClass262_2837.method4724(is, 0, is.length, class523_sub34.aByteArray10658, 2349011 * class523_sub34.anInt10661, (byte) -80) * 189765723;
		return 2349011 * class523_sub34.anInt10661 - i;
	}

	public static int method4702(Class523_Sub34 class523_sub34, String string) {
		int i = class523_sub34.anInt10661 * 2349011;
		byte[] is = OutgoingPacket.method6623(string, -1975220533);
		class523_sub34.method16317(is.length, (short) -2002);
		class523_sub34.anInt10661 += aClass262_2837.method4724(is, 0, is.length, class523_sub34.aByteArray10658, 2349011 * class523_sub34.anInt10661, (byte) -99) * 189765723;
		return 2349011 * class523_sub34.anInt10661 - i;
	}
	...
	public static int method4703(Class523_Sub34 class523_sub34, String string) {
		int i = class523_sub34.anInt10661 * 2349011;
		byte[] is = OutgoingPacket.method6623(string, -1198075734);
		class523_sub34.method16317(is.length, (short) -2002);
		class523_sub34.anInt10661 += aClass262_2837.method4724(is, 0, is.length, class523_sub34.aByteArray10658, 2349011 * class523_sub34.anInt10661, (byte) -2) * 189765723;
		return 2349011 * class523_sub34.anInt10661 - i;
	}

	public static int method4704(Class523_Sub34 class523_sub34, String string) {
		int i = class523_sub34.anInt10661 * 2349011;
		byte[] is = OutgoingPacket.method6623(string, -86826433);
		class523_sub34.method16317(is.length, (short) -2002);
		class523_sub34.anInt10661 += aClass262_2837.method4724(is, 0, is.length, class523_sub34.aByteArray10658, 2349011 * class523_sub34.anInt10661, (byte) 30) * 189765723;
		return 2349011 * class523_sub34.anInt10661 - i;
	}

	public static String method4705(Class523_Sub34 class523_sub34) {
	...
	static final void method4708(Class669 class669, int i) {
		...
		Class250 class250 = Class188.method3592(i_0_, -1799152915);
