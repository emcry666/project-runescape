...
public class Class232 implements Interface28 {
	...
	Class232(Class224 class224, Class523_Sub34 class523_sub34) {
		this$0 = class224;
	...
	static final void decodeMask(Class523_Sub34_Sub2 buffer, int i, Player player, int i_1_, byte i_2_) {
		if (0 != (i_1_ & 0x20)) {
			int i_3_ = buffer.readUnsignedShort(-1216078617);
			if (65535 == i_3_)
				i_3_ = -1;
			player.anInt11909 = -1843265241 * i_3_;
		}
		if (0 != (i_1_ & 0x400)) {
		...
		if (0 != (i_1_ & 0x4000)) {
			String string = buffer.readString(-1888011741);
			if (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453 == player)
				Class515.method8593(2, 0, player.method18682(true, 1053685246), player.method18669(false, (byte) 0), player.displayName, string, null, -1531290572);
			player.method18660(string, 0, 0, -369582292);
		}
		if (0 != (i_1_ & 0x4)) {
			int i_4_ = buffer.readUnsignedShortLE((byte) 89);
			int i_5_ = buffer.readUnsignedIntV1(-1908553945);
			if (i_4_ == 65535)
				i_4_ = -1;
			int i_6_ = buffer.readUnsignedByte128(147554596);
			int i_7_ = i_6_ & 0x7;
			int i_8_ = i_6_ >> 3 & 0xf;
			if (15 == i_8_)
				i_8_ = -1;
			boolean bool = 1 == (i_6_ >> 7 & 0x1);
			player.method18337(i_4_, i_5_, i_7_, i_8_, bool, 0, 1924177644);
		}
		if (0 != (i_1_ & 0x2000)) {//head icons
			int i_9_ = buffer.readUnsignedByte(1862392730);
			byte[] is = new byte[i_9_];
			Class523_Sub34 class523_sub34 = new Class523_Sub34(is);
			buffer.readBytesReversed(is, 0, i_9_, 2013353240);
			Class108.aClass523_Sub34Array1317[i] = class523_sub34;
			player.decodeHeadIcons(class523_sub34, -654999937);
		}
		if (0 != (i_1_ & 0x100000)) {
			...
			player.anInt11924 = ((client.anInt11011 + buffer.readUnsignedShortLE128(1939502057)) * -1819254063);
			player.anInt11925 = (client.anInt11011 + buffer.readUnsignedShortLE128(1856314296)) * -637108827;
		}
		if ((i_1_ & 0x800000) != 0)
			player.aBool12202 = buffer.readUnsignedByte128(-1406808550) == 1;
		if ((i_1_ & 0x2) != 0) {
			...
			player.anInt11954 = (buffer.readUnsignedShort128((short) 767) + client.anInt11011) * -1242459571;
			player.anInt11932 = (buffer.readUnsignedShort(-1960659089) + client.anInt11011) * 1395835143;
			player.anInt11923 = buffer.readUnsignedShortLE((byte) 116) * 272295045;
			player.anInt11941 = -822788275;
			player.anInt11946 = 0;
			player.anInt11915 += player.anIntArray11885[0] * -25072087;
			player.anInt11917 += player.anIntArray11943[0] * 245440217;
			player.anInt11908 += (1206178097 * player.anIntArray11885[0]);
			player.anInt11918 += (-360111831 * player.anIntArray11943[0]);
		...
		if ((i_1_ & 0x10000) != 0) {
			...
			player.method18337(i_10_, i_11_, i_13_, i_14_, bool, 4, -808976619);
		}
		if (0 != (i_1_ & 0x40)) {
			player.anInt12195 = buffer.readUnsignedShort128((short) 28505) * -505899647;
			if (0 == player.anInt11941 * 703205765) {
				player.method18331(-1693078911 * player.anInt12195, 1444433219);
				player.anInt12195 = 505899647;
			}
		}
		if ((i_1_ & 0x40000) != 0) {
			player.anInterface2_11952.method20(-2046438609);
			buffer.anInt10661 += 379531446;
			int i_15_ = ((buffer.aByteArray10658[((buffer.anInt10661 += 189765723) * 2349011 - 1)]) & 0xff);
			for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
				int i_17_ = buffer.readUnsignedByte128(885582781);
				Class474 class474 = ((Class474) Class334.method5910(Class474.method7746(693190351), i_17_, 866760439));
		...
		if ((i_1_ & 0x1) != 0) {
			...
			if (i_18_ > 0) {
				for (int i_19_ = 0; i_19_ < i_18_; i_19_++) {
					...
					player.method18340(i_23_, i_21_, i_20_, i_22_, client.anInt11011, i_24_, 513676825);
				}
			}
			...
			if (i_25_ > 0) {
				for (int i_26_ = 0; i_26_ < i_25_; i_26_++) {
					...
					if (i_28_ != 32767) {
						...
						player.method18349(i_27_, (client.anInt11011), i_28_, i_29_, i_30_, i_31_, -1970230724);
					} else
		...
		if ((i_1_ & 0x8000) != 0) {
			...
			player.method18337(i_32_, i_33_, i_35_, i_36_, bool, 2, 559682214);
		}
		if (0 != (i_1_ & 0x200000)) {
			...
			player.method18337(i_37_, i_38_, i_40_, i_41_, bool, 3, -781365698);
		}
		if ((i_1_ & 0x8) != 0) {//appearance 14
			int i_42_ = buffer.readUnsignedByteC(-2026222340);
			byte[] is = new byte[i_42_];
			Class523_Sub34 class523_sub34 = new Class523_Sub34(is);
			buffer.readBytesReversed(is, 0, i_42_, 2046906494);
			Class108.aClass523_Sub34Array1316[i] = class523_sub34;
			player.decodeAppearance(class523_sub34, 868284689);
		}
		if (0 != (i_1_ & 0x20000)) {
			buffer.anInt10661 += 379531446;
			int i_43_ = ((buffer.aByteArray10658[((buffer.anInt10661 += 189765723) * 2349011 - 1)]) & 0xff);
			for (int i_44_ = 0; i_44_ < i_43_; i_44_++) {
				int i_45_ = buffer.readUnsignedByteC(674586290);
				Class474 class474 = ((Class474) Class334.method5910(Class474.method7746(2028976425), i_45_, 1359595407));
				Class426 class426 = (Class669.aClass98_Sub1_Sub1_8582.method14344(buffer, class474, (byte) 1));
		...
		if ((i_1_ & 0x400000) != 0) {
			...
			player.method18660(string, 0, 0, -940600446);
		}
		if ((i_1_ & 0x80000) != 0) {
		...
		if ((i_1_ & 0x1000) != 0) {
			...
			player.method18337(i_52_, i_53_, i_55_, i_56_, bool, 1, -1720737465);
		}
		if ((i_1_ & 0x200) != 0) {
		...
		if ((i_1_ & 0x10) != 0) {
			...
			Class643.method10538(player, is, i_62_, false, -700536104);
		}
	}

	static void method4255(Class647_Sub1_Sub3_Sub1_Sub1 class647_sub1_sub3_sub1_sub1, boolean bool, int i) {
		if (Class36.anInt330 * 462991943 < 409) {
			...
			if (class300.aBool3287) {
				if (0 != 1167898669 * class647_sub1_sub3_sub1_sub1.anInt12171) {
					...
					string = new StringBuilder().append(string).append(Class443.method7204((class647_sub1_sub3_sub1_sub1.anInt12171 * 1167898669), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12186) * 1773490063, (byte) -63)).append(Class31.aString297).append(string_63_).append(1167898669 * class647_sub1_sub3_sub1_sub1.anInt12171).append(Class31.aString295).toString();
				}
	...
	static void method4256(Class523_Sub27_Sub6 class523_sub27_sub6, byte i) {
		if (!Class36.aBool326) {
			...
			if (!class523_sub27_sub6.aBool11638) {
				...
				for (class523_sub27_sub8 = ((Class523_Sub27_Sub8) Class36.aClass14_338.method741(l)); (null != class523_sub27_sub8 && !class523_sub27_sub8.aString11720.equals(class523_sub27_sub6.aString11637)); class523_sub27_sub8 = ((Class523_Sub27_Sub8) Class36.aClass14_338.method740(231172810))) {
					/* empty */
				}
				...
				for (Class523_Sub27_Sub8 class523_sub27_sub8 = ((Class523_Sub27_Sub8) Class36.aClass697_339.method14016(-1426448868)); class523_sub27_sub8 != null; class523_sub27_sub8 = ((Class523_Sub27_Sub8) Class36.aClass697_339.method14018(768418218))) {
					if (class523_sub27_sub8.aString11720.equals(class523_sub27_sub6.aString11637)) {
						boolean bool = false;
						for (Class523_Sub27_Sub6 class523_sub27_sub6_73_ = ((Class523_Sub27_Sub6) class523_sub27_sub8.aClass697_11718.method14016(-1426448868)); class523_sub27_sub6_73_ != null; class523_sub27_sub6_73_ = ((Class523_Sub27_Sub6) class523_sub27_sub8.aClass697_11718.method14018(768418218))) {
