			...
			for (int i_10_ = 0; i_10_ < anInt1706; i_10_++) {
				...
				for (int i_13_ = 0; i_13_ < anInt1710; i_13_++) {
					...
					if (i_14_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_13_][i_10_].method2097(class523_sub34_sub1.aByteArray10658, i_14_);
					}
				}
			}
		}
			...
			for (int i_33_ = 0; i_33_ < anInt1706; i_33_++) {
				...
				for (int i_36_ = 0; i_36_ < anInt1710; i_36_++) {
					...
					if (i_37_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_36_][i_33_].method2097(class523_sub34_sub1.aByteArray10658, i_37_);
					}
				}
			}
		}
			...
			for (int i_136_ = 0; i_136_ < anInt1706; i_136_++) {
				...
				for (int i_139_ = 0; i_139_ < anInt1710; i_139_++) {
					...
					if (i_140_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_139_][i_136_].method2097(class523_sub34_sub1.aByteArray10658, i_140_);
					}
				}
			}
		}
			...
			for (int i_158_ = 0; i_158_ < anInt1706; i_158_++) {
				...
				for (int i_161_ = 0; i_161_ < anInt1710; i_161_++) {
					...
					if (i_162_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_161_][i_158_].method2097(class523_sub34_sub1.aByteArray10658, i_162_);
					}
				}
			}
		}
			...
			for (int i_191_ = 0; i_191_ < anInt1706; i_191_++) {
				...
				for (int i_194_ = 0; i_194_ < anInt1710; i_194_++) {
					...
					if (i_195_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_194_][i_191_].method2097(class523_sub34_sub1.aByteArray10658, i_195_);
					}
				}
			}
		}
			...
			for (int i_316_ = 0; i_316_ < anInt1706; i_316_++) {
				...
				for (int i_319_ = 0; i_319_ < anInt1710; i_319_++) {
					...
					if (i_320_ > 0) {
						...
						OpenGL.glMatrixMode(5888);
						aClass122ArrayArray1713[i_319_][i_316_].method2097(class523_sub34_sub1.aByteArray10658, i_320_);
					}
				}
			}
		}
