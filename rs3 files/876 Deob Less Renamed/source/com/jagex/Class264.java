			...
			try {
				if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
					...
					if (2 == Class562.anInt7564 * 2097396553) {
						...
						Class485.method7932(new StringBuilder().append("Pos: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -726146514)) + (int) class437.aFloat4904).toString(), (byte) -40);
						Class485.method7932(new StringBuilder().append("Look: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437_9_.aFloat4903 >> 9, (int) class437_9_.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437_9_.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -1025268105)) + (int) class437.aFloat4904).toString(), (byte) -16);
					} else {
						Class485.method7932(new StringBuilder().append("Pos: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append(((760427037 * Class77.anInt858 >> 9) + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + (-1221225203 * Class497.anInt5563 >> 9)) >> 6).append(",").append((class592.localX * 235453015 + (760427037 * Class77.anInt858 >> 9)) & 0x3f).append(",").append(((-1221225203 * Class497.anInt5563 >> 9) + class592.localY * 1704054549) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(760427037 * Class77.anInt858, -1221225203 * Class497.anInt5563, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -486089866)) - Class285.anInt3085 * 805779207).toString(), (byte) -16);
						Class485.method7932(new StringBuilder().append("Look: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append((-1744666137 * Class602.anInt7934 + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + Class42.anInt564 * -479513739) >> 6).append(",").append((class592.localX * 235453015 + -1744666137 * Class602.anInt7934) & 0x3f).append(",").append((class592.localY * 1704054549 + Class42.anInt564 * -479513739) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(-1744666137 * Class602.anInt7934, -479513739 * Class42.anInt564, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -1038587401)) - Class290.anInt3146 * 1734327845).toString(), (byte) -107);
					}
				}
		...
		if (Class674.aClass674_8613 != Class80.aClass674_865 || -1746920271 * client.rights >= 2) {
			try {
				...
				if (string.equalsIgnoreCase("breakcon")) {
					...
					for (int i_13_ = 0; i_13_ < class116s.length; i_13_++) {
						Class116 class116 = class116s[i_13_];
						if (class116.method1979(782493095) != null)
							class116.method1979(782493095).method9204(-574844400);
					}
				...
				if (string.startsWith("getclientvarp")) {
					...
					Class485.method7932(new StringBuilder().append("varp=").append(Class98_Sub1_Sub2.playerVarsProvider.method94((Class98_Sub1_Sub2.playerVarsProvider.method110(Class470.aClass470_5354, i_15_, 1916119467)), 758882264)).toString(), (byte) -100);
					return;
				}
				...
				if (9 == client.anInt11136 * -2020118759 || -2020118759 * client.anInt11136 == 0) {
					Class116 class116 = Class537.method8941(-2032440421);
