...
public class Class643 implements Interface75 {
	...
	public static void method10538(Class647_Sub1_Sub3_Sub1 class647_sub1_sub3_sub1, int[] is, int i, boolean bool, int i_0_) {
		...
		for (int i_5_ = 0; i_5_ < is.length; i_5_++) {
			if (is[i_5_] != -1)
				bool_4_ = false;
			if (class647_sub1_sub3_sub1.anIntArray11911 == null || class647_sub1_sub3_sub1.anIntArray11911[i_5_] == -1 || ((((AnimationDefinitions) Class248.aClass53_Sub13_2492.getDefinition(is[i_5_], (byte) 58)).priority * 1835115947) >= ((AnimationDefinitions) (Class248.aClass53_Sub13_2492.getDefinition(class647_sub1_sub3_sub1.anIntArray11911[i_5_], (byte) 45))).priority * 1835115947)) {
				class647_sub1_sub3_sub1.anIntArray11911 = is;
				class647_sub1_sub3_sub1.aClass707_11913.method14174(i, (byte) 53);
				if (bool)
					class647_sub1_sub3_sub1.anInt11946 = -1125057301 * class647_sub1_sub3_sub1.anInt11941;
			}
		}
		if (bool_4_) {
			class647_sub1_sub3_sub1.anIntArray11911 = is;
