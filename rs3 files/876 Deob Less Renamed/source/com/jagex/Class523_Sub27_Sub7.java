...
public class Class523_Sub27_Sub7 extends Class523_Sub27 {
	...
	static Class697 aClass697_11657;
	...
	static Class697 aClass697_11671 = new Class697();
	...
	void method17962(byte i) {
		aLong10552 = ((aLong10552 * -8659322449062458077L & ~0x7fffffffffffffffL | Class248.method4401(1516375036) + 500L) * -9121445971199030645L);
		aClass697_11657.method14030(this, (byte) -80);
	}

	void method17963(int i) {
		aLong10552 = -9121445971199030645L * (aLong10552 * -8659322449062458077L | ~0x7fffffffffffffffL);
		if (method17966(-421495104) == 0L)
			aClass697_11671.method14030(this, (byte) -27);
	}
	...
	long method17966(int i) {
		return aLong10552 * -8659322449062458077L & 0x7fffffffffffffffL;
	}

	static {
		aClass697_11657 = new Class697();
	...
	static void method17970() {
		...
		aClass697_11657.method14014(1239462612);
		aClass697_11671.method14014(-234750665);
	}
	...
	static void method17972() {
		...
		aClass697_11657.method14014(694444780);
		aClass697_11671.method14014(-202089947);
	}

	static Class523_Sub27_Sub7 method17973(int i, long l) {
		aBool11677 = false;
		Class523_Sub27_Sub7 class523_sub27_sub7 = ((Class523_Sub27_Sub7) aClass14_11647.method741((long) i << 56 | l));
	...
	static Class523_Sub27_Sub7 method17974() {
		Class523_Sub27_Sub7 class523_sub27_sub7 = (Class523_Sub27_Sub7) aClass697_11671.method14016(-1426448868);
		if (class523_sub27_sub7 != null) {
		...
		for (;;) {
			class523_sub27_sub7 = ((Class523_Sub27_Sub7) aClass697_11657.method14016(-1426448868));
			if (null == class523_sub27_sub7)
				return null;
			if (class523_sub27_sub7.method17966(-1187623694) > Class248.method4401(1516375036))
				return null;
			class523_sub27_sub7.method8661(607052656);
			class523_sub27_sub7.method16154(-261651695);
			if (0L != (-8659322449062458077L * class523_sub27_sub7.aLong10552 & ~0x7fffffffffffffffL))
				return class523_sub27_sub7;
		}
	}
	...
	static void method17988() {
		...
		aClass697_11657.method14014(-533324899);
		aClass697_11671.method14014(820551460);
	}
	...
	static Class523_Sub27_Sub7 method18050() {
		...
		for (;;) {
			...
			if (null == class523_sub27_sub7)
				return null;
			if (class523_sub27_sub7.method17966(54283159) > Class248.method4401(1516375036))
				return null;
			class523_sub27_sub7.method8661(607052656);
			class523_sub27_sub7.method16154(-261651695);
			if (0L != (-8659322449062458077L * class523_sub27_sub7.aLong10552 & ~0x7fffffffffffffffL))
	...
	static void method18052() {
		...
		aClass697_11657.method14014(1413884847);
		aClass697_11671.method14014(906222198);
	}
	...
	void method18056() {
		...
		if (method17966(2100059323) == 0L)
			aClass697_11671.method14030(this, (byte) -29);
	}

	void method18057() {
		aLong10552 = -9121445971199030645L * (aLong10552 * -8659322449062458077L | ~0x7fffffffffffffffL);
		if (method17966(93387577) == 0L)
			aClass697_11671.method14030(this, (byte) -69);
	}
