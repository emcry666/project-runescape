...
public class Class225 implements Interface28 {
	...
	Class225(Class224 class224, Class523_Sub34 class523_sub34) {
		this$0 = class224;
	...
	public static void method4157(Class250 class250, int i, int i_3_, byte i_4_) {
		if (null != class250) {
			...
			Class232.anInt2367 = class250.anInt2585 * 880360359;
			...
			Class523_Sub14.method15991(class250, (byte) -52);
		}
	}
