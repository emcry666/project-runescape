...
public class Class650 {
	...
	static final void method10623(Class250 class250, Class669 class669, int i) {
	...
	static final void method10624(Class669 class669, byte i) {
		if (Class194_Sub6.aClass334_9900 != null) {
			...
			class669.aMap8573.put(Class470.aClass470_5352, Class244.method4378(class669.aClass334_8571, -1260447139));
		} else
	...
	public static void method10626(Iterable iterable, Class523_Sub34 class523_sub34, short i) {
		int i_1_ = Class567.method9518(iterable, -2088907955);
		class523_sub34.method16317(i_1_, (short) -2002);
		if (0 != i_1_) {
			for (int i_2_ = 0; i_2_ < i_1_; i_2_++)
				class523_sub34.aByteArray10658[2349011 * class523_sub34.anInt10661 + i_2_] = (byte) 0;
			Iterator iterator = iterable.iterator();
			while (iterator.hasNext()) {
				Interface75 interface75 = (Interface75) iterator.next();
				int i_3_ = interface75.method82();
				int i_4_ = i_3_ / 8;
				class523_sub34.aByteArray10658[class523_sub34.anInt10661 * 2349011 + i_4_] |= 1 << (i_3_ & 0x7);
			}
			class523_sub34.anInt10661 += i_1_ * 189765723;
		}
	}
