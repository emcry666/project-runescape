...
public class Class525 {
	...
	boolean method8690(InputStream inputstream, OutputStream outputstream, long l) throws IOException {
	...
	boolean method8703(byte[] is, int i) {
		if (is.length < 5)
			return false;
		int i_67_ = is[0] & 0xff;
		int i_68_ = i_67_ % 9;
	...
	public static Object[] method8709(Class523_Sub34 class523_sub34, Class464[] class464s, int i) {
	...
	static final void method8710(Class669 class669, int i) {
		...
		Class250 class250 = Class188.method3592(i_100_, -1686059044);
	...
	static final void method8711(Class669 class669, byte i) {
		...
		Class250 class250 = Class188.method3592(i_101_, -1018549530);
