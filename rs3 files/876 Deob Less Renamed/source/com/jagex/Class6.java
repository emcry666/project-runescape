...
public class Class6 {
	...
	public static void method525(boolean bool, byte[] is) {
		if (Class251.aClass523_Sub34_2717 == null)
			Class251.aClass523_Sub34_2717 = new Class523_Sub34(20000);
		Class251.aClass523_Sub34_2717.readBytes(is, 0, is.length, (short) -30627);
		if (bool) {
			Class77.method1544(Class251.aClass523_Sub34_2717.aByteArray10658, (byte) -117);
			...
			aBool43 = false;
			Class228.aLong2349 = Class248.method4401(1516375036) * 1454622044886850051L;
	...
	public static void method536(boolean bool, byte[] is) {
		...
		if (bool) {
			Class77.method1544(Class251.aClass523_Sub34_2717.aByteArray10658, (byte) -79);
			aClass611_Sub1Array47 = new Class611_Sub1[2004567773 * Class595.anInt7827];
			int i = 0;
	...
	public static void method538(boolean bool, byte[] is) {
		...
		if (bool) {
			Class77.method1544(Class251.aClass523_Sub34_2717.aByteArray10658, (byte) -77);
			aClass611_Sub1Array47 = new Class611_Sub1[2004567773 * Class595.anInt7827];
			int i = 0;
	...
	public static void method539(boolean bool, byte[] is) {
		...
		if (bool) {
			Class77.method1544(Class251.aClass523_Sub34_2717.aByteArray10658, (byte) -60);
			aClass611_Sub1Array47 = new Class611_Sub1[2004567773 * Class595.anInt7827];
			int i = 0;
