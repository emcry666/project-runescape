		...
		if (null != string) {
			if (1563815891 * client.anInt11287 >= i_38_)
				...
				if (string_39_ != null) {
					...
					if (Class226.method4163((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.username), Class112.aClass73_1351, (byte) 62).equals(string_39_))
						Class214.method3840(4, (Class39.aClass39_527.method1124(Class53_Sub20.aClass668_10979, (byte) -97)), 2127248874);
					else {
						Class116 class116 = Class537.method8941(-1384989808);
