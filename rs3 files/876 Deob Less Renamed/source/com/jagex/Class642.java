...
public class Class642 {
	...
	static final void method10533(Class669 class669, int i) {
		...
		Class250 class250 = Class188.method3592(i_0_, -1122662053);
	...
	public static final void method10536(Class250[] class250s, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, byte i_11_) {
		Class31.aClass178_303.method3378(i_4_, i_5_, i_6_, i_7_);
		for (int i_12_ = 0; i_12_ < class250s.length; i_12_++) {
			Class250 class250 = class250s[i_12_];
			if (null != class250 && (class250.anInt2546 * 97896203 == i || (i == -1412584499 && client.aClass250_11197 == class250))) {
				int i_13_;
				if (-1 == i_10_) {
				...
				class250.anInt2706 = client.anInt11011 * -333677645;
				if (!client.method17254(class250)) {
					...
					if (client.aBool11180 && ((client.method17252(class250).anInt10450 * 747608249) != 0 || class250.anInt2534 * 36473529 == 0) && i_16_ > 127)
						i_16_ = 127;
					if (client.aClass250_11197 == class250) {
						if (-1412584499 != i && ((175219699 * class250.anInt2633 == -1769267387 * Class250.anInt2675) || (Class250.anInt2506 * 723497885 == 175219699 * class250.anInt2633) || (client.method17252(class250).method15967((byte) 40) && (1202875309 * Class250.anInt2558 != class250.anInt2633 * 175219699)))) {
							Class523_Sub15.aClass250Array10471 = class250s;
							Class58.anInt753 = 2014160343 * i_8_;
							Class458_Sub1.anInt10326 = 2098380537 * i_9_;
							continue;
						}
						if (client.aBool11231 && client.aBool11213) {
							...
							if (175219699 * class250.anInt2633 != 1202875309 * Class250.anInt2558) {
								i_14_ = i_17_;
								i_15_ = i_18_;
							}
						}
						if (Class250.anInt2506 * 723497885 == 175219699 * class250.anInt2633)
							i_16_ = 128;
					}
					int i_19_;
					int i_20_;
					int i_21_;
					int i_22_;
					if (2 == 36473529 * class250.anInt2534) {
						i_19_ = i_4_;
						i_20_ = i_5_;
						i_21_ = i_6_;
						i_22_ = i_7_;
						...
						if (9 == class250.anInt2534 * 36473529) {
							i_23_++;
							i_24_++;
						}
					...
					if (i_19_ < i_21_ && i_20_ < i_22_) {
						if (0 != 1963816533 * class250.anInt2582) {
							if ((1301979947 * Class250.anInt2538 == 1963816533 * class250.anInt2582) || (15445289 * Class250.anInt2630 == 1963816533 * class250.anInt2582)) {
								if (client.aBool10980) {
									Class31.aClass178_303.method3206();
									Class702.method14125(i_14_, i_15_, class250.anInt2581 * 365308179, class250.anInt2543 * -1759297857, (15445289 * Class250.anInt2630 == 1963816533 * class250.anInt2582), (short) 7401);
							...
							if ((class250.anInt2582 * 1963816533 == 1365047505 * Class250.anInt2508) && client.anInt11071 * -1616721887 == 3) {
								if (5 != 36473529 * class250.anInt2534 || (class250.method4440((Class31.aClass178_303), (byte) -64) != null)) {
									Class687_Sub7.method16802((Class31.aClass178_303), class250, i_14_, i_15_, -215635651);
									Class31.aClass178_303.method3378(i_4_, i_5_, i_6_, i_7_);
								}
								continue;
							}
							if (class250.anInt2582 * 1963816533 == -833542861 * Class250.anInt2518) {
								Class240.method4344(Class31.aClass178_303, i_14_, i_15_, class250, (byte) 105);
								continue;
							}
							if (Class250.anInt2516 * -124642643 == class250.anInt2582 * 1963816533) {
								Class274.method5031(Class31.aClass178_303, i_14_, i_15_, class250, (class250.anInt2556 * -293786715 % 64), 1962256274);
								continue;
							}
							if (-1196308247 * Class250.anInt2509 == class250.anInt2582 * 1963816533) {
							...
							if (1963816533 * class250.anInt2582 == -562952145 * Class250.anInt2510) {
							...
							if (1963816533 * class250.anInt2582 == Class250.anInt2511 * -259826345) {
							...
							if (-2006194977 * Class250.anInt2658 == class250.anInt2582 * 1963816533) {
								if (client.aBool11096 || client.aBool11280) {
									Class460.method7502(i_14_, i_15_, class250, (byte) 21);
									client.aBoolArray11246[i_13_] = true;
								}
								continue;
							}
							if (Class250.anInt2517 * 1211745551 == class250.anInt2582 * 1963816533) {
							...
							if (Class250.anInt2528 * -1559569275 == class250.anInt2582 * 1963816533) {
								if (Class423.method6714(899016063) && Class220.method4130((byte) 0))
									Class197.method3670(i_4_, i_5_, i_6_, i_7_, 65280);
								continue;
							}
						}
						if (0 == class250.anInt2534 * 36473529) {
							if (1963816533 * class250.anInt2582 == -1315133245 * Class250.anInt2514) {
								Class31.aClass178_303.method3206();
							...
							method10536(class250s, class250.anInt2585 * -1363815505, i_19_, i_20_, i_21_, i_22_, (i_14_ - class250.anInt2636 * -448482823), (i_15_ - -1013149031 * class250.anInt2539), i_13_, bool, (byte) -21);
							if (class250.aClass250Array2519 != null)
								method10536(class250.aClass250Array2519, -1363815505 * class250.anInt2585, i_19_, i_20_, i_21_, i_22_, i_14_ - (class250.anInt2636 * -448482823), i_15_ - (class250.anInt2539 * -1013149031), i_13_, bool, (byte) -54);
							Class523_Sub36 class523_sub36 = ((Class523_Sub36) (client.aClass14_11187.method741((long) (class250.anInt2585 * -1363815505))));
							...
							if (Class250.anInt2514 * -1315133245 == class250.anInt2582 * 1963816533) {
								...
								if (4 == -1616721887 * client.anInt11071) {
									...
									if (client.anInt11011 < 1730058607 * client.anInt11079) {
										float f = (1.0F * (float) (client.anInt11011 - (-141996737 * (client.anInt11076))) / (float) ((client.anInt11079 * 1730058607) - (-141996737 * (client.anInt11076))));
						...
						if (client.aBoolArray11247[i_13_] || 2023836395 * client.anInt11249 > 1) {
							if (36473529 * class250.anInt2534 == 3) {
								if (0 == i_16_) {
							...
							} else if (4 == class250.anInt2534 * 36473529) {
							...
							} else if (class250.anInt2534 * 36473529 == 5) {
								if (642394889 * class250.anInt2547 >= 0)
									...
									if (-1 != class250.anInt2680 * -1878986101) {
										Class623 class623 = (class250.aBool2655 ? (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aClass623_12183) : null);
										...
										if (class148 == null && !(client.aMap11300.containsKey(Integer.valueOf(-623144603 * class250.anInt2691)))) {
											try {
												client.aMap11300.put((Integer.valueOf(-623144603 * class250.anInt2691)), (Class282.aClass55_3070.method1351((new URL(new StringBuilder().append(client.aString10995).append("/img/image_").append((class250.anInt2691) * -623144603).append(".png?a=").append(Class248.method4401(1516375036)).toString())), -998646991)));
									...
									} else if (Class250.aBool2525)
										Class523_Sub14.method15991(class250, (byte) -17);
								}
							} else if (6 == class250.anInt2534 * 36473529) {
								Class31.aClass178_303.method3206();
								...
								if (class250.anInt2680 * -1878986101 != -1) {
									...
									if (null != class12) {
										...
										class167 = (class12.method660(Class31.aClass178_303, i_47_, 1, (class250.aBool2655 ? (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aClass623_12183) : null), class250.aClass707_2693, 0, 0, 0, 0, (byte) 0));
										if (class167 != null)
											i_48_ = -class167.method2804() >> 1;
										else
											Class523_Sub14.method15991(class250, (byte) 0);
									}
								} else if (-428962391 * class250.anInt2570 == 3) {
									...
									if (i_49_ >= 0 && i_49_ < 2048) {
										...
										if ((class647_sub1_sub3_sub1_sub2 != null) && (i_49_ == (client.anInt11154 * 1109726117) || ((Class618.method10118((class647_sub1_sub3_sub1_sub2.username), -97380228)) == (-1918195571 * (class250.anInt2584))))) {
											class167 = (class250.method4434(Class31.aClass178_303, i_47_, Class80.aClass53_Sub17_866, (Class448.aClass53_Sub6_4945), (Class174.aClass53_Sub7_1856), (Class523_Sub37.aClass53_Sub8_10677), (Class248.aClass53_Sub13_2492), (Class98_Sub1_Sub2.playerVarsProvider), (Class98_Sub1_Sub2.playerVarsProvider), class250.aClass707_2693, (class647_sub1_sub3_sub1_sub2.aClass623_12183), 816252803));
											if (null == class167 && Class250.aBool2525)
												Class523_Sub14.method15991(class250, (byte) -19);
										}
									}
								} else if (5 == (-428962391 * class250.anInt2570)) {
								...
								} else if (8 == -428962391 * class250.anInt2570 || (class250.anInt2570 * -428962391 == 9)) {
									ItemsContainer class523_sub1 = Class72.method1507((-2080195333 * (class250.anInt2571)), false, -768489515);
									if (null != class523_sub1)
										class167 = (class523_sub1.method15827(Class31.aClass178_303, i_47_, class250.aClass707_2693, (-1918195571 * class250.anInt2584), (class250.anInt2570 * -428962391) == 9, (class250.aBool2655 ? (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aClass623_12183) : null), 1829289465));
								} else if (null == class250.aClass707_2693 || !class250.aClass707_2693.method14161(-1001128291)) {
									class167 = (class250.method4434(Class31.aClass178_303, i_47_, Class80.aClass53_Sub17_866, Class448.aClass53_Sub6_4945, Class174.aClass53_Sub7_1856, Class523_Sub37.aClass53_Sub8_10677, Class248.aClass53_Sub13_2492, Class98_Sub1_Sub2.playerVarsProvider, Class98_Sub1_Sub2.playerVarsProvider, null, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aClass623_12183), 816252803));
									if (null == class167 && Class250.aBool2525)
										Class523_Sub14.method15991(class250, (byte) -112);
								} else {
									class167 = (class250.method4434(Class31.aClass178_303, i_47_, Class80.aClass53_Sub17_866, Class448.aClass53_Sub6_4945, Class174.aClass53_Sub7_1856, Class523_Sub37.aClass53_Sub8_10677, Class248.aClass53_Sub13_2492, Class98_Sub1_Sub2.playerVarsProvider, Class98_Sub1_Sub2.playerVarsProvider, class250.aClass707_2693, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aClass623_12183), 816252803));
									if (null == class167 && Class250.aBool2525)
										Class523_Sub14.method15991(class250, (byte) -36);
								}
								if (class167 != null) {
									...
									class250.method4435(Class31.aClass178_303, class167, client.aClass435_11006, client.anInt11011, (byte) -28);
									Class31.aClass178_303.method3067();
							...
							} else if (9 == 36473529 * class250.anInt2534) {
								int i_61_;
								int i_62_;
								int i_63_;
								int i_64_;
