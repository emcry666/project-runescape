	...
	static final void method13724(byte i) {
		...
		for (Class523_Sub27_Sub7 class523_sub27_sub7 = Class174.method2939((byte) -98); class523_sub27_sub7 != null; class523_sub27_sub7 = Class174.method2939((byte) -125)) {
			...
			if (1 == i_12_) {
				...
				Class250 class250 = Class188.method3592((int) l, -1971768723);
				if (!class523_sub27_sub7.aString11650.equals(class250.aString2607)) {
					class250.aString2607 = class523_sub27_sub7.aString11650;
					Class523_Sub14.method15991(class250, (byte) -120);
				}
			} else if (23 == i_12_) {
				Class250 class250 = Class188.method3592((int) l, -779142031);
				...
				Class250 class250 = Class188.method3592((int) l, -1838271413);
				...
				if (i_13_ != class250.anInt2570 * -428962391 || class250.anInt2571 * -2080195333 != i_14_ || i_15_ != -1918195571 * class250.anInt2584) {
					class250.anInt2570 = i_13_ * -182688103;
					class250.anInt2571 = i_14_ * 903474739;
					class250.anInt2584 = -1367647675 * i_15_;
					class250.aClass302_2553 = null;
					Class523_Sub14.method15991(class250, (byte) -86);
				}
			} else if (i_12_ == 5) {
				Class250 class250 = Class188.method3592((int) l, -1081840847);
				if (class250.anInt2548 * -339807053 != 1313066817 * class523_sub27_sub7.anInt11653) {
					...
					Class523_Sub14.method15991(class250, (byte) -127);
				}
			} else if (6 == i_12_) {
				...
				if ((1313066817 * class523_sub27_sub7.anInt11653 != 175466669 * class250.anInt2563) || (-2058422725 * class523_sub27_sub7.anInt11649 != class250.anInt2577 * 1376491541) || (-628044223 * class523_sub27_sub7.anInt11665 != class250.anInt2544 * -1904547845)) {
					...
					Class523_Sub14.method15991(class250, (byte) -124);
				}
			} else if (9 == i_12_) {
				Class250 class250 = Class188.method3592((int) l, -2020996534);
				if ((class523_sub27_sub7.anInt11653 * 1313066817 != class250.anInt2680 * -1878986101) || (class523_sub27_sub7.anInt11649 * -2058422725 != class250.anInt2681 * -1263698325)) {
					...
					Class523_Sub14.method15991(class250, (byte) -66);
				}
			} else if (i_12_ == 10) {
				Class250 class250 = Class188.method3592((int) l, -579484377);
				if ((1313066817 * class523_sub27_sub7.anInt11653 != 1419153773 * class250.anInt2523) || (-2058422725 * class523_sub27_sub7.anInt11649 != class250.anInt2501 * 2014714437) || (-628044223 * class523_sub27_sub7.anInt11665 != class250.anInt2578 * 533045263)) {
					...
					Class523_Sub14.method15991(class250, (byte) -2);
				}
			} else if (i_12_ == 11) {
				Class250 class250 = Class188.method3592((int) l, -1327756525);
				...
				Class250 class250 = Class188.method3592((int) l, -604129951);
				int i_21_ = class523_sub27_sub7.anInt11653 * 1313066817;
				if (class250 != null && 0 == class250.anInt2534 * 36473529) {
					...
					if (i_21_ != -1013149031 * class250.anInt2539) {
						...
						Class523_Sub14.method15991(class250, (byte) -108);
					}
				}
			} else if (i_12_ == 13) {
				Class250 class250 = Class188.method3592((int) l, -1181721474);
				...
				Class250 class250 = Class188.method3592((int) l, -1197626255);
				class250.anInt2605 = class523_sub27_sub7.anInt11653 * 559325301;
			} else if (21 == i_12_) {
				Class250 class250 = Class188.method3592((int) l, -1305176550);
				class250.aBool2606 = 1313066817 * class523_sub27_sub7.anInt11653 == 1;
			} else if (i_12_ == 22) {
				Class250 class250 = Class188.method3592((int) l, -1203457091);
				class250.aBool2569 = 1 == 1313066817 * class523_sub27_sub7.anInt11653;
			} else if (17 == i_12_) {
				Class250 class250 = Class188.method3592((int) l, -598338624);
				int i_22_ = (int) (l >> 32);
				...
				Class250 class250 = Class188.method3592((int) l, -867204997);
				int i_23_ = (int) (l >> 32);
