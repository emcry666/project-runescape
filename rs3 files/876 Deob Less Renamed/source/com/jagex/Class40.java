...
public class Class40 {
			...
			if (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453 == class647_sub1_sub3_sub1_sub2) {
				...
				if (0 == -476056167 * class647_sub1_sub3_sub1_sub2.anInt12189) {
					...
					if ((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12178 * 1202781135) != -1 && -1 != (1202781135 * class647_sub1_sub3_sub1_sub2.anInt12178)) {
						int i_1_ = (((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12178) * 1202781135 < (1202781135 * class647_sub1_sub3_sub1_sub2.anInt12178)) ? (1202781135 * (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12178)) : (1202781135 * class647_sub1_sub3_sub1_sub2.anInt12178));
						int i_2_ = ((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12186) * 1773490063 - (1773490063 * class647_sub1_sub3_sub1_sub2.anInt12186));
						if (i_2_ < 0)
							i_2_ = -i_2_;
						if (i_2_ > i_1_)
							bool_0_ = false;
					...
					if (class647_sub1_sub3_sub1_sub2.anInt12186 * 1773490063 >= 98635177 * class647_sub1_sub3_sub1_sub2.anInt12187)
						string = new StringBuilder().append(class647_sub1_sub3_sub1_sub2.method18682(true, 643273452)).append(bool_0_ ? (Class443.method7204((1773490063 * (class647_sub1_sub3_sub1_sub2.anInt12186)), (1773490063 * (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12186)), (byte) -20)) : Class495.method8101(16777215, -183316928)).append(Class31.aString297).append(string_3_).append(1773490063 * class647_sub1_sub3_sub1_sub2.anInt12186).append(Class31.aString295).toString();
					else
						string = new StringBuilder().append(class647_sub1_sub3_sub1_sub2.method18682(true, 1760675182)).append(bool_0_ ? (Class443.method7204((1773490063 * (class647_sub1_sub3_sub1_sub2.anInt12186)), (1773490063 * (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12186)), (byte) -38)) : Class495.method8101(16777215, 801853259)).append(Class31.aString297).append(string_3_).append(1773490063 * class647_sub1_sub3_sub1_sub2.anInt12186).append("+").append((98635177 * class647_sub1_sub3_sub1_sub2.anInt12187) - (class647_sub1_sub3_sub1_sub2.anInt12186 * 1773490063)).append(Class31.aString295).toString();
				...
				if (class647_sub1_sub3_sub1_sub2.aClass623_12183 != null && -1 != -1137516987 * (class647_sub1_sub3_sub1_sub2.aClass623_12183.anInt8106)) {
					...
					if (class300.aBool3308) {
						bool_4_ = true;
						string = ((NPCDefinition) (Class174.aClass53_Sub7_1856.getDefinition(-1137516987 * (class647_sub1_sub3_sub1_sub2.aClass623_12183.anInt8106), (byte) -46))).aString3314;
						if (0 != class300.anInt3295 * -380812719) {
							...
							string = new StringBuilder().append(string).append(Class443.method7204(class300.anInt3295 * -380812719, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anInt12186) * 1773490063, (byte) -42)).append(Class31.aString297).append(string_5_).append(class300.anInt3295 * -380812719).append(Class31.aString295).toString();
						}
					}
				}
	...
	static final void method1135(Class669 class669, int i) {
		Class309 class309 = (Class309) (class669.aClass523_Sub27_Sub19_8580.anObjectArray11845[1180759405 * class669.anInt8579]);
	...
	static final void method1137(Class250 class250, Class669 class669, byte i) {
		...
		if (6 != class250.anInt2570 * -428962391)
