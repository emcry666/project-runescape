...
public abstract class Class9 implements Interface5 {
	...
	public static int method593(byte i) {
		if (1546072167 * Archive.anInt629 == -1) {
			Archive[] class44s = Class88.getArchiveReferences(-1734020679);
			for (int i_48_ = 0; i_48_ < class44s.length; i_48_++) {
				Archive class44 = class44s[i_48_];
				if (-538819837 * class44.anInt664 > Archive.anInt629 * 1546072167)
					Archive.anInt629 = 329811717 * class44.anInt664;
			}
			Archive.anInt629 += 1489038167;
		}
		return 1546072167 * Archive.anInt629;
	}
}
