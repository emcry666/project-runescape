...
public class Class268 {
	...
	static void method4903(int i, int i_4_) {
		...
		try {
			if (i == 6)
				...
				Class572.aClass458_7684.method7459(952755890);
			else if (13 == i)
				...
				Class437 class437 = (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.method10569().aClass437_4862);
				Class485.method7932(new StringBuilder().append("").append(client.aClass505_11019.method8241((byte) -27).aClass142Array7509[(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821)].method2321((int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9, 1641882332)).toString(), (byte) -100);
			} else if (1 == i) {
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2521.method3780(30105747)).append(" ").append(Class250.aClass209_2521.method3774((short) 2487)).toString(), (byte) -109);
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2524.method3780(30105747)).append(" ").append(Class250.aClass209_2524.method3774((short) 19898)).toString(), (byte) -29);
			} else if (4 == i)
	...
	static int method4906(Class472 class472, Class656 class656, int i) {
		if (null != class472) {
