...
public class Class586 implements Interface13 {
	...
	public final Class586 method9693(Interface19 interface19, Interface17 interface17, int i) {
		...
		if (-1 != anInt7739 * 1968643165) {
			Class309 class309 = interface19.method106(1968643165 * anInt7739, -1577931439);
			if (class309 != null)
				i_0_ = interface17.method93(class309, 568995143);
		} else if (-1092754317 * anInt7740 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, anInt7740 * -1092754317, 1906673971);
			if (class159 != null)
	...
	void method9694(Class523_Sub34 class523_sub34, int i, byte i_3_) {
		if (i == 1)
	...
	public final Class586 method9705(Interface19 interface19, Interface17 interface17) {
		...
		if (null == interface19 || interface17 == null)
			return null;
		if (-1 != anInt7739 * 1968643165) {
			Class309 class309 = interface19.method106(1968643165 * anInt7739, 775461380);
			if (class309 != null)
				i = interface17.method93(class309, -1288547456);
		} else if (-1092754317 * anInt7740 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, anInt7740 * -1092754317, 1769413266);
			if (class159 != null)
	...
	public final Class586 method9706(Interface19 interface19, Interface17 interface17) {
		...
		if (null == interface19 || interface17 == null)
			return null;
		if (-1 != anInt7739 * 1968643165) {
			Class309 class309 = interface19.method106(1968643165 * anInt7739, 1108877823);
			if (class309 != null)
				i = interface17.method93(class309, 204764981);
		} else if (-1092754317 * anInt7740 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, anInt7740 * -1092754317, 1331086331);
			if (class159 != null)
	...
	void method9710(Class523_Sub34 class523_sub34, int i) {
		if (i == 1)
	...
	static final boolean method9714(Class116 class116, short i) {
		boolean bool;
		try {
			...
			String string = new StringBuilder().append(class116.currentPacket != null ? 942758347 * class116.currentPacket.anInt4522 : -1).append(Class31.aString300).append(null != class116.aClass409_1430 ? class116.aClass409_1430.anInt4522 * 942758347 : -1).append(Class31.aString300).append(null != class116.aClass409_1426 ? class116.aClass409_1426.anInt4522 * 942758347 : -1).append(" ").append(class116.anInt1421 * -1372959327).append(Class31.aString300).append(235453015 * class592.localX + (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anIntArray11885[0])).append(Class31.aString300).append((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.anIntArray11943[0]) + 1704054549 * class592.localY).append(" ").toString();
			for (int i_19_ = 0; i_19_ < class116.anInt1421 * -1372959327 && i_19_ < 50; i_19_++)
				string = new StringBuilder().append(string).append(class116.aClass523_Sub34_Sub2_1431.aByteArray10658[i_19_]).append(Class31.aString300).toString();
