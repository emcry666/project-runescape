...
public class Class463 {
	...
	Class463(Class523_Sub34 class523_sub34, BigInteger biginteger, BigInteger biginteger_0_) {
		class523_sub34.anInt10661 = 948828615;
		int i = class523_sub34.readUnsignedByte(-5244777);
		class523_sub34.anInt10661 += -1998611344 * i;
		byte[] is = new byte[(class523_sub34.aByteArray10658.length - class523_sub34.anInt10661 * 2349011)];
		class523_sub34.method16298(is, 0, is.length, (byte) -15);
		byte[] is_1_;
...
//		}
		...
		for (int i_6_ = 0; i_6_ < i; i_6_++) {
			class523_sub34.anInt10661 = -1998611344 * i_6_ + 1138594338;
			...
			class523_sub34.method16298(is_11_, 0, 64, (byte) -10);
	...
	static final void method7520(Class250 class250, Class242 class242, Class669 class669, int i) {
		...
		if (i_12_ >= 0 && i_12_ < 5) {
			...
			Class523_Sub14.method15991(class250, (byte) -100);
			if (-1 == class250.anInt2709 * 234012635 && !class242.aBool2456)
				Class104.method1858(-1363815505 * class250.anInt2585, i_12_, (byte) -66);
		}
	}

	static final void method7521(Class669 class669, byte i) {
		class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.method18399((byte) 1).method9786(2094060211);
	}
