...
public final class Inventory implements Serializable {
	...
	public void unlockInventory(boolean menu) {
		for (int i = 0; i < Utils.getInterfaceDefinitionsComponentsSize(menu ? INVENTORY_INTERFACE_2 : INVENTORY_INTERFACE); i++) {
			player.getPackets().sendIComponentSettings(menu ? INVENTORY_INTERFACE_2 : INVENTORY_INTERFACE, menu ? 15 : 34, -1, -1, 2097152);
			player.getPackets().sendIComponentSettings(menu ? INVENTORY_INTERFACE_2 : INVENTORY_INTERFACE, menu ? 15 : 34, 0, 27, 15302030);
