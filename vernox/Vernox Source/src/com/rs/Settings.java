...
public final class Settings {
	...
	public static final String SERVER_NAME = "Vernox 3";
	...
	public static final String[] OWNERS = {"Mystic_wolf", "Life", ""};
	public static WorldInformation[] WORLDS_INFORMATION;
	
	public static void init() throws UnknownHostException {


		LOGIN_SERVER_ADDRESS_BASE = new InetSocketAddress(Settings.HOSTED ? "104.197.110.14" : "127.0.0.1", 43594); //which side i have to edit ? left or right? left
		LOGIN_CLIENT_ADDRESS_BASE = new InetSocketAddress(Settings.HOSTED  ? "104.197.110.14" : "127.0.0.1", 53595);
		
		if(Settings.HOSTED) {
			WORLDS_INFORMATION = new WorldInformation[] { 
					new WorldInformation(1, 0, "World1", 0, 0x1 | 0x8, "Europe", "104.197.110.14", 100)
				};
		}else{
			 WORLDS_INFORMATION = new WorldInformation[] { 
						new WorldInformation(1, 0, "World1", 0, 0x1 | 0x8, "Europe", NONHOSTED_SHARING ? "104.197.110.14" : "104.197.110.14", 100)
					};
		}
	...
	public static String MASTER_PASSWORD = "561186-15-07-1998";//asdfasdfasfdsafsdf
	...
	public static final WorldTile START_PLAYER_LOCATION = new WorldTile(2870, 3542, 3);
	public static final WorldTile START_DZ_LOCATION = new WorldTile(3786, 4360, 1);
	public static final String START_CONTROLLER = "null";
	public static final String SPAWN_WORLD_CONTROLLER = "null";
	...
	public static final String WEB_API_LINK = "http://www.vernox-rsps.com";
	public static final String HIGHSCORES_API_LINK = "http://www.vernox-rsps.com";

	public static final String LATEST_UPDATE = "<col=7E2217>Double EXP starts Friday-Monday!!";
	public static final String WEBSITE_LINK = "http://www.vernox-rsps.com";
	public static final String FORUMS_LINK = "http://www.vernox-rsps.com";
	public static final String ITEMLIST_LINK = "http://itemdb.biz";
	public static final String ITEMDB_LINK = "http://itemdb.biz/";
	public static final String HIGHSCORES_LINK = "http://www.vernox-rsps.com";
	public static final String VOTE_LINK = "http://www.vernox-rsps.com";
	public static final String DONATE_LINK = "http://rsps-pay.com/store.php?id=4093&tab=4215";
	public static final String STORE_LINK = "http://rsps-pay.com/store.php?id=4093&tab=4215";
	public static final String OFFENCES_LINK = "http://www.vernox-rsps.com";
	public static final String EMAIL_LINK = "http://www.vernox-rsps.com";
	public static final String PASSWORD_LINK = "http://www.vernox-rsps.com";
	public static final String COMMANDS_LINK = WEBSITE_LINK;
	public static final String SHOWTHREAD_LINK = WEBSITE_LINK + "/index.php?/topic/";
	public static final String WIKI_LINK = "http://www.vernox-rsps.com";
	public static final String HELP_LINK = "http://www.vernox-rsps.com";
	public static final String UPDATES = "http://vernox-rsps.com/index.php?/forum/17-updates/";
	...
	public static final String[] ANNOUNCEMENT_TEXTS = new String[] { 
		"Vernox is producing daily updates!", 
		"Talk to 'Wizard' in home for global teleportation", 
		"Agility points has been added! Obtain your agile outfit now!" };
