...
public class ButtonHandler {
	...
	if (interfaceId == 1477) { // gamescreen rs3
	...
	} else if (interfaceId == 216 || interfaceId == 668 || interfaceId == 737 || interfaceId == 1262
		...
		else if (componentId >= 140 && componentId <= 204) {
		int tabId = ((componentId - 84) / 8) - 7;
		if (packetId == WorldPacketsDecoder.ACTION_BUTTON1_PACKET)
	...
	if (itemId == 18337 || itemId == 19675 || itemId == 27996) {
	    player.getPackets().sendGameMessage("You can't wear that.");
	    return false;
	}
