...
public class WarriorsGuild extends Controller {
	...
	public void sendInterfaces() {
		...
		player.getInterfaceManager().sendWGuildInter(player);
	}
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						if (defensiveStyle == timer.projectileType) {
							...
							player.setwPoints(player.getWPoints() + 5);
...
/*		player.getInterfaceManager().closeTaskSystem();
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (ticks == 3) {
					...
					player.setwPoints(player.getWPoints() - base + Utils.random(2));
	...
	private void loseBalance() {
		...
		if (kegCount != 1) {
			...
			player.setwPoints(player.getWPoints() + (10 * kegCount) + (kegTicks / 2));
		}
		resetKegBalance();
	}
