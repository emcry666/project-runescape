...
public abstract class Dialogue {
	...
	public static final int OPTION_1 = 3, OPTION_2 = 4, OPTION_3 = 5, OPTION_4 = 6, OPTION_5 = 7, OPTION_6 = 8;

	public boolean sendOptionsDialogue(String title, String... options) {
		if (options.length > 6) {
			throw new InvalidParameterException("The max options length is 6.");
		}
		String[] newopts = new String[6];
		for (int i = 0; i < 6; i++)
			newopts[i] = "";
		int ptr = 0;
