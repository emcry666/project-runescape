...
public class TeleportCrystal extends Dialogue {
	...
	@Override
	public void start() {
		sendDialogue("Hello, I can teleport you around Vernox."
		...
		public void run(int interfaceId, int componentId) {
			...
			else if (stage == 3)
			{
				...
				{
					sendOptionsDialogue("Training Areas", "Trolls");
					stage = 30;
				}
			}
			else if (stage == 4)
			{
				...
				{
					sendOptionsDialogue("Mining areas", "Varrock mine", "Al-kharid mine", "Dwarven mine");
					stage = 9;
				}
				else if (componentId == OPTION_3)
				{
				...
				{
					sendOptionsDialogue("Skilling Teleports", "Dungeoneering", "Divination", "Farming");
					stage = 12;
				}
			}
			else if (stage == 5)
			...
			else if (stage == 27)//slayer masters
			{
				...
				{
					Magic.sendLunarTeleportSpell(player, 0, 0.0D, new WorldTile(3351, 3003, 1));
				}
				else if (componentId == OPTION_3)
				{
			...
			else if (stage == 31)
			{
				...
				else if (stage == 33)
				{
				  ...
				  if (componentId == OPTION_2)
					    {
						sendOptionsDialogue("Slayer Tower");
						    stage = 35;
					    }
					   }
					    else if (stage == 35)//slayertower
						{
						    if (componentId == OPTION_1)
						    {
