...
import com.rs.game.player.controllers.bossInstance.AraxxiInstanceController;
...
public class ControlerHandler {
	...
	public static final void init() {
		try {
			...
			handledControlers.put("VoragoController", VoragoController.class);
			handledControlers.put("AraxxiInstanceController", AraxxiInstanceController.class);
