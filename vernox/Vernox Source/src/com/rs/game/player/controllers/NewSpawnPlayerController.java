...
public class NewSpawnPlayerController extends Controller {
	...
	public void sendInterfaces() {
		...
		if (stage == 2) {
			...
			player.getPackets().sendIComponentText(372, 2, "Wizard Drakzis in this room .He is indicated by a flashing");
	...
	public void forceClose() {
		...
		player.getPackets().sendGameMessage("If you have questions, please talk to Wizard Drakzis.");
		if (Settings.HOSTED)
