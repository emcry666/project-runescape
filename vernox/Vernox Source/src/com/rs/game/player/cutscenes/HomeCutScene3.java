...
public class HomeCutScene3 extends Cutscene {
	...
	public CutsceneAction[] getActions(final Player player) {
		...
		actionsList.add(new NPCForceTalkAction(ADVERTISER, "Doesn't matter! My job is to introduce new players to Wizard Drakzis.", 10));
		...
		actionsList.add(new CreateNPCAction(ORACLE, 15158, 3126, 3710, 0, "Wizard Drakzis", 0, -1));
