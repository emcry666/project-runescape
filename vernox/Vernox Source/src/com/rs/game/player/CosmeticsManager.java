...
public class CosmeticsManager implements Serializable {
	...
	public void handleButtons(int componentId, int slotId, int slotId2, int packetId) {
		if(componentId == 669) {
		...
		else if (componentId == 678) {
		    if (player.isDonor == true || player.isExtrDonor == true || player.getRights() > 1)
		    {
			...
			player.getPackets().sendGameMessage("<img=9><col=009fff>You need to be a donator to use this");
		    }
		}else{
