...
public class Fishing extends Action {
	...
	LURE2(329, 1, 309, 314, new Animation(622), Fish.TROUT,
			Fish.SALMON), 
	...
	HARPOON(312, 2, 311, -1, new Animation(618),
	...
	BIG_NET2(326, 1, 305, -1, new Animation(620), Fish.MONKFISH),


	HARPOON2(313, 2, 311, -1, new Animation(618), Fish.TUNA, Fish.SWORDFISH, Fish.SHARK),
	HARPOON3(334, 2, 311, -1, new Animation(618), Fish.SHARK),
