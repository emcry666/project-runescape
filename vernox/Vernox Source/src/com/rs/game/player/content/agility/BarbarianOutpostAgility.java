		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				...
				if (stage == 3)
					...
					player.setAgilityPoints(player.getAgilityPoints() + 1);
					player.getPackets().sendGameMessage("<col=ff8c38>You received 1 agility point, you now have "+player.getAgilityPoints()+ " agility points");
				}
			}
