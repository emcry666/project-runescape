...
public class Summoning extends Action {
    ...
    public enum Pouch {
        ...
        SPIRIT_WOLF(1, 100.8, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 7), new Item(2859, 1)}, 12047, 360000, 1),

        DREADFOWL(4, 120.3, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 8), new Item(2138, 1)}, 12043, 240000, 1),

        SPIRIT_SPIDER(10, 125.6, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 8), new Item(6291, 1)}, 12059, 900000, 2),

        THORNY_SNAIL(13, 130.6, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 9), new Item(3363, 1)}, 12019, 960000, 2),

        GRANITE_CRAB(16, 135.6, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 7), new Item(440, 1)}, 12009, 1080000, 2),

        SPIRIT_MOSQUITO(17, 140.5, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 1), new Item(6319, 1)}, 12778, 720000, 2), // gfx 1440

        DESERT_WYRM(18, 145.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 45), new Item(1783, 1)}, 12049, 1140000, 1),

        SPIRIT_SCORPIAN(19, 150.2, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 57), new Item(3095, 1)}, 12055, 1020000, 2),

        SPIRIT_TZ_KIH(22, 155.8, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 64), new Item(12168, 1)}, 12808, 1080000, 3),

        ALBINO_RAT(23, 158.4, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 75), new Item(2134, 1)}, 12067, 1320000, 3),

        SPIRIT_KALPHITE(25, 165, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 51), new Item(3138, 1)}, 12063, 1320000, 3),

        COMPOST_MOUNT(28, 168.8, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 47), new Item(6032, 1)}, 12091, 1440000, 6),

        GIANT_CHINCHOMPA(29, 170, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 84), new Item(9976, 1)}, 12800, 1860000, 1),

        VAMPYRE_BAT(31, 171, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 81), new Item(3325, 1)}, 12053, 1980000, 4),

        HONEY_BADGER(32, 172.8, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 84), new Item(12156, 1)}, 12065, 1500000, 4),

        BEAVER(33, 172.6, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 72), new Item(1519, 1)}, 12021, 1620000, 4),

        VOID_RAVAGER(34, 190.6, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 74), new Item(12164, 1)}, 12818, 1620000, 4),

        VOID_SPINNER(34, 190.6, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 74), new Item(12165, 1)}, 12780, 1620000, 4),

        VOID_TORCHER(34, 190.6, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 74), new Item(12166, 1)}, 12798, 5640000, 4),

        VOID_SHIFTER(34, 190.6, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 74), new Item(12167, 1)}, 12814, 5640000, 4),

        BRONZE_MINOTAUR(36, 200.8, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 102), new Item(2349, 1)}, 12073, 1800000, 9),

        BULL_ANT(40, 200.8, new Item[]{new Item(GOLD), new Item(POUCH), new Item(SHARDS, 11), new Item(6010, 1)}, 12087, 1800000, 5),

        MACAW(41, 202.4, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 78), new Item(249, 1)}, 12071, 1860000, 5),

        EVIL_TURNIP(42, 203.8, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 104), new Item(12153, 1)}, 12051, 1800000, 5),

        SPIRIT_COCKATRICE(43, 202.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12654, 1)}, 12095, 2160000, 5),

        SPIRIT_GUTHATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12111, 1)}, 12097, 2160000, 5),

        SPIRIT_SARATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12113, 1)}, 12099, 2160000, 5),

        SPIRIT_ZAMATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12115, 1)}, 12101, 2160000, 5),

        SPIRIT_PENGATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12117, 1)}, 12103, 2160000, 5),

        SPIRIT_CORAXATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12119, 1)}, 12105, 2160000, 5),

        SPIRIT_VULATRICE(43, 204.2, new Item[]{new Item(GREEN), new Item(POUCH), new Item(SHARDS, 88), new Item(12121, 1)}, 12107, 2160000, 5),

        IRON_MINOTAUR(46, 304.8, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 125), new Item(2351, 1)}, 12075, 2220000, 9),
        ...
        STEEL_MINOTAUR(56, 401.8, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 141), new Item(2353, 1)}, 12077, 2760000, 9),
        ...
        RUNE_MINOTAUR(86, 666.8, new Item[]{new Item(BLUE), new Item(POUCH), new Item(SHARDS, 1), new Item(2363)}, 12083, 9060000, 9),
        ...
        IRON_TITAN(95, 633.6, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 198), new Item(1115)}, 12822, 3600000, 10),

        PACK_YAK(96, 620.2, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 211), new Item(10818)}, 12093, 3480000, 10),

        STEEL_TITAN(99, 650.2, new Item[]{new Item(CRIMSON), new Item(POUCH), new Item(SHARDS, 178), new Item(1119)}, 12790, 3840000, 10),;
