...
public class Shop {
	...
	public int getSellPrice(Item item) {
		...
		switch(item.getId())
		{
			case 1637: //sapphire ring
			    item.getDefinitions().setValue(1000); // 12mill,, so price will be : 12mill * 30 /100 = 3,6m
			 break;
			...
			case 1391:
			    item.getDefinitions().setValue(3334);
			    break;
			case 10499:
			    item.getDefinitions().setValue(10000);
			    //armours
			case 11818:
			    item.getDefinitions().setValue(1225);
			    break;
			case 11822:
			    item.getDefinitions().setValue(2000);
			    break;
			case 11826:
			    item.getDefinitions().setValue(3525);
			    break;
			case 11830:
			    item.getDefinitions().setValue(5275);
			    break;
			case 11834:
			    item.getDefinitions().setValue(10000);
			    break;
