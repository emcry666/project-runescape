	...
	public void removeHitpoints(final Hit hit) {
		...
		if (hitpoints <= 0)
			...
			Player player = (Player) this;
		    	int percentage = (int)(player.getMaxHitpoints() / 100) * 10;
			...
			if (player.getEquipment().getAmuletId() != 11090 && player.getEquipment().getRingId() == 2570)
			{
			    int hp = player.getMaxHitpoints() / 10;
			    if (player.getHitpoints() <= player.getMaxHitpoints() / 10)
			    {
