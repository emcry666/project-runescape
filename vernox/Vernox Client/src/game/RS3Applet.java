...
public class RS3Applet extends Applet implements AppletStub {
	...
	public static String LOBBY_ADDR = "104.197.110.14";
	/**
	 * Address of lobby server.
	 */
	public static String WEB_STREAM_ADDR = "104.197.110.14";
	/**
	 * Chooses the Host
	 */
	public static String WORLD_HOST = !MODS ? "http://world58a.runescape.com" : "http://104.197.110.14";
	...
	private void openFrame() {
		clientFrame = new JFrame("Vernox RS3");
		clientFrame.add(this);
		clientFrame.setVisible(true);
		clientFrame.setSize(820, 620);
		clientFrame.setMinimumSize(new Dimension(820, 620));
	}
