...
public final class IDirect3DDevice extends IUnknown {
	...
	public static int method15722(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15723(long l, int i, boolean bool) {
	...
	public static int method15724(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15725(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15726(long l, int i, float f) {
		return SetRenderStatef(l, i, f);
	}

	public static int method15727(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}

	public static int method15728(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}

	public static int method15729(long l, int i, boolean bool) {
		return SetRenderStateb(l, i, bool);
	}
}
