...
public class Class298_Sub1 extends Class298 {
	...
	public void method15547(Class523_Sub34 class523_sub34, int i) {
		int i_0_ = class523_sub34.anInt10661 * 2349011;
		...
		if (class523_sub34.anInt10661 * 2349011 - i_0_ != i)
			throw new RuntimeException(new StringBuilder().append(class523_sub34.anInt10661 * 2349011 - i_0_).append(",").append(i).toString());
	}
	...
	public void method15549(Class523_Sub34 class523_sub34, int i, byte i_8_) {
		int i_9_ = class523_sub34.anInt10661 * 2349011;
		...
		if (aClass328_3200 != null && 1 == (i_10_ >> 6 & 0x1))
			aClass328_3200.method5760(class523_sub34, -406957251);
		if (class523_sub34.anInt10661 * 2349011 - i_9_ != i)
			throw new RuntimeException(new StringBuilder().append(class523_sub34.anInt10661 * 2349011 - i_9_).append(",").append(i).toString());
	}
	...
	public void method15552(Class523_Sub34 class523_sub34, int i) {
		int i_17_ = class523_sub34.anInt10661 * 2349011;
		...
		if (aClass328_3200 != null && 1 == (i_18_ >> 6 & 0x1))
			aClass328_3200.method5760(class523_sub34, -406957251);
		if (class523_sub34.anInt10661 * 2349011 - i_17_ != i)
			throw new RuntimeException(new StringBuilder().append(class523_sub34.anInt10661 * 2349011 - i_17_).append(",").append(i).toString());
	}
