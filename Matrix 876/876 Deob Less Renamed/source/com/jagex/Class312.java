...
public abstract class Class312 implements Interface33 {
	...
	public void method213(boolean bool, short i) {
		...
		if (Class248.method4401(1516375036) - 6564325488839177379L * aLong3388 > 10000L)
		...
		if (anInt3391 * -316203185 == i_10_ && i_10_ != 0) {
			...
			if (i_12_ > i_10_) {
				...
				if (l > 0L) {
					...
					long l_14_ = ((Class248.method4401(1516375036) - 6564325488839177379L * aLong3388) * 10000L);
					if (l_14_ < l_13_)
			...
			aLong3388 = Class248.method4401(1516375036) * 7926514305215045387L;
		}
		return i_11_;
	}
		...
		if (anInt3391 * -316203185 == i && i != 0) {
			...
			if (i_17_ > i) {
				...
				if (l > 0L) {
					...
					long l_19_ = ((Class248.method4401(1516375036) - 6564325488839177379L * aLong3388) * 10000L);
					if (l_19_ < l_18_)
		...
		if (anInt3391 * -316203185 == i && i != 0) {
			...
			if (i_23_ > i) {
				...
				if (l > 0L) {
					...
					long l_25_ = ((Class248.method4401(1516375036) - 6564325488839177379L * aLong3388) * 10000L);
					if (l_25_ < l_24_)
