...
public abstract class Class557 {
	...
	public abstract int method9201(byte[] is, int i, int i_3_, short i_4_) throws IOException;

	public abstract int method9202(int i) throws IOException;

	public abstract void method9203(int i);

	public abstract void method9204(int i);
	...
	public abstract void method9214(byte[] is, int i, int i_7_, byte i_8_) throws IOException;
	...
	public static Class557 method9219(Socket socket, int i) throws IOException {
