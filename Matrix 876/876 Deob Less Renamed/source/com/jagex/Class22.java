...
public class Class22 {
	...
	public static byte[] method819(byte[] is, int i, int i_0_) {
		...
		class22.method821(1124655573);
		class22.method822(is_1_, (long) (8 * i_0_));
		byte[] is_3_ = new byte[64];
		class22.method823(is_3_, 0, -1514814709);
		return is_3_;
	}
	...
	void method823(byte[] is, int i, int i_19_) {
