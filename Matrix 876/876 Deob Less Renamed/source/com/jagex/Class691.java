...
public class Class691 implements Interface75 {
	...
	static void method13961(Class250 class250, Class145 class145, int i, int i_0_, int i_1_, int i_2_, Class148 class148, double d, Class275 class275, Class273 class273, byte i_3_) {
		if (null != class148) {
			int i_4_;
	...
	static void method13962(int i, int i_12_) {
		...
		Class534_Sub1.anInt10779 = -465264525;
		Archive.method1233((byte) -102);
	}

	static final void method13963(Class523_Sub34_Sub2 class523_sub34_sub2, int i) {
		class523_sub34_sub2.method18223(972595080);
		int i_13_ = client.anInt11154 * 1109726117;
		Player class647_sub1_sub3_sub1_sub2 = (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453 = client.aClass647_Sub1_Sub3_Sub1_Sub2Array11153[i_13_] = (new Player(client.aClass505_11019.method8241((byte) -128))));
		...
		class647_sub1_sub3_sub1_sub2.anIntArray11885[0] = i_16_ - class592.localX * 235453015;
		class647_sub1_sub3_sub1_sub2.anIntArray11943[0] = i_17_ - class592.localY * 1704054549;
		...
		if (client.aClass505_11019.method8243(389074819).method7282(class647_sub1_sub3_sub1_sub2.anIntArray11885[0], class647_sub1_sub3_sub1_sub2.anIntArray11943[0], -638715901))
	...
	static final void method13964(int i, int i_23_, int i_24_, int i_25_, int i_26_, int i_27_, int i_28_) {
		...
		for (int i_31_ = 0; i_31_ < i_30_; i_31_++) {
			...
			if (4 == -1616721887 * client.anInt11071) {
				...
				if (class192.anInt2172 * -580266303 >= 0) {
					class300 = ((Class647_Sub1_Sub3_Sub1_Sub1) class647_sub1_sub3_sub1).aClass300_12175;
				...
				if (i_31_ < i_29_)
					...
					class647_sub1_sub3_sub1 = ((Class647_Sub1_Sub3_Sub1) (((Class523_Sub28) (client.aClass14_11047.method741((long) client.anIntArray11051[i_31_ - i_29_]))).anObject10554));
					class300 = ((Class647_Sub1_Sub3_Sub1_Sub1) class647_sub1_sub3_sub1).aClass300_12175;
				...
				if (-420874213 * class647_sub1_sub3_sub1.anInt11896 < 0 || ((1826923379 * class647_sub1_sub3_sub1.anInt11889 != -487274901 * client.anInt10981) && ((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821) != class647_sub1_sub3_sub1.aByte10821)))
					continue;
			}
			...
			if (!(client.aFloatArray11297[0] < 0.0F)) {
				...
				if (!class647_sub1_sub3_sub1.aBool11892 && !class647_sub1_sub3_sub1.aClass701_11920.method14083(983590184)) {
					for (Class522_Sub6 class522_sub6 = (Class522_Sub6) class647_sub1_sub3_sub1.aClass701_11920.method14087(1706431677); class522_sub6 != null; class522_sub6 = (Class522_Sub6) class647_sub1_sub3_sub1.aClass701_11920.method14088(1563898752)) {
						Class522_Sub1 class522_sub1 = class522_sub6.method15868(client.anInt11011, 16711935);
						if (null != class522_sub1) {
							...
							if (null != class148 && class148_33_ != null) {
								int i_34_ = 255;
								int i_35_ = -1;
								int i_36_ = (client.anInt11011 - (class522_sub1.anInt10291 * -1433551525));
				...
				if (!class647_sub1_sub3_sub1.aBool11892) {
					if (null == class300) {
						...
						int[] is_48_ = (null != (class647_sub1_sub3_sub1_sub1.aClass304_12167) ? (class647_sub1_sub3_sub1_sub1.aClass304_12167.anIntArray3345) : (class647_sub1_sub3_sub1_sub1.aClass300_12175.anIntArray3282));
						short[] is_49_ = (null != (class647_sub1_sub3_sub1_sub1.aClass304_12167) ? (class647_sub1_sub3_sub1_sub1.aClass304_12167.aShortArray3344) : (class647_sub1_sub3_sub1_sub1.aClass300_12175.aShortArray3283));
					...
					for (int i_54_ = 0; i_54_ < class111s.length; i_54_++) {
						...
						if (null != class111 && class111.anInt1334 * 239678453 == 1 && (client.anIntArray11051[i_31_ - i_29_] == 920515165 * class111.anInt1336)) {
							...
							if (0 == class111.anInt1343 * -1161226431)
								...
								bool_55_ = client.anInt11011 % (i_56_ * 2) < i_56_;
							}
							if (bool_55_)
				...
				for (/**/; (i_57_ < -113292831 * Class523_Sub11.aClass625_10427.anInt8133); i_57_++) {
					...
					if (i_58_ - i_60_ <= client.anInt11011) {
						if (null == class586)
							class647_sub1_sub3_sub1.anIntArray11905[i_57_] = -1;
						else {
							...
							if (client.aFloatArray11297[0] > -1.0F) {
								...
								int i_117_ = ((class647_sub1_sub3_sub1.anIntArray11905[i_57_]) - client.anInt11011);
		...
		for (int i_131_ = 0; i_131_ < -1661345859 * client.anInt11279; i_131_++) {
			...
			if (i_132_ < 2048)
				...
				class647_sub1_sub3_sub1 = ((Class647_Sub1_Sub3_Sub1) (((Class523_Sub28) client.aClass14_11047.method741((long) (i_132_ - 2048))).anObject10554));
			...
			if (i_133_ < 2048)
				...
				class647_sub1_sub3_sub1_134_ = ((Class647_Sub1_Sub3_Sub1) (((Class523_Sub28) client.aClass14_11047.method741((long) (i_133_ - 2048))).anObject10554));
