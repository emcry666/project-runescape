...
public class Class602 implements Interface13 {
	...
	public int method9889(int i, int i_0_) {
		if (aClass14_7923 == null)
			return i_0_;
		Class523_Sub24 class523_sub24 = (Class523_Sub24) aClass14_7923.method741((long) i);
	...
	public final Class602 method9893(Interface19 interface19, Interface17 interface17, int i) {
		...
		if (-1 != -1520549181 * anInt7914) {
			Class309 class309 = interface19.method106(-1520549181 * anInt7914, -814506691);
			if (class309 != null)
				i_8_ = interface17.method93(class309, 449210170);
		} else if (-612414895 * anInt7911 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, -612414895 * anInt7911, 1657625672);
			if (class159 != null)
	...
	void method9896(Class523_Sub34 class523_sub34, int i, int i_35_) {
		if (i == 1) {
	...
	public String method9898(int i, String string, int i_74_) {
		if (null == aClass14_7923)
			return string;
		Class523_Sub28 class523_sub28 = (Class523_Sub28) aClass14_7923.method741((long) i);
	...
	void method9905(Class523_Sub34 class523_sub34, int i) {
		if (i == 1) {
	...
	public final Class602 method9906(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != -1520549181 * anInt7914) {
			Class309 class309 = interface19.method106(-1520549181 * anInt7914, 288087293);
			if (class309 != null)
				i = interface17.method93(class309, 24013635);
		} else if (-612414895 * anInt7911 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, -612414895 * anInt7911, 2065079636);
			if (class159 != null)
	...
	void method9907(Class523_Sub34 class523_sub34, int i) {
		if (i == 1) {
	...
	public final Class602 method9920(Interface19 interface19, Interface17 interface17) {
		int i = -1;
		if (-1 != -1520549181 * anInt7914) {
			Class309 class309 = interface19.method106(-1520549181 * anInt7914, -111907057);
			if (class309 != null)
				i = interface17.method93(class309, 165285363);
		} else if (-612414895 * anInt7911 != -1) {
			Class159 class159 = interface19.method110(Class470.aClass470_5354, -612414895 * anInt7911, 1488339852);
			if (class159 != null)
	...
	void method9929(Class523_Sub34 class523_sub34, int i) {
		if (i == 1) {
	...
	static final void method9936(Class250 class250, Class242 class242, Class669 class669, short i) {
