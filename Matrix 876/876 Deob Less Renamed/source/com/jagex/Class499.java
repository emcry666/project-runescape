...
public class Class499 {
	public static void method8109(boolean bool) {
		...
		if (Class474.method7761(-2020118759 * client.anInt11136, (byte) 92)) {
			...
			for (int i = 0; i < class116s.length; i++) {
				...
				if (!class116.aBool1432 && class116.method1979(782493095) != null) {
	...
	static final void method8111(Class250 class250, Class242 class242, Class669 class669, int i) {
	...
	static int method8112(int i) {
		if (null == client.aClass250_11197) {
			if (!Class36.aBool326) {
				...
				if (!Class36.aBool327) {
					if (i_0_ > Class22.anInt231 * -1744502791 && i_0_ < (-1744502791 * Class22.anInt231 + Class474.anInt5390 * -345535891)) {
						int i_2_ = -1;
				...
				} else if (i_0_ > -1744502791 * Class22.anInt231 && i_0_ < (Class474.anInt5390 * -345535891 + Class22.anInt231 * -1744502791)) {
					int i_7_ = -1;
