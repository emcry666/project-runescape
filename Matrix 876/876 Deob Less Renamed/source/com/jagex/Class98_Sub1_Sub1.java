...
public class Class98_Sub1_Sub1 extends Class98_Sub1 implements Interface12 {
	...
	Class159_Sub2 method17699(int i) {
		byte[] is = aClass472_11323.method7688((aClass470_8890.method7626((byte) -88).anInt8501) * 1688317219, i, 92647414);
		Class159_Sub2 class159_sub2 = new Class159_Sub2(aClass470_8890, i);
		if (is != null)
			class159_sub2.method80(new Class523_Sub34(is), 2059438270);
	...
	Class159_Sub2 method17701(int i, byte i_0_) {
		byte[] is = aClass472_11323.method7688((aClass470_8890.method7626((byte) -2).anInt8501) * 1688317219, i, 396570359);
		Class159_Sub2 class159_sub2 = new Class159_Sub2(aClass470_8890, i);
		if (is != null)
			class159_sub2.method80(new Class523_Sub34(is), 2132721228);
		return class159_sub2;
	}
	...
	Class159_Sub2 method17705(int i) {
		byte[] is = aClass472_11323.method7688((aClass470_8890.method7626((byte) 42).anInt8501) * 1688317219, i, -2096147457);
		Class159_Sub2 class159_sub2 = new Class159_Sub2(aClass470_8890, i);
		if (is != null)
			class159_sub2.method80(new Class523_Sub34(is), 2110329708);
		return class159_sub2;
	}

	Class159_Sub2 method17706(int i) {
		byte[] is = aClass472_11323.method7688((aClass470_8890.method7626((byte) 63).anInt8501) * 1688317219, i, -1340851877);
		Class159_Sub2 class159_sub2 = new Class159_Sub2(aClass470_8890, i);
		if (is != null)
			class159_sub2.method80(new Class523_Sub34(is), 2132543202);
		return class159_sub2;
	}

	public Class98_Sub1_Sub1(Class681 class681, Class470 class470, Class668 class668, Class472 class472) {
		super(class681, class470, class668, (class472 != null ? class472.method7702((class470.method7626((byte) -65).anInt8501 * 1688317219), (byte) -49) : 0));
