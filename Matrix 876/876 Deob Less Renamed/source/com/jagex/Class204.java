...
public class Class204 {
	...
	Class204(Class523_Sub34 class523_sub34) {
	...
	public static void method3709(Class250[] class250s, int i) {
		for (int i_5_ = 0; i_5_ < class250s.length; i_5_++) {
			Class250 class250 = class250s[i_5_];
	...
	static void method3712(Class116 class116, int i) {
