...
public class Class53_Sub16 extends Class53 {
	public Class53_Sub16(Class681 class681, Class668 class668, Class472 class472) {
		super(class681, class668, class472, Class656.aClass656_8431, 128, new Class68(com.jagex.Class37.class));
	}

	static void method17217(int i, int i_0_, int i_1_) {
		Class309 class309 = (Class309) Class539.aClass53_Sub3_7213.getDefinition(i, (byte) -69);
