...
public class Class520 {
	...
	static final void method8643(Class250 class250, Class669 class669, int i) {
	...
	static final void method8645(Class669 class669, int i) {
		...
		if (-1 == i_7_)
			throw new RuntimeException();
		Class37 class37 = (Class37) Class394.aClass53_Sub16_4056.getDefinition(i_7_, (byte) -3);
		if (class37.aClass464_367.method82() != i_6_)
			throw new RuntimeException();
	...
	static final void method8646(Class669 class669, int i) {
		...
		Class250 class250 = Class188.method3592(i_9_, -1383729780);
