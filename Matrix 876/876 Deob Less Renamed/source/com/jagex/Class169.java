...
public class Class169 {
	...
	Class169(byte[] is, Class523_Sub15 class523_sub15) {
		...
		try {
			...
			Class523_Sub34 class523_sub34_0_ = new Class523_Sub34(is);
			int i = class523_sub34.readUnsignedByte(-607798955);
			class523_sub34.anInt10661 += 379531446;
			int i_1_ = class523_sub34.readUnsignedShort(-1421573098);
			int i_2_ = 0;
			int i_3_ = -1;
			int i_4_ = -1;
			class523_sub34_0_.anInt10661 = (class523_sub34.anInt10661 * 2349011 + i_1_) * 189765723;
			...
			if (class523_sub34_0_.anInt10661 * 2349011 != is.length)
