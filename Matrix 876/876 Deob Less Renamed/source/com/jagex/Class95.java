...
public class Class95 {
	...
	static boolean method1731() {
		if (Class656.method10755(-2020118759 * client.anInt11136, 2005224112))
			return false;
		return true;
	}
		...
		if (strings.length > 1) {
			for (int i = 0; i < strings.length; i++) {
				if (strings[i].startsWith("pause")) {
					...
					Class687_Sub24.aLong10885 = (Class248.method4401(1516375036) + (long) (i_16_ * 1000)) * 1332324763258881553L;
					break;
				}
	...
	static void method1738() {
		if (-15297265 * anInt1162 < 102)
			anInt1162 += 263347098;
		if (-1 != anInt1176 * 1006265677 && (7528894964442540785L * Class687_Sub24.aLong10885 < Class248.method4401(1516375036))) {
			for (int i = 1006265677 * anInt1176; i < Class53_Sub6.aStringArray10968.length; i++) {
				if (Class53_Sub6.aStringArray10968[i].startsWith("pause")) {
					...
					Class687_Sub24.aLong10885 = (Class248.method4401(1516375036) + (long) (1000 * i_17_)) * 1332324763258881553L;
					return;
				}
		...
		for (int i = 0; i < -1614747943 * client.anInt11030; i++) {
			...
			if (i_18_ == 80)
				...
				if (Class557.aClipboard7479 != null) {
					String string = "";
					...
					Class557.aClipboard7479.setContents(new StringSelection(string), null);
				}
		...
		if (-1 != anInt1176 * 1006265677 && (7528894964442540785L * Class687_Sub24.aLong10885 < Class248.method4401(1516375036))) {
			for (int i = 1006265677 * anInt1176; i < Class53_Sub6.aStringArray10968.length; i++) {
				if (Class53_Sub6.aStringArray10968[i].startsWith("pause")) {
					...
					anInt1176 = (1 + i) * -1190962299;
					Class687_Sub24.aLong10885 = (Class248.method4401(1516375036) + (long) (1000 * i_24_)) * 1332324763258881553L;
					return;
				}
				aString1171 = Class53_Sub6.aStringArray10968[i];
				Class628.method10314(false, (byte) -1);
		...
		if (-1 != anInt1176 * 1006265677 && (7528894964442540785L * Class687_Sub24.aLong10885 < Class248.method4401(1516375036))) {
			for (int i = 1006265677 * anInt1176; i < Class53_Sub6.aStringArray10968.length; i++) {
				if (Class53_Sub6.aStringArray10968[i].startsWith("pause")) {
					...
					anInt1176 = (1 + i) * -1190962299;
					Class687_Sub24.aLong10885 = (Class248.method4401(1516375036) + (long) (1000 * i_31_)) * 1332324763258881553L;
					return;
				}
				aString1171 = Class53_Sub6.aStringArray10968[i];
				Class628.method10314(false, (byte) -1);
			...
			try {
				if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
					...
					if (2 == Class562.anInt7564 * 2097396553) {
						...
						Class485.method7932(new StringBuilder().append("Pos: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 796895371)) + (int) class437.aFloat4904).toString(), (byte) -53);
						Class485.method7932(new StringBuilder().append("Look: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437_41_.aFloat4903 >> 9, (int) class437_41_.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437_41_.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 746616669)) + (int) class437.aFloat4904).toString(), (byte) -50);
					} else {
						Class485.method7932(new StringBuilder().append("Pos: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append(((760427037 * Class77.anInt858 >> 9) + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + (-1221225203 * Class497.anInt5563 >> 9)) >> 6).append(",").append((class592.localX * 235453015 + (760427037 * Class77.anInt858 >> 9)) & 0x3f).append(",").append(((-1221225203 * Class497.anInt5563 >> 9) + class592.localY * 1704054549) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(760427037 * Class77.anInt858, -1221225203 * Class497.anInt5563, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 1821980115)) - Class285.anInt3085 * 805779207).toString(), (byte) -24);
						Class485.method7932(new StringBuilder().append("Look: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append((-1744666137 * Class602.anInt7934 + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + Class42.anInt564 * -479513739) >> 6).append(",").append((class592.localX * 235453015 + -1744666137 * Class602.anInt7934) & 0x3f).append(",").append((class592.localY * 1704054549 + Class42.anInt564 * -479513739) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(-1744666137 * Class602.anInt7934, -479513739 * Class42.anInt564, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 890548620)) - Class290.anInt3146 * 1734327845).toString(), (byte) 0);
					}
				}
			} catch (Exception exception) {
			...
			try {
				...
				if (string.equalsIgnoreCase("breakcon")) {
					...
					for (int i = 0; i < class116s.length; i++) {
						Class116 class116 = class116s[i];
						if (class116.method1979(782493095) != null)
							class116.method1979(782493095).method9204(733237503);
					}
					Class572.aClass458_7684.method7460(65535);
					return;
				}
				...
				if (string.startsWith("getclientvarp")) {
					...
					Class485.method7932(new StringBuilder().append("varp=").append(Class98_Sub1_Sub2.playerVarsProvider.method94((Class98_Sub1_Sub2.playerVarsProvider.method110(Class470.aClass470_5354, i, 1965983800)), -1712283688)).toString(), (byte) -3);
					return;
				}
				...
				if (string.startsWith("setoutput ")) {
					...
					if (file.exists()) {
						file = new File(new StringBuilder().append(string.substring(10)).append(".").append(Class248.method4401(1516375036)).append(".log").toString());
						if (file.exists()) {
				...
				if (9 == client.anInt11136 * -2020118759 || -2020118759 * client.anInt11136 == 0) {
					Class116 class116 = Class537.method8941(-1478559692);
		...
		if (strings.length > 1) {
			for (int i = 0; i < strings.length; i++) {
				if (strings[i].startsWith("pause")) {
					...
					Class53_Sub6.aStringArray10968 = strings;
					anInt1176 = (i + 1) * -1190962299;
					Class687_Sub24.aLong10885 = (Class248.method4401(1516375036) + (long) (i_50_ * 1000)) * 1332324763258881553L;
					break;
				}
				aString1171 = strings[i];
				Class628.method10314(false, (byte) -1);
			...
			try {
				if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
					...
					if (2 == Class562.anInt7564 * 2097396553) {
						...
						Class485.method7932(new StringBuilder().append("Pos: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 1198302975)) + (int) class437.aFloat4904).toString(), (byte) -89);
						Class485.method7932(new StringBuilder().append("Look: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437_90_.aFloat4903 >> 9, (int) class437_90_.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437_90_.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -812158457)) + (int) class437.aFloat4904).toString(), (byte) -11);
					} else {
						Class485.method7932(new StringBuilder().append("Pos: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append(((760427037 * Class77.anInt858 >> 9) + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + (-1221225203 * Class497.anInt5563 >> 9)) >> 6).append(",").append((class592.localX * 235453015 + (760427037 * Class77.anInt858 >> 9)) & 0x3f).append(",").append(((-1221225203 * Class497.anInt5563 >> 9) + class592.localY * 1704054549) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(760427037 * Class77.anInt858, -1221225203 * Class497.anInt5563, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 520910818)) - Class285.anInt3085 * 805779207).toString(), (byte) -91);
						Class485.method7932(new StringBuilder().append("Look: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append((-1744666137 * Class602.anInt7934 + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + Class42.anInt564 * -479513739) >> 6).append(",").append((class592.localX * 235453015 + -1744666137 * Class602.anInt7934) & 0x3f).append(",").append((class592.localY * 1704054549 + Class42.anInt564 * -479513739) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(-1744666137 * Class602.anInt7934, -479513739 * Class42.anInt564, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 2112550796)) - Class290.anInt3146 * 1734327845).toString(), (byte) -27);
					}
				}
			} catch (Exception exception) {
			...
			try {
				...
				if (string.equalsIgnoreCase("breakcon")) {
					...
					for (int i = 0; i < class116s.length; i++) {
						Class116 class116 = class116s[i];
						if (class116.method1979(782493095) != null)
							class116.method1979(782493095).method9204(396789312);
					}
					Class572.aClass458_7684.method7460(65535);
					return;
				}
				...
				if (string.startsWith("getclientvarp")) {
					int i = Integer.parseInt(string.substring(14));
					Class485.method7932(new StringBuilder().append("varp=").append(Class98_Sub1_Sub2.playerVarsProvider.method94((Class98_Sub1_Sub2.playerVarsProvider.method110(Class470.aClass470_5354, i, 1649070888)), -1540436978)).toString(), (byte) -103);
					return;
				}
				if (string.startsWith("directlogin")) {
				...
				if (9 == client.anInt11136 * -2020118759 || -2020118759 * client.anInt11136 == 0) {
					Class116 class116 = Class537.method8941(-1524463155);
					Class523_Sub22 class523_sub22 = Class523_Sub18.method16042(OutgoingPacket.COMMANDS_PACKET, class116.aClass11_1413, 1370050649);
			...
			try {
				if (string.equalsIgnoreCase("commands") || string.equalsIgnoreCase("help")) {
					...
					if (2 == Class562.anInt7564 * 2097396553) {
						...
						Class485.method7932(new StringBuilder().append("Pos: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 640370539)) + (int) class437.aFloat4904).toString(), (byte) -7);
						Class485.method7932(new StringBuilder().append("Look: ").append(new Class592((Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), (int) class437_96_.aFloat4903 >> 9, (int) class437_96_.aFloat4905 >> 9).toString()).append(" Height: ").append((Class53_Sub17.method17220(((int) class437_96_.aFloat4903 - (235453015 * class592.localX << 9)), ((int) class437.aFloat4905 - (class592.localY * 1704054549 << 9)), (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), -111955903)) + (int) class437.aFloat4904).toString(), (byte) -45);
					} else {
						Class485.method7932(new StringBuilder().append("Pos: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append(((760427037 * Class77.anInt858 >> 9) + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + (-1221225203 * Class497.anInt5563 >> 9)) >> 6).append(",").append((class592.localX * 235453015 + (760427037 * Class77.anInt858 >> 9)) & 0x3f).append(",").append(((-1221225203 * Class497.anInt5563 >> 9) + class592.localY * 1704054549) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(760427037 * Class77.anInt858, -1221225203 * Class497.anInt5563, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 1515559866)) - Class285.anInt3085 * 805779207).toString(), (byte) -56);
						Class485.method7932(new StringBuilder().append("Look: ").append(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821).append(",").append((-1744666137 * Class602.anInt7934 + class592.localX * 235453015) >> 6).append(",").append((1704054549 * class592.localY + Class42.anInt564 * -479513739) >> 6).append(",").append((class592.localX * 235453015 + -1744666137 * Class602.anInt7934) & 0x3f).append(",").append((class592.localY * 1704054549 + Class42.anInt564 * -479513739) & 0x3f).append(" Height: ").append((Class53_Sub17.method17220(-1744666137 * Class602.anInt7934, -479513739 * Class42.anInt564, (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821), 1969786159)) - Class290.anInt3146 * 1734327845).toString(), (byte) -124);
					}
				}
			} catch (Exception exception) {
			...
			try {
				...
				if (string.equalsIgnoreCase("breakcon")) {
					...
					for (int i = 0; i < class116s.length; i++) {
						Class116 class116 = class116s[i];
						if (class116.method1979(782493095) != null)
							class116.method1979(782493095).method9204(-1313569718);
					}
					Class572.aClass458_7684.method7460(65535);
					return;
				}
				...
				if (string.startsWith("getclientvarp")) {
					int i = Integer.parseInt(string.substring(14));
					Class485.method7932(new StringBuilder().append("varp=").append(Class98_Sub1_Sub2.playerVarsProvider.method94((Class98_Sub1_Sub2.playerVarsProvider.method110(Class470.aClass470_5354, i, 2021902050)), 1190344443)).toString(), (byte) -97);
					return;
				}
				if (string.startsWith("directlogin")) {
				...
				if (9 == client.anInt11136 * -2020118759 || -2020118759 * client.anInt11136 == 0) {
					Class116 class116 = Class537.method8941(-2057665203);
					Class523_Sub22 class523_sub22 = Class523_Sub18.method16042(OutgoingPacket.COMMANDS_PACKET, class116.aClass11_1413, 1370050649);
	...
	static void method1758(int i) {
		...
		try {
			if (i == 6)
				...
				Class572.aClass458_7684.method7459(-628144884);
			else if (13 == i)
				Class572.aClass458_7684.method7458(2002437890);
			else if (i == 7)
				...
				client.aClass505_11019.aLong5656 = Class248.method4401(1516375036) * -7546729170109173589L;
				...
				Class437 class437 = (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.method10569().aClass437_4862);
				Class485.method7932(new StringBuilder().append("").append(client.aClass505_11019.method8241((byte) -59).aClass142Array7509[(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821)].method2321((int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9, 1677620402)).toString(), (byte) -64);
			} else if (1 == i) {
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2521.method3780(30105747)).append(" ").append(Class250.aClass209_2521.method3774((short) 12141)).toString(), (byte) -59);
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2524.method3780(30105747)).append(" ").append(Class250.aClass209_2524.method3774((short) 8756)).toString(), (byte) -109);
			} else if (4 == i)
	...
	static void method1759(int i) {
		...
		try {
			if (i == 6)
				...
				Class572.aClass458_7684.method7459(-645958205);
			else if (13 == i)
				Class572.aClass458_7684.method7458(2002437890);
			else if (i == 7)
				Class523_Sub18_Sub8.aCanvas11689.setLocation(50, 50);
				...
				Class437 class437 = (Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.method10569().aClass437_4862);
				Class485.method7932(new StringBuilder().append("").append(client.aClass505_11019.method8241((byte) -106).aClass142Array7509[(Class241.aClass647_Sub1_Sub3_Sub1_Sub2_2453.aByte10821)].method2321((int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9, 1602875264)).toString(), (byte) -9);
			} else if (1 == i) {
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2521.method3780(30105747)).append(" ").append(Class250.aClass209_2521.method3774((short) 26197)).toString(), (byte) -30);
				Class485.method7932(new StringBuilder().append(Class250.aClass209_2524.method3780(30105747)).append(" ").append(Class250.aClass209_2524.method3774((short) 20585)).toString(), (byte) -32);
			} else if (4 == i)
	...
	public static int method1763(int i, int i_111_) {
		Class523_Sub27_Sub15 class523_sub27_sub15 = ((Class523_Sub27_Sub15) Class271.aClass14_2876.method741((long) i));
	...
	static final void method1765(Class669 class669, byte i) {
		...
		Class250 class250 = Class188.method3592(i_114_, -624347397);
