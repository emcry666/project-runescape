				...
				if (62 == c && i_107_ != -1) {
					...
					if (string_111_.equals("lt"))
						...
						if (string_111_.startsWith("img=")) {
							try {
								int i_112_ = (Class458_Sub1.method15856(string_111_.substring(4), (byte) 116));
							...
							if (aClass10_1787.anInterface4_79 != null) {
								try {
									...
									if (i_116_ == -1)
										i_114_ = (Class458_Sub1.method15856(string_111_.substring(7), (byte) 22));
									else {
										i_114_ = (Class458_Sub1.method15856(string_111_.substring(7, i_116_), (byte) 19));
										i_115_ = (Class458_Sub1.method15856(string_111_.substring(1 + i_116_), (byte) 110));
									}
						...
						if (string_129_.startsWith("img=")) {
							try {
								...
								if (null != is_122_)
									...
									i_131_ = 0;
								i_126_++;
								int i_132_ = (Class458_Sub1.method15856(string_129_.substring(4), (byte) 31));
							...
							if (null != aClass10_1787.anInterface4_79) {
								try {
									...
									if (-1 == i_136_)
										i_134_ = (Class458_Sub1.method15856(string_129_.substring(7), (byte) 38));
									else {
										i_134_ = (Class458_Sub1.method15856(string_129_.substring(7, i_136_), (byte) 16));
										i_135_ = (Class458_Sub1.method15856(string_129_.substring(i_136_ + 1), (byte) 74));
									}
									int i_137_;
									if (is_121_ != null)
