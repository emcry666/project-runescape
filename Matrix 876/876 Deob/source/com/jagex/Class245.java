...
public class Class245 {
	public static Class245 method4380(RSBuffer class523_sub34) {
		...
		for (int i_1_ = 0; i_1_ < i; i_1_++) {
			...
			if (i_2_ == 0)
				objects[i_1_] = BaseVarType.method7745(java.lang.Integer.class, 1482870554).method65(class523_sub34, -721285210);
			else if (i_2_ == 1)
				objects[i_1_] = BaseVarType.method7745(java.lang.String.class, 1569046205).method65(class523_sub34, -721285210);
			else
	...
	public static Class245 method4381(RSBuffer class523_sub34) {
		...
		for (int i_4_ = 0; i_4_ < i; i_4_++) {
			...
			if (i_5_ == 0)
				objects[i_4_] = BaseVarType.method7745(java.lang.Integer.class, 1569824985).method65(class523_sub34, -721285210);
			else if (i_5_ == 1)
				objects[i_4_] = BaseVarType.method7745(java.lang.String.class, 1882296159).method65(class523_sub34, -721285210);
			else
		...
		if (null != Class54.aClass62_729) {
			try {
				...
				if (Class62.aClass62_771 == Class54.aClass62_729) {
					...
					int i_7_ = 2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset);
					...
					int i_8_ = 2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset);
					...
					class523_sub22.aClass523_Sub34_Sub2_10525.method16263(Class54.anIntArray726, i_8_, (class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011), (byte) 107);
					class523_sub22.aClass523_Sub34_Sub2_10525.method16275(2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset) - i_7_, -256764084);
				...
				if (Class54.aClass62_729 == Class62.aClass62_770) {
					if (client.aClass116_11057.getCurrentStream(782493095) == null)
						Class508.method8502(1825546770);
					else if (client.aClass116_11057.getCurrentStream(782493095).method9199(1, 1509511606)) {
						client.aClass116_11057.getCurrentStream(782493095).read((client.aClass116_11057.updateBuffer.buffer), 0, 1, (short) 26499);
						Class54.aClass711_730 = ((Class711) Class334.method5910(Class554.method9172(-598626950), ((client.aClass116_11057.updateBuffer.buffer[0]) & 0xff), 2085061289));
						if (Class54.aClass711_730 == Class711.aClass711_8851) {
							...
							new Class11(is);
							client.aClass116_11057.updateBuffer.method18218(client.aClass116_11057.aClass11_1420, 380758988);
							Class657.method10791(11, (byte) -2);
							client.aClass116_11057.method1998(1681440368);
							client.aClass116_11057.updateBuffer.offset = 0;
