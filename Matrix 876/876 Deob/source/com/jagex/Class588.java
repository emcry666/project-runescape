...
public class Class588 implements Interface6, Interface13 {
	...
	void method9721(RSBuffer class523_sub34, int i, byte i_4_) {
		if (1 == i) {
	...
	static final void method9722(int i, Class14 class14) {
		if (i != -1 && class14.getFromIndex((long) i) == null)
	...
	void method9727(RSBuffer class523_sub34, int i) {
		if (1 == i) {
	...
	void method9728(RSBuffer class523_sub34, int i) {
		if (1 == i) {
	...
	void method9729(RSBuffer class523_sub34, int i) {
		if (1 == i) {
	...
	void method9730(RSBuffer class523_sub34, int i) {
		if (1 == i) {
	...
	void method9739(RSBuffer class523_sub34, int i) {
		if (1 == i) {
	...
	static final void method9740(Class669 class669, int i) {
		class669.anObjectArray8559[(class669.anInt8560 += 1235970069) * 240723773 - 1] = Class241.player.method18358((byte) 19);
	}
