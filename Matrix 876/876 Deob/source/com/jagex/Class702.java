	...
	static final void method14125(int i, int i_3_, int i_4_, int i_5_, boolean bool, short i_6_) {
		if (client.aClass505_11019.method8241((byte) -115) == null)
			...
			if (bool_7_)
				...
				if (null != Class241.player && ((int) class437.aFloat4903 - (Class241.player.method18338(2142197017) - 1) * 256) >> 9 == Class104.anInt1269 * -69669203 && (((int) class437.aFloat4905 - (Class241.player.method18338(2146734627) - 1) * 256) >> 9 == 274896403 * Class104.anInt1270)) {
				...
				VarDomainType.method7633(i, i_3_, i_4_, i_5_, true, 1775229050);
				...
				InterfaceComponentDefinitions.method4519(i, i_3_, (byte) -59);
				...
				if (Class274.method5030(-691979946))
					...
					client.aClass435_11005.method6814(0.0F, 0.0F, -1.0F, Class433.method6799(-(TimeUtils.anInt2491 * 2069375919) & 0x3fff));
					VarDomainType.method7635(client.aClass441_11004, true, (float) (i_4_ / 2), (float) (i_5_ / 2), (float) (-1438988655 * client.anInt11286 << 1), (float) (client.anInt11286 * -1438988655 << 1), i_4_, i_5_, -1575505843);
				}
				...
				if (class632.method10368(-1674001807) != null) {
					...
					if (2097396553 * Class562.anInt7564 == 2) {
						...
						class632.method10368(1219256633).method8214(Class31.aClass178_303, 1926301335 * Class64.anInt790 << 3, i, i_3_, i_4_, i_5_, 1555328683 * Class678.anInt8639, Class424.anInt4817 * 325333285, 2069375919 * TimeUtils.anInt2491, i_20_, true, false, 2093179052);
				...
				if (Class274.method5030(463746539) || 2097396553 * Class562.anInt7564 == 2)
					client.aClass505_11019.method8241((byte) -21).method9273(client.cycles, 887340707 * class307.anInt3352, class307.anInt3353 * 1516838213, 1459940421 * class307.anInt3351, client.aClass505_11019.method8247(2003682856), client.anIntArray11141, client.anIntArray11261, client.anIntArray11119, client.anIntArray11144, client.anIntArray11145, 1 + (Class241.player.aByte10821), i_24_, (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9, Class449.aClass523_Sub33_4946.aClass687_Sub13_10613.method16853(-2046412852) == 0, true, 0, true);
				else
					client.aClass505_11019.method8241((byte) -53).method9273(client.cycles, 760427037 * Class77.anInt858, Class285.anInt3085 * 805779207, -1221225203 * Class497.anInt5563, client.aClass505_11019.method8247(-49514150), client.anIntArray11141, client.anIntArray11261, client.anIntArray11119, client.anIntArray11144, client.anIntArray11145, (Class241.player.aByte10821) + 1, i_24_, (int) class437.aFloat4903 >> 9, (int) class437.aFloat4905 >> 9, Class449.aClass523_Sub33_4946.aClass687_Sub13_10613.method16853(2013608286) == 0, true, 0, true);
				...
				if (client.aBool11009 && Class572.aClass458_7684.getLowPriorityRequestsCount((byte) 127) == 0)
				...
				VarDomainType.method7635(client.aClass441_11004, false, (float) (i + i_4_ / 2), (float) (i_5_ / 2 + i_3_), (float) (client.anInt11286 * -1438988655 << 1), (float) (-1438988655 * client.anInt11286 << 1), i_4_, i_5_, 1490326491);
				Class31.aClass178_303.method3124(client.aClass441_11004);
