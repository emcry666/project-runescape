...
public class Class7 implements Interface13, Interface6 {
	...
	void method557(RSBuffer class523_sub34, int i, int i_7_) {
		if (i == 1) {
	...
	void method560(RSBuffer class523_sub34, int i) {
		if (i == 1) {
	...
	void method561(RSBuffer class523_sub34, int i) {
		if (i == 1) {
	...
	static final void method563(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		...
		if (-339807053 * class250.anInt2548 != i_36_) {
			...
			Login.method15991(class250, (byte) -103);
		}
		if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456)
			Class194_Sub14.method15515(-1363815505 * class250.interfaceHash, -1335462253);
	}
