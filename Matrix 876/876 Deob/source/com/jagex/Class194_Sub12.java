...
public class Class194_Sub12 extends Class194 {
	...
	Class194_Sub12(RSBuffer class523_sub34) {
	...
	boolean method3655() {
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(anInt9915 * -222201273, (byte) -33));
		return class205.method3719(169699403);
	}

	boolean method3650(int i) {
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(anInt9915 * -222201273, (byte) -81));
		return class205.method3719(169699403);
	}
	...
	public void method3651() {
		...
		if (-426117601 * anInt9916 == 0)
			Class643.setAnimation(class647_sub1_sub3_sub1, anIntArray9917, 0, false, -1952064036);
		else
	...
	public void method3656() {
		...
		if (-426117601 * anInt9916 == 0)
			Class643.setAnimation(class647_sub1_sub3_sub1, anIntArray9917, 0, false, 1706861403);
		else
	...
	public void method3657() {
		...
		if (-426117601 * anInt9916 == 0)
			Class643.setAnimation(class647_sub1_sub3_sub1, anIntArray9917, 0, false, 1487225506);
		else
			Class523.method8667(class647_sub1_sub3_sub1, new int[] { -222201273 * anInt9915 }, new int[] { 0 }, new int[] { -426117601 * anInt9916 }, (byte) 107);
	}

	boolean method3653() {
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(anInt9915 * -222201273, (byte) -96));
		return class205.method3719(169699403);
	}

	boolean method3654() {
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(anInt9915 * -222201273, (byte) 11));
		return class205.method3719(169699403);
	}
	...
	public void method3648(int i) {
		...
		if (-426117601 * anInt9916 == 0)
			Class643.setAnimation(class647_sub1_sub3_sub1, anIntArray9917, 0, false, -1676886334);
		else
