...
public class Class173 {
	...
	public static final int method2903(long l, String string, byte i) {
		...
		class523_sub34.encryptRSA(Class48.aBigInteger698, Class48.aBigInteger699, 737146878);
		...
		class523_sub34_0_.method16441(random.nextLong());
		class523_sub34_0_.encryptRSA(Class48.aBigInteger698, Class48.aBigInteger699, 737146878);
		int i_4_ = Class6.method555(string, (byte) 9);
		if (i_4_ % 8 != 0)
			i_4_ += 8 - i_4_ % 8;
		RSBuffer class523_sub34_5_ = new RSBuffer(i_4_);
		class523_sub34_5_.method16270(string, (byte) -74);
		class523_sub34_5_.offset = 189765723 * i_4_;
		class523_sub34_5_.method16307(is, 245278669);
		RSBuffer class523_sub34_6_ = new RSBuffer(class523_sub34_5_.offset * 2349011 + (2349011 * class523_sub34_0_.offset + (class523_sub34.offset * 2349011 + 5)));
		class523_sub34_6_.writeByte(2, -1418159936);
		class523_sub34_6_.writeByte(class523_sub34.offset * 2349011, 297541489);
		class523_sub34_6_.readBytes(class523_sub34.buffer, 0, 2349011 * class523_sub34.offset, (short) -5216);
		class523_sub34_6_.writeByte(2349011 * class523_sub34_0_.offset, 1304343400);
		class523_sub34_6_.readBytes(class523_sub34_0_.buffer, 0, 2349011 * class523_sub34_0_.offset, (short) -14847);
		class523_sub34_6_.writeShort(2349011 * class523_sub34_5_.offset, (byte) -91);
		class523_sub34_6_.readBytes(class523_sub34_5_.buffer, 0, 2349011 * class523_sub34_5_.offset, (short) -1181);
		String string_7_ = Class221.method4138(class523_sub34_6_.buffer, 1983767396);
		int i_8_;
		try {
			...
			class523_sub34_6_ = new RSBuffer(new byte[1000]);
			for (;;) {
				int i_9_ = inputstream.read(class523_sub34_6_.buffer, class523_sub34_6_.offset * 2349011, 1000 - (class523_sub34_6_.offset * 2349011));
				if (i_9_ == -1)
					break;
				class523_sub34_6_.offset += i_9_ * 189765723;
				if (class523_sub34_6_.offset * 2349011 >= 1000)
					return 5;
			}
			outputstreamwriter.close();
			inputstream.close();
			String string_10_ = new String(class523_sub34_6_.buffer);
			...
			for (/**/; (2349011 * class523_sub34_6_.offset > 0 && 0 == (class523_sub34_6_.buffer[2349011 * class523_sub34_6_.offset - 1])); class523_sub34_6_.offset -= 189765723) {
				/* empty */
			}
			string_10_ = new String(class523_sub34_6_.buffer, 0, 2349011 * class523_sub34_6_.offset);
	...
	static Class148 method2909(byte[] is, byte i) {
		...
		for (;;) {
			try {
				...
				java.awt.Container container = JS5Protocol.method7486(-2031548384);
