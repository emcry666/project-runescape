...
public abstract class Class194_Sub16 extends Class194 {
	...
	boolean method3654() {
		...
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(class671.emoteId * -61429051, (byte) 3));
	...
	boolean method3650(int i) {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(class671.emoteId * -61429051, (byte) -51));
		bool &= class205.method3719(169699403);
		return bool;
	}
	...
	boolean method3653() {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(class671.emoteId * -61429051, (byte) 25));
		bool &= class205.method3719(169699403);
		return bool;
	}
	...
	boolean method3655() {
		...
		boolean bool = class671.method13700((byte) 127);
		AnimationDefinitions class205 = ((AnimationDefinitions) TimeUtils.aClass53_Sub13_2492.getDefinition(class671.emoteId * -61429051, (byte) -38));
		bool &= class205.method3719(169699403);
		return bool;
	}

	Class194_Sub16(RSBuffer class523_sub34) {
	...
	static final void method15519(Class669 class669, short i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_0_, -1547955743);
