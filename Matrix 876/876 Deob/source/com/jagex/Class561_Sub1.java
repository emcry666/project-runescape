...
public class Class561_Sub1 extends Class561 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	void method16658(int i, int i_0_, int i_1_, int i_2_) {
		Class523_Sub39_Sub1 class523_sub39_sub1 = Class375.method6387(i, i_0_, i_1_, TimeUtils.getCurrentTimeMilliseconds(1516375036), i_2_, (byte) 6);
	...
	void method16660(int i, int i_3_, int i_4_, int i_5_, byte i_6_) {
		Class523_Sub39_Sub1 class523_sub39_sub1 = Class375.method6387(i, i_3_, i_4_, TimeUtils.getCurrentTimeMilliseconds(1516375036), i_5_, (byte) 46);
	...
	void method16663(int i, int i_7_, int i_8_, int i_9_) {
		Class523_Sub39_Sub1 class523_sub39_sub1 = Class375.method6387(i, i_7_, i_8_, TimeUtils.getCurrentTimeMilliseconds(1516375036), i_9_, (byte) 125);
