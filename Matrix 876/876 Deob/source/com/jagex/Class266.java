...
public class Class266 {
	...
	static Class4 method4890(RSBuffer class523_sub34, Class98_Sub1 class98_sub1, int i) {
		Class4 class4 = new Class4(class98_sub1);
		for (;;) {
			int i_0_ = class523_sub34.readUnsignedByte(-600136537);
			if (i_0_ == 255)
				break;
			BaseVarType class474 = (BaseVarType) Class95.method1764(com.jagex.BaseVarType.class, i_0_, 2138772399);
			for (;;) {
