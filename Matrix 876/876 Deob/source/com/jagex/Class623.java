...
public class Class623 {
	...
	public Class167 method10176(Class178 class178, int i, Class53_Sub17 class53_sub17, Class53_Sub6 class53_sub6, Class53_Sub7 class53_sub7, Class53_Sub8 class53_sub8, Interface19 interface19, Interface17 interface17, Class707 class707, Class707 class707_23_, Class707[] class707s, int[] is, int i_24_, boolean bool, BodyDefinitions class630, int i_25_) {
		...
		if (null != class707) {
			...
			if (null != class205 && (-1421451731 * class205.rightHandItem >= 0 || 746156899 * class205.leftHandItem >= 0)) {
				is_27_ = new int[anIntArray8094.length];
				for (int i_30_ = 0; i_30_ < is_27_.length; i_30_++)
					is_27_[i_30_] = anIntArray8094[i_30_];
				if (-1421451731 * class205.rightHandItem >= 0 && -1 != 1840849895 * class630.anInt8234) {
					bool_28_ = true;
					if (class205.rightHandItem * -1421451731 == 65535) {
						...
						is_27_[class630.anInt8234 * 1840849895] = -1421451731 * class205.rightHandItem | 0x40000000;
				...
				if (class205.leftHandItem * 746156899 >= 0 && -1 != 384712765 * class630.anInt8235) {
					bool_29_ = true;
					if (746156899 * class205.leftHandItem == 65535) {
						...
						is_27_[class630.anInt8235 * 384712765] = class205.leftHandItem * 746156899 | 0x40000000;
