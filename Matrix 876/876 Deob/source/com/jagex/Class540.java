...
public class Class540 {
	...
	public Class540(Class178 class178, RSBuffer class523_sub34, int i) {
	...
	static final void method8983(Class669 class669, short i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_25_, -396538871);
	...
	static final void decodeUpdate(RSBitBuffer class523_sub34_sub2, byte i) {
		int i_26_ = 0;
	...
	static final void method8986(Class669 class669, int i) {
		...
		if (null != Class241.player.aClass623_12183)
			Class241.player.aClass623_12183.method10172(i_40_, i_41_, (byte) 41);
	}
