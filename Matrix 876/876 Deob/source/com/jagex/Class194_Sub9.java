...
public class Class194_Sub9 extends Class194 {
	...
	Class194_Sub9(RSBuffer class523_sub34) {
		...
		if (client.aClass116_11058.aBool1432) {
			...
			if (9 == client.anInt11136 * -2020118759) {
				while (Class652.method10645(-279284202)) {
					...
					int i_1_ = 2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset);
					Class468.method7611((class523_sub22.aClass523_Sub34_Sub2_10525), -533357774);
					class523_sub22.aClass523_Sub34_Sub2_10525.method16276(2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset) - i_1_, 1768886921);
				...
				} else if (TimeUtils.getCurrentTimeMilliseconds(1516375036) >= -4281200043935582719L * Class520.aLong7060)
				...
				if (Class274.method5030(-376237283))
					...
					if (Class168.aLong1799 * -2251960109566032967L <= 0L)
						Class168.aLong1799 = (TimeUtils.getCurrentTimeMilliseconds(1516375036) * 6286482357763674761L);
					float f = (float) (TimeUtils.getCurrentTimeMilliseconds(1516375036) - (-2251960109566032967L * Class168.aLong1799));
					...
					if (-524877901 * client.aClass116_11058.anInt1423 > 2250)
						...
						if (3 == -1616721887 * client.anInt11071) {
							...
							if (1 == client.anInt11071 * -1616721887 && 10 != -2020118759 * client.anInt11136) {
								...
								client.anInt11073 = client.cycles * 470293709;
								client.anInt11230 = 0;
								client.aBool11072 = false;
								Class263.method4740((byte) -116);
							}
							if (-1616721887 * client.anInt11071 == 4) {
								int i_10_ = (client.cycles - client.anInt11073 * -667602939);
								...
								if (4 == -1616721887 * client.anInt11071) {
									for (int i_11_ = 0; i_11_ < (Class191.aClass192Array2157).length; i_11_++) {
										...
										if (class192.aBool2174) {
											...
											VarBitDefinitions.method5617(class647_sub1_sub3_sub1, true, (byte) -53);
										}
									}
								}
							}
						...
						if (null != Class436.aClass250_4899) {
							...
							if (client.anInt11173 * -1412331351 >= 15) {
								Login.method15991((Class436.aClass250_4899), (byte) -117);
						...
						InterfaceComponentSettings.method15984(null, -1, -1, 184849983);
						...
						for (;;) {
							...
							if (class523_sub38 == null)
								break;
							InterfaceComponentDefinitions class250 = class523_sub38.aClass250_10678;
							if (234012635 * class250.anInt2709 >= 0) {
								InterfaceComponentDefinitions class250_12_ = Class188.getDefinitions((97896203 * (class250.parentId)), -1182986515);
						...
						for (;;) {
							...
							InterfaceComponentDefinitions class250 = class523_sub38.aClass250_10678;
							if (234012635 * class250.anInt2709 >= 0) {
								InterfaceComponentDefinitions class250_13_ = Class188.getDefinitions((97896203 * (class250.parentId)), -602113869);
						...
						for (;;) {
							...
							InterfaceComponentDefinitions class250 = class523_sub38.aClass250_10678;
							if (234012635 * class250.anInt2709 >= 0) {
								InterfaceComponentDefinitions class250_14_ = Class188.getDefinitions((97896203 * (class250.parentId)), -1924443434);
						...
						LZMADecompressor.method8928(1870687181);
						if (-1746920271 * client.rights > 0 && Class481.aClass551_5473.method9127(82, (byte) -25) && Class481.aClass551_5473.method9127(81, (byte) -15) && 0 != 203206237 * client.anInt11028) {
							int i_15_ = ((Class241.player.aByte10821) - 203206237 * client.anInt11028);
							if (i_15_ < 0)
								i_15_ = 0;
							else if (i_15_ > 3)
								i_15_ = 3;
							Class592 class592 = client.aClass505_11019.method8242(55538902);
							RSSocket.method506(i_15_, ((Class241.player.screenX[0]) + class592.localX * 235453015), (class592.localY * 1704054549 + (Class241.player.screenY[0])), -1854377085);
						}
						for (int i_16_ = 0; i_16_ < 5; i_16_++)
							client.anIntArray11273[i_16_]++;
						if (Class423.clientConfigsDomain.aBool8903 && ((Class423.clientConfigsDomain.aLong8904 * -6425266789231785447L) < TimeUtils.getCurrentTimeMilliseconds(1516375036) - 60000L))
						...
						for (Class522_Sub5 class522_sub5 = ((Class522_Sub5) client.aClass701_11309.method14087(1706431677)); null != class522_sub5; class522_sub5 = ((Class522_Sub5) client.aClass701_11309.method14088(949172309))) {
							if ((long) (class522_sub5.anInt10341 * -754049503) < (TimeUtils.getCurrentTimeMilliseconds(1516375036) / 1000L - 5L)) {
	...
	static final void method15506(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
