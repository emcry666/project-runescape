...
public class Class624 {
	...
	void method10213(RSBuffer class523_sub34, byte i) {
		for (;;) {
	...
	void method10214(RSBuffer class523_sub34) {
		for (;;) {
	...
	public Class624(Class472 class472) {
		...
		method10213(new RSBuffer(is), (byte) 16);
	}
	...
	static final void method10215(Class669 class669, int i) {
		...
		if (-1746920271 * client.rights != 0 || ((!client.aBool11160 || client.aBool11161) && !client.aBool11164)) {
			...
			RSStream class116 = Class537.method8941(-1581360660);
			...
			int i_4_ = (class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011);
			...
			class523_sub22.aClass523_Sub34_Sub2_10525.method16276((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i_4_, 1313557169);
