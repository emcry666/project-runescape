...
public class Class84 implements Interface13, Interface6 {
	...
	void method1593(RSBuffer class523_sub34, int i, byte i_1_) {
		if (i == 1) {
	...
	void method1594(RSBuffer class523_sub34, int i) {
		if (i == 1) {
	...
	void method1595(RSBuffer class523_sub34, int i) {
		if (i == 1) {
	...
	public static int method1596(int i, int i_15_, int i_16_, boolean bool, int i_17_) {
		VarBitDefinitions class309 = ((VarBitDefinitions) Class539.aClass53_Sub3_7213.getDefinition(i_16_, (byte) -39));
