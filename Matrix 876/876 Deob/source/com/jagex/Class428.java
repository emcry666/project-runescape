...
public class Class428 implements Interface7 {
	...
	static void method6757(RSBitBuffer class523_sub34_sub2, int i, byte i_0_) {
		...
		if (i_1_ == 0) {
			...
			int i_4_ = class647_sub1_sub3_sub1_sub2.screenX[0];
			int i_5_ = class647_sub1_sub3_sub1_sub2.screenY[0];
			if (i_3_ == 1) {
			...
			int i_8_ = class647_sub1_sub3_sub1_sub2.screenX[0];
			int i_9_ = class647_sub1_sub3_sub1_sub2.screenY[0];
			if (i_7_ == 0) {
				i_8_ -= 2;
				i_9_ -= 2;
			} else if (1 == i_7_) {
			...
			if (i_10_ == 0) {
				...
				if (i_15_ > 15)
					i_15_ -= 32;
				int i_16_ = class647_sub1_sub3_sub1_sub2.screenX[0] + i_14_;
				int i_17_ = class647_sub1_sub3_sub1_sub2.screenY[0] + i_15_;
				...
				int i_23_ = ((i_21_ + (235453015 * class592.localX + (class647_sub1_sub3_sub1_sub2.screenX[0])) & 0x3fff) - class592.localX * 235453015);
				int i_24_ = ((class592.localY * 1704054549 + class647_sub1_sub3_sub1_sub2.screenY[0] + i_22_) & 0x3fff) - 1704054549 * class592.localY;
