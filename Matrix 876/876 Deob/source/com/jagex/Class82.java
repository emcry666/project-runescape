...
public class Class82 {
	...
	public Class92 method1570(int i) {
		...
		class92.method1662(new RSBuffer(is), (byte) 80);
		return class92;
	}
	...
	public Class92 method1571(int i, int i_0_) {
		...
		Class92 class92 = new Class92();
		class92.method1662(new RSBuffer(is), (byte) -10);
		return class92;
	}
	...
	public Class92 method1578(int i) {
		...
		Class92 class92 = new Class92();
		class92.method1662(new RSBuffer(is), (byte) 51);
		return class92;
	}
	...
	public Class82(Class681 class681, Class668 class668, Class472 class472) {
		...
		RSBuffer class523_sub34 = new RSBuffer(aClass472_868.method7688(0, 0, -71889030));
		int i = ((class523_sub34.buffer == null || class523_sub34.buffer.length < 1) ? -1 : class523_sub34.readUnsignedByte(-1594323637));
		if (i < 4) {
