...
public class LZMADecompressor {
	...
	static Class525 decoder;

	static {
		new Class518();
		decoder = new Class525();
	}
	...
	static byte[] method8922(InputStream inputstream, int i) throws IOException {
		...
		synchronized (decoder) {
			if (!decoder.setDecoderProperties(is, -119240299))
				throw new IOException("3");
			decoder.codeLZMA(inputstream, bytearrayoutputstream, (long) i);
		}
		bytearrayoutputstream.flush();
		return bytearrayoutputstream.toByteArray();
	}

	LZMADecompressor() throws Throwable {
		throw new Error();
	}
	...
	static byte[] method8925(InputStream inputstream, int i) throws IOException {
		...
		ByteArrayOutputStream bytearrayoutputstream = new ByteArrayOutputStream(i);
		synchronized (decoder) {
			if (!decoder.setDecoderProperties(is, 174071164))
				throw new IOException("3");
			decoder.codeLZMA(inputstream, bytearrayoutputstream, (long) i);
		}
		bytearrayoutputstream.flush();
		...
		if (-2131499789 * client.anInt11070 < 0) {
			...
			if (Class36.aBool326) {
				if (Class293.method5251((Class61.aClass633_769.anInterface68_8266), class523_sub39, 942498599)) {
					...
					} else if (i_1_ >= -1744502791 * Whirlpool.anInt231 && i_1_ <= (BaseVarType.anInt5390 * -345535891 + Whirlpool.anInt231 * -1744502791) && i_2_ >= 14756423 * Class194_Sub17.anInt9941 && (i_2_ <= (2080544711 * Class523_Sub19.anInt10492 + (Class194_Sub17.anInt9941 * 14756423)))) {
						if (!Class36.aBool327) {
							int i_8_ = -1;
					...
					if (!bool) {
						if (i_1_ < Whirlpool.anInt231 * -1744502791 - 10 || i_1_ > (BaseVarType.anInt5390 * -345535891 + -1744502791 * Whirlpool.anInt231 + 10) || i_2_ < 14756423 * Class194_Sub17.anInt9941 - 10 || i_2_ > (2080544711 * Class523_Sub19.anInt10492 + Class194_Sub17.anInt9941 * 14756423 + 10))
							Class524.method8685(-522212835);
