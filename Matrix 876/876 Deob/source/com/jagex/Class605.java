...
public class Class605 implements Interface71 {
		...
		if (null != aClass209_7954) {
			...
			synchronized (aClass209_7954) {
				...
				if (null != list) {
					...
					anInt7953 += -1395805875 * class523_sub34.buffer.length;
	...
	public RSBuffer method469(int i, int i_1_) {
		if (null == aClass209_7954)
			return null;
		RSBuffer class523_sub34 = null;
		if (anInterface69_7950 != null)
			anInterface69_7950.method437(this, (byte) 13);
		synchronized (aClass209_7954) {
			List list = method9957(-578637934);
			if (list.size() > i)
				class523_sub34 = (RSBuffer) list.get(i);
		}
	...
	static boolean method9962(int i, int i_11_, int i_12_) {
		if (i_11_ >= 1000 && i < 1000)
			return true;
		if (i_11_ < 1000 && i < 1000) {
			if (InterfaceComponentDefinitions.method4518(i, 991233810))
				return true;
			if (InterfaceComponentDefinitions.method4518(i_11_, 1145921376))
				return false;
			return true;
		}
		if (i_11_ >= 1000 && i >= 1000)
