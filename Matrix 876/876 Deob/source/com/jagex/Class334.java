...
public class Class334 {
	...
	boolean method5853(int i, int i_9_, int i_10_, int i_11_) {
		...
		if (aClass14_3538 != null) {
			Class523 class523 = aClass14_3538.getFromIndex((long) i);
			if (null != class523) {
	...
	void method5865(RSBuffer class523_sub34) {
	...
	void method5867(RSBuffer class523_sub34) {
	...
	void method5871(RSBuffer class523_sub34, int i) {
	...
	public Class334(RSBuffer class523_sub34) {
	...
	void method5905(RSBuffer class523_sub34) {
	...
	static final void method5908(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_121_, -2092630340);
	...
	public static Interface75 method5910(Interface75[] interface75s, int opcode, int i_124_) {
		...
		for (int i_126_ = 0; i_126_ < interface75s_125_.length; i_126_++) {
			...
			if (opcode == interface75.method82())
				return interface75;
		}
		return null;
	}
