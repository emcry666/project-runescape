...
public class ItemDefinitions implements Interface13 {
	...
	void decodeItemDefinitions(RSBuffer buffer, int opcode, byte i_3_) {
		if (opcode == 1)
	...
	public int method659(int i, int i_36_) {
		if (aClass14_163 == null)
			return i_36_;
		Class523_Sub24 class523_sub24 = (Class523_Sub24) aClass14_163.getFromIndex((long) i);
	...
	void method676(RSBuffer class523_sub34, int i) {
		if (i == 1)
	...
	void method677(RSBuffer class523_sub34, int i) {
		if (i == 1)
	...
	public String method686(int i, String string, int i_197_) {
		if (aClass14_163 == null)
			return string;
		Class523_Sub28 class523_sub28 = (Class523_Sub28) aClass14_163.getFromIndex((long) i);
	...
	static final void method722(Class669 class669, byte i) {
		class669.anIntArray8557[(class669.anInt8558 += 2138772399) * 1357652815 - 1] = Class241.player.aClass72_11938.method1494((byte) 39);
	}
}
