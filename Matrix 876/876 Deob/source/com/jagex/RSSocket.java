...
public class RSSocket {
	...
	static InterfaceComponentDefinitions aClass250_15;
	...
	public Socket method502(int i) throws IOException {
		...
		return Class577.method9650(RS3Applet.Host, 43594, (byte) 4).method914((byte) -1);
	}
	...
	static final void method507(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_8_, -532856404);
