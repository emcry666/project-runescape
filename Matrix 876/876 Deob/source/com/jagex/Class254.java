...
public class Class254 implements Interface26 {
	...
	Class254(Class224 class224, RSBuffer class523_sub34) {
		this$0 = class224;
	...
	static final void method4545(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		...
		Login.method15991(class250, (byte) -90);
	}
	...
	static final void method4547(Class669 class669, int i) {
		...
		if (client.aBool11185) {
			try {
				Object object = (Class402.aClass402_4161.method6576((new Object[] { Integer.valueOf(-1857773681 * Class303.anInt3343), Boolean.valueOf((Class241.player.aByte12182) == 1), Integer.valueOf(class669.anIntArray8557[((class669.anInt8558 -= 2138772399) * 1357652815)]) }), 16711680));
				if (null != object)
	...
	static final void method4548(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		...
		if (!string.equals(class250.aString2607)) {
			...
			Login.method15991(class250, (byte) 6);
		}
		if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456)
			Class543.method9010(-1363815505 * class250.interfaceHash, -113773269);
	}
