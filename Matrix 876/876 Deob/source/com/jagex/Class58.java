...
public class Class58 implements Interface12 {
	...
	Class58(Class681 class681, Class668 class668, JS5ConfigStruct class656, Class472 class472, Interface5 interface5, boolean bool) {
	...
	void method1390(int i, int i_0_) {
		if (anInterface13Array750[i] == null) {
			...
			if (is != null)
				anInterface13Array750[i].readValues(new RSBuffer(is), 2105016660);
	...
	void method1391(int i) {
		if (anInterface13Array750[i] == null) {
			...
			if (is != null)
				anInterface13Array750[i].readValues(new RSBuffer(is), 2110029751);
	...
	void method1392(int i) {
		if (anInterface13Array750[i] == null) {
			...
			if (is != null)
				anInterface13Array750[i].readValues(new RSBuffer(is), 2130538717);
