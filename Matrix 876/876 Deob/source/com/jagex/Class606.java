...
public class Class606 implements Interface75 {
	...
	static final void method9968(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, byte i) {
		class250.modelType = -365376206;
		...
		if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456)
			Class328_Sub3_Sub1.method17886(class250.interfaceHash * -1363815505, 1648921847);
	}
	...
	public static void method9969(Class178 class178, long l, int i, int i_3_, int i_4_) {
		...
		if (Class569.aBool7641) {
			...
			if (!class178.method3309()) {
				...
				Class569.aLinkedList7646.add(new Class587(client.cycles, Class569.aLinkedList7645, 1970564341 * class178.anInt1945, 1216763507 * class178.anInt1937, class178.aFloat1948));
