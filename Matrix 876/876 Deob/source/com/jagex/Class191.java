...
public class Class191 {
	...
	static final void method3622(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_0_, -378323507);
		Class242 class242 = Class31.aClass242Array302[i_0_ >> 16];
		Class212.method3829(class250, class242, class669, (short) 16384);
	}

	static final void method3623(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
	...
	static final void method3624(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_3_, -660825378);
	...
	public static void method3626(RSBuffer class523_sub34, int i, int i_4_) {
				...
				if (i_6_ == 0 || 1 == i_6_ || i_6_ == 2) {
					...
					if (i_6_ == 3) {
						for (int i_13_ = 0; i_13_ < i_10_; i_13_++) {
							...
							class523_sub34.readBytes(is[i_13_], 0, i_14_, (byte) -15);
						}
					}
					class523_sub30.anIntArray10565[i_5_] = i_6_;
	...
	public static NetworkStream method3627(Socket socket, int i, byte i_20_) throws IOException {
