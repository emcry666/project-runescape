...
public class Class644 {
	...
	public static void method10541() {
		...
		if (client.anInt11184 * -751939039 > 0) {
			...
			for (int i = 0; i < -751939039 * client.anInt11184; i++) {
				...
				class523_sub22.aClass523_Sub34_Sub2_10525.writeMedium((int) l, (byte) 0);
			}
		...
		if (!client.aBool11012) {
			...
			int i = (2349011 * class523_sub22.aClass523_Sub34_Sub2_10525.offset);
			RSBuffer class523_sub34 = Class449.aClass523_Sub33_4946.method16233((short) 29671);
			class523_sub22.aClass523_Sub34_Sub2_10525.readBytes(class523_sub34.buffer, 0, class523_sub34.offset * 2349011, (short) -8352);
			class523_sub22.aClass523_Sub34_Sub2_10525.method16276((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i, 1488010779);
		...
		if (!client.aBool11013 && Class449.aClass523_Sub33_4946.aClass687_Sub1_10629.method16678((byte) -115) == 1) {
			...
			class523_sub22.aClass523_Sub34_Sub2_10525.method16275((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i, 959875061);
	...
	public static void method10543(Class523_Sub39 class523_sub39) {
		if (!BaseVarType.method7761(client.anInt11136 * -2020118759, (byte) 43))
	...
	public static void method10549() {
		...
		if (!client.aBool11012) {
			...
			int i = (2349011 * class523_sub22.aClass523_Sub34_Sub2_10525.offset);
			RSBuffer class523_sub34 = Class449.aClass523_Sub33_4946.method16233((short) 9256);
			class523_sub22.aClass523_Sub34_Sub2_10525.readBytes(class523_sub34.buffer, 0, class523_sub34.offset * 2349011, (short) -29303);
			class523_sub22.aClass523_Sub34_Sub2_10525.method16276((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i, 840041915);
		...
		if (!client.aBool11013 && Class449.aClass523_Sub33_4946.aClass687_Sub1_10629.method16678((byte) 10) == 1) {
			...
			class523_sub22.aClass523_Sub34_Sub2_10525.method16275((class523_sub22.aClass523_Sub34_Sub2_10525.offset * 2349011) - i, -801116874);
	...
	public static void method10552(int i, int i_10_, String string, String string_11_, String string_12_, String string_13_, String string_14_, int i_15_, Class421 class421, byte i_16_) {
		...
		Class271.aClass697_2877.removeFromQueue(class523_sub27_sub15, (byte) -14);
		client.anInt11229 = client.anInt11251 * -208551861;
	}

	public static void method10553(Class242 class242, InterfaceComponentDefinitions class250, boolean bool, byte i) {
