...
public class Class591 {
	...
	static final void method9778(Class669 class669, byte i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_3_, -635418857);
	...
	public static Class472 method9781(JS5ArchiveReference class44, boolean bool, int i, boolean bool_5_, boolean bool_6_, short i_7_) {
		if (null == GraphicsDefinitions.aClass467_Sub1Array8605) {
			GraphicsDefinitions.aClass467_Sub1Array8605 = new Class467_Sub1[Class9.getArchiveCount((byte) 44)];
			Class488.aMap5500 = new HashMap();
		}
		Class545 class545 = null;
		int i_8_ = class44.getIndexId(787387159);
		if (null != client.aClass20_5687 && !Class418.aBool4697)
			class545 = new Class545(i_8_, client.aClass20_5687, Class406.aClass20Array4198[i_8_], (i_8_ == JS5ArchiveReference.DLLS_INDEX.getIndexId(-1572055229) ? 8000000 : 2500000));
		GraphicsDefinitions.aClass467_Sub1Array8605[i_8_] = Class90.aClass424_890.method6721(i_8_, class545, Class516.aClass545_7051, class44.isStreamed((byte) 68), (byte) 57);
		if (bool_6_)
