...
public final class Class149_Sub1 extends Class149 {
		...
		do {
			try {
				try {
					...
					if ((class523_sub34.buffer.length - class523_sub34.offset * 2349011) < 1) {
						try {
					...
					if ((class523_sub34.buffer.length - 2349011 * class523_sub34.offset) < 2) {
						try {
					...
					if ((class523_sub34.buffer.length - class523_sub34.offset * 2349011) < 6 * i_6_) {
						try {
	...
	public void method14385(Class19 class19, short i) {
		do {
			try {
				try {
					...
					RSBuffer class523_sub34 = new RSBuffer(i_9_);
		...
		aLong8904 = TimeUtils.getCurrentTimeMilliseconds(1516375036) * 8792460426006770217L;
		aBool8903 = false;
	}

	public void method14386(byte i) {
		if (TimeUtils.getCurrentTimeMilliseconds(1516375036) >= aLong8906 * -516099212067259127L) {
			...
			if (null != aClass426Array8908 && anInt8909 * -1092729361 < aClass426Array8908.length) {
				RSStream class116 = Class537.method8941(-1677478992);
				if (class116.anInt1415 * -1660026723 <= 1200) {
					...
					int i_15_ = 2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset);
					class523_sub22.aClass523_Sub34_Sub2_10525.offset += 189765723;
					for (/**/; anInt8909 * -1092729361 < aClass426Array8908.length; anInt8909 += 1883474191) {
						...
						if ((-1660026723 * class116.anInt1415 + (class523_sub22.aClass523_Sub34_Sub2_10525.offset) * 2349011 + Class114.aClass98_Sub1_Sub2_1405.method14342(class426, 1963975858)) > 1500)
							break;
						Class114.aClass98_Sub1_Sub2_1405.method14341(class523_sub22.aClass523_Sub34_Sub2_10525, class426, (byte) 4);
					}
					class523_sub22.aClass523_Sub34_Sub2_10525.method16275(2349011 * (class523_sub22.aClass523_Sub34_Sub2_10525.offset) - i_15_, -1030357736);
					if (-1092729361 * anInt8909 >= aClass426Array8908.length)
						class523_sub22.aClass523_Sub34_Sub2_10525.buffer[i_15_] = (byte) 1;
					else
						class523_sub22.aClass523_Sub34_Sub2_10525.buffer[i_15_] = (byte) 0;
					class116.method1974(class523_sub22, (byte) 79);
					aLong8906 = ((TimeUtils.getCurrentTimeMilliseconds(1516375036) + 1000L) * -8924321158575988423L);
				}
			}
		}
	}
		...
		do {
			try {
				try {
					...
					RSBuffer class523_sub34 = new RSBuffer(i);
		...
		do {
			try {
				try {
					...
					if ((class523_sub34.buffer.length - class523_sub34.offset * 2349011) < 6 * i_21_) {
						try {
		...
		do {
			try {
				try {
					...
					if ((class523_sub34.buffer.length - class523_sub34.offset * 2349011) < 6 * i_27_) {
						try {
		...
		do {
			try {
				try {
					...
					if ((class523_sub34.buffer.length - class523_sub34.offset * 2349011) < 6 * i_32_) {
						try {
	...
	static void method14397(InterfaceComponentDefinitions class250, InterfaceComponentDefinitions class250_39_, byte i) {
		...
		class523_sub22.aClass523_Sub34_Sub2_10525.writeIntLE(class250.interfaceHash * -1363815505, 1225853340);
		class523_sub22.aClass523_Sub34_Sub2_10525.writeShort(class250.anInt2709 * 234012635, (byte) -47);
		class523_sub22.aClass523_Sub34_Sub2_10525.writeIntV1(-1363815505 * class250_39_.interfaceHash, (byte) 1);
