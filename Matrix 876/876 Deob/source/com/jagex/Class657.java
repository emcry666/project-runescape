...
public class Class657 {
	...
	static final void method10789(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_181_, -1265952011);
	...
	public static void method10791(int i, byte i_182_) {
		if (-2020118759 * client.anInt11136 != i) {
			...
			if (17 != i && Class246.aClass557_2480 != null) {
				Class246.aClass557_2480.closeConnection(1728200611);
			...
			if (bool != bool_183_)
				Class572.aClass458_7684.initGrabServerLoggedInStatus(!bool, -471449444);
	...
	static final void method10792(byte i) {
		...
		client.anInt11245 = 1846074621 * client.cycles;
		if (-1614846429 * client.anInt11186 != -1) {
			client.anInt10994 = 0;
