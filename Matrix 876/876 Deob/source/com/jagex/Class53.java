...
public class Class53 implements Interface12 {
	...
	Interface13 method1291(int i, int i_1_) {
		...
		if (is != null)
			interface13.readValues(new RSBuffer(is), 2099928681);
	...
	public Class53(Class681 class681, Class668 class668, Class472 class472, JS5ConfigStruct class656, int i, Interface5 interface5) {
	...
	Interface13 method1295(int i) {
		...
		if (is != null)
			interface13.readValues(new RSBuffer(is), 2087221192);
	...
	Interface13 method1304(int i) {
		...
		if (is != null)
			interface13.readValues(new RSBuffer(is), 2097309453);
	...
	Interface13 method1306(int i) {
		...
		if (is != null)
			interface13.readValues(new RSBuffer(is), 2111839080);
