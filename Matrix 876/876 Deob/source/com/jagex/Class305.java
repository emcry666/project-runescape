...
final class Class305 implements Interface19 {
	...
	public Class159 method110(VarDomainType class470, int i, int i_0_) {
	...
	public VarBitDefinitions method109(int i) {
		return (VarBitDefinitions) Class539.aClass53_Sub3_7213.getDefinition(i, (byte) -28);
	}

	public VarBitDefinitions method108(int i) {
		return (VarBitDefinitions) Class539.aClass53_Sub3_7213.getDefinition(i, (byte) -1);
	}

	public VarBitDefinitions method106(int i, int i_1_) {
		return (VarBitDefinitions) Class539.aClass53_Sub3_7213.getDefinition(i, (byte) -74);
	}

	public VarBitDefinitions method107(int i) {
		return (VarBitDefinitions) Class539.aClass53_Sub3_7213.getDefinition(i, (byte) 9);
	}
	...
	static final void method5549(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_4_, -1826498912);
	...
	static final void method5550(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_5_, -1972235758);
