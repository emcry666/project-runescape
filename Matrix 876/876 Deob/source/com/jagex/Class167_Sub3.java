...
public class Class167_Sub3 extends Class167 {
	...
	void method14868(boolean bool) {
		if ((aClass178_Sub1_9486.aClass523_Sub34_Sub1_9321.buffer).length < anInt9474 * 6)
			aClass178_Sub1_9486.aClass523_Sub34_Sub1_9321 = new Class523_Sub34_Sub1((anInt9474 + 100) * 6);
		else
			aClass178_Sub1_9486.aClass523_Sub34_Sub1_9321.offset = 0;
		...
		if (class523_sub34_sub1.offset * 2349011 != 0) {
			if (bool) {
				if (anInterface18_9488 == null)
					anInterface18_9488 = (aClass178_Sub1_9486.method14660(5123, class523_sub34_sub1.buffer, class523_sub34_sub1.offset * 2349011, true));
				else
					anInterface18_9488.method100(5123, class523_sub34_sub1.buffer, class523_sub34_sub1.offset * 2349011);
				aClass119_9509.anInterface18_1474 = anInterface18_9488;
			} else
				aClass119_9509.anInterface18_1474 = (aClass178_Sub1_9486.method14660(5123, class523_sub34_sub1.buffer, class523_sub34_sub1.offset * 2349011, false));
			if (!bool)
				aBool9490 = true;
		}
	}
	...
	void method14876(boolean bool) {
		...
		if (i != 0) {
			if ((aClass178_Sub1_9486.aClass523_Sub34_Sub1_9321.buffer).length < anInt9511 * i)
				...
				if (aClass178_Sub1_9486.aBool9393) {
					for (int i_592_ = 0; i_592_ < anInt9459; i_592_++) {
						...
						for (int i_598_ = i_596_; i_598_ < i_597_ && aShortArray9504[i_598_] != 0; i_598_++) {
							...
							class523_sub34_sub1.offset = i_599_ * i * 189765723;
					...
					for (int i_600_ = 0; i_600_ < anInt9459; i_600_++) {
						...
						for (int i_606_ = i_604_; i_606_ < i_605_ && aShortArray9504[i_606_] != 0; i_606_++) {
							...
							class523_sub34_sub1.offset = i_607_ * i * 189765723;
				...
				if (aClass131_9485 == null) {
					...
					for (int i_616_ = 0; i_616_ < anInt9515; i_616_++) {
						...
						if (i_627_ < 0)
							...
							i_627_ = 255;
						class523_sub34_sub1.offset = (i_589_ + i_621_ * i) * 189765723;
					...
					for (int i_628_ = 0; i_628_ < anInt9515; i_628_++) {
						...
						class523_sub34_sub1.offset = ((i_589_ + (aShortArray9450[i_628_] & 0xffff) * i) * 189765723);
						class523_sub34_sub1.writeInt(i_629_, -929320894);
						class523_sub34_sub1.offset = ((i_589_ + (aShortArray9478[i_628_] & 0xffff) * i) * 189765723);
						class523_sub34_sub1.writeInt(i_629_, -2106666854);
						class523_sub34_sub1.offset = ((i_589_ + (aShortArray9464[i_628_] & 0xffff) * i) * 189765723);
			...
			if (bool_585_) {
				...
				class523_sub34_sub1.offset = i_590_ * 189765723;
				if (aClass178_Sub1_9486.aBool9393) {
					for (int i_634_ = 0; i_634_ < anInt9511; i_634_++) {
						...
						class523_sub34_sub1.offset += (i - 12) * 189765723;
					}
				} else {
			...
			if (bool_587_) {
				class523_sub34_sub1.offset = i_591_ * 189765723;
				if (aClass178_Sub1_9486.aBool9393) {
					for (int i_640_ = 0; i_640_ < anInt9511; i_640_++) {
						...
						class523_sub34_sub1.offset += (i - 8) * 189765723;
					}
				} else {
			...
			class523_sub34_sub1.offset = i * anInt9511 * 189765723;
			Interface15 interface15;
			if (bool) {
				if (anInterface15_9477 == null)
					anInterface15_9477 = (aClass178_Sub1_9486.method14717(i, class523_sub34_sub1.buffer, class523_sub34_sub1.offset * 2349011, true));
				else
					anInterface15_9477.method84(i, (class523_sub34_sub1.buffer), (class523_sub34_sub1.offset * 2349011));
				interface15 = anInterface15_9477;
				aByte9454 = (byte) 0;
			} else {
				interface15 = (aClass178_Sub1_9486.method14717(i, class523_sub34_sub1.buffer, class523_sub34_sub1.offset * 2349011, false));
				aBool9490 = true;
			}
			if (bool_586_) {
	...
	void method14912(boolean bool) {
		...
		if (i != 0) {
				...
				if (aClass178_Sub1_9486.aBool9393) {
					for (int i_2219_ = 0; i_2219_ < anInt9459; i_2219_++) {
						...
						for (int i_2225_ = i_2223_; (i_2225_ < i_2224_ && aShortArray9504[i_2225_] != 0); i_2225_++) {
							...
							class523_sub34_sub1.offset = i_2226_ * i * 189765723;
					...
					for (int i_2227_ = 0; i_2227_ < anInt9459; i_2227_++) {
						...
						for (int i_2233_ = i_2231_; (i_2233_ < i_2232_ && aShortArray9504[i_2233_] != 0); i_2233_++) {
							...
							class523_sub34_sub1.offset = i_2234_ * i * 189765723;
				...
				if (aClass131_9485 == null) {
					...
					for (int i_2243_ = 0; i_2243_ < anInt9515; i_2243_++) {
						...
						if (i_2254_ < 0)
							...
							i_2254_ = 255;
						class523_sub34_sub1.offset = (i_2216_ + i_2248_ * i) * 189765723;
					...
					for (int i_2255_ = 0; i_2255_ < anInt9515; i_2255_++) {
						...
						class523_sub34_sub1.offset = ((i_2216_ + (aShortArray9450[i_2255_] & 0xffff) * i) * 189765723);
						class523_sub34_sub1.writeInt(i_2256_, -931361889);
						class523_sub34_sub1.offset = ((i_2216_ + (aShortArray9478[i_2255_] & 0xffff) * i) * 189765723);
						class523_sub34_sub1.writeInt(i_2256_, -1019074246);
						class523_sub34_sub1.offset = ((i_2216_ + (aShortArray9464[i_2255_] & 0xffff) * i) * 189765723);
			...
			if (bool_2212_) {
				...
				class523_sub34_sub1.offset = i_2217_ * 189765723;
				if (aClass178_Sub1_9486.aBool9393) {
			...
			if (bool_2214_) {
				class523_sub34_sub1.offset = i_2218_ * 189765723;
				if (aClass178_Sub1_9486.aBool9393) {
