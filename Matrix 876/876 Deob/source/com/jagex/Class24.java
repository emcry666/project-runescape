...
public class Class24 {
	...
	public QuickChatOptionDefinitions method836(int i) {
		QuickChatOptionDefinitions class523_sub27_sub18 = (QuickChatOptionDefinitions) aClass209_239.method3767((long) i);
		...
		class523_sub27_sub18 = new QuickChatOptionDefinitions();
		class523_sub27_sub18.aClass24_11838 = this;
		if (is != null)
			class523_sub27_sub18.readValues(new RSBuffer(is), 1953306581);
		if (i >= 32768)
	...
	String method837(QuickChatStringType class636, int[] is, long l) {
	...
	String method838(QuickChatStringType class636, int[] is, long l) {
		if (anInterface72_244 != null) {
			String string = anInterface72_244.method486(class636, is, l);
			if (null != string)
				return string;
	...
	public QuickChatOptionDefinitions method839(int i, byte i_1_) {
		QuickChatOptionDefinitions class523_sub27_sub18 = (QuickChatOptionDefinitions) aClass209_239.method3767((long) i);
		if (class523_sub27_sub18 != null)
			return class523_sub27_sub18;
		byte[] is;
	...
	static final void method840(Class669 class669, int i) {
		...
		int i_4_ = (Class645.aClass24_8347.method839(i_2_, (byte) -36).method18266(i_3_, (short) -6764).id * -1912590719);
	...
	static final void updateNPC(int i, int i_5_) {
		...
		Class687_Sub20.decodeUpdate(-505058275);
		Class3.decodeUpdateInformation(i, -1475006295);
		Class79.decodeMasks(-816065565);
		boolean bool = false;
		for (int i_6_ = 0; i_6_ < -1760171397 * client.anInt11055; i_6_++) {
			int i_7_ = client.anIntArray11253[i_6_];
			Class523_Sub28 class523_sub28 = ((Class523_Sub28) client.aClass14_11047.getFromIndex((long) i_7_));
		...
		if (-1372959327 * client.aClass116_11058.anInt1421 != (2349011 * client.aClass116_11058.updateBuffer.offset))
			throw new RuntimeException(new StringBuilder().append(2349011 * (client.aClass116_11058.updateBuffer.offset)).append(" ").append(client.aClass116_11058.anInt1421 * -1372959327).toString());
		for (int i_11_ = 0; i_11_ < 920163749 * client.anInt11050; i_11_++) {
			if (client.aClass14_11047.getFromIndex((long) client.anIntArray11051[i_11_]) == null)
	...
	static final void method842(Class669 class669, int i) {
		...
		InterfaceComponentDefinitions class250 = Class188.getDefinitions(i_13_, -1932431598);
