...
class Class214 implements Interface44 {
	...
	static final void method3838(InterfaceComponentDefinitions class250, Class242 class242, Class669 class669, int i) {
		class250.aBool2606 = (class669.anIntArray8557[(class669.anInt8558 -= 2138772399) * 1357652815]) == 1;
		Login.method15991(class250, (byte) -25);
		if (-1 == 234012635 * class250.anInt2709 && !class242.aBool2456)
			Class201.method3693(-1363815505 * class250.interfaceHash, -1626792069);
	}

	static final void method3839(Class669 class669, byte i) {
		String string;
		if (Class241.player != null && (Class241.player.displayName != null))
			string = Class241.player.method18669(false, (byte) 0);
		else
			string = "";
	...
	public static void method3841(InterfaceComponentDefinitions[] class250s, int i, int i_4_, int i_5_, boolean bool, int i_6_) {
		for (int i_7_ = 0; i_7_ < class250s.length; i_7_++) {
			InterfaceComponentDefinitions class250 = class250s[i_7_];
			if (null != class250 && i == class250.parentId * 97896203) {
	...
	public static void method3842(int i) {
		...
		Class271.aClass697_2877.removeFromQueue(1173351342);
